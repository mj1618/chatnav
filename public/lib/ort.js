...
var ort = (() => {
  ...
  var x = (i, e) => () => (i && (e = i((i = 0))), e);
  var tt = (i, e) => () => (
      e || i((e = { exports: {} }).exports, e), e.exports
    ),
    We = (i, e) => {
      for (var o in e) yr(i, o, { get: e[o], enumerable: !0 });
    },
    oi = (i, e, o, t) => {
      if ((e && typeof e == "object") || typeof e == "function")
        for (let r of Sc(e))
          !Ac.call(i, r) &&
            ...
            yr(i, r, {
              get: () => e[r],
              enumerable: !(t = _c(e, r)) || t.enumerable,
            });
      return i;
    };
  var Ae = (i, e, o) => (
      ...
      oi(
        e || !i || !i.__esModule
          ? yr(o, "default", { value: i, enumerable: !0 })
          : o,
        i
      )
    ),
    gr = (i) => oi(yr({}, "__esModule", { value: !0 }), i);
  var xr,
    se,
    ue,
    Pc,
      ...
      (xr = new Map()),
        ...
        (ue = (i, e, o) => {
          if (
            ...
            let t = xr.get(i);
            if (t === void 0) xr.set(i, { backend: e, priority: o });
            else {
        ...
        (Tr = async (i) => {
          ...
          return [
            ...
            new Proxy(i, {
              get: (u, l) =>
                l === "executionProviders" ? a : Reflect.get(u, l),
            }),
          ];
        });
    });
  ...
  var ui,
    ...
    Fn = x(() => {
        ...
        (Tt = {
          ...
          set logLevel(i) {
            if (i !== void 0) {
              if (
                typeof i != "string" ||
                ["verbose", "info", "warning", "error", "fatal"].indexOf(i) ===
                  -1
              )
      ...
      Object.defineProperty(Tt, "logLevel", { enumerable: !0 });
    });
  var $,
    li = x(() => {
      "use strict";
    ...
    pi = x(() => {
      ...
      (fi = (i, e) => {
        ...
        if (t != null) {
          ...
          for (let g = 0; g < n; g++)
            for (let T = 0; T < r; T++) {
              let _ = (i.data[c++] - l[0]) * u[0],
                w = (i.data[d++] - l[1]) * u[1],
                v = (i.data[m++] - l[2]) * u[2],
                L = y === -1 ? 255 : (i.data[y++] - l[3]) * u[3];
              (t.fillStyle = "rgba(" + _ + "," + w + "," + v + "," + L + ")"),
                t.fillRect(T, g, 1, 1);
            }
        ...
        (ci = (i, e) => {
          ...
          if (o != null) {
            ...
            for (let B = 0; B < n * r; m += d, y += d, g += d, T += d, B++)
              (t.data[m] = (i.data[_++] - f[0]) * l[0]),
                (t.data[y] = (i.data[w++] - f[1]) * l[1]),
                (t.data[g] = (i.data[v++] - f[2]) * l[2]),
                (t.data[T] = L === -1 ? 255 : (i.data[L++] - f[3]) * l[3]);
          } else throw new Error("Can not access image data");
          return t;
        });
    });
    ...
    gi = x(() => {
      ...
      (Nn = (i, e) => {
        ...
        let a = e.format !== void 0 ? e.format : "RGBA",
          ...
          w = l * 2,
          v = -1;
        a === "RGB" && ((c = 3), (d = 0), (m = 1), (y = 2), (g = -1)),
          u === "RGBA"
            ? (v = l * 3)
            : u === "RBG"
            ? ((T = 0), (w = l), (_ = l * 2))
            : u === "BGR" && ((w = 0), (_ = l), (T = l * 2));
        for (let B = 0; B < l; B++, d += c, y += c, m += c, g += c)
          (f[T++] = (i[d] + s[0]) / n[0]),
            (f[_++] = (i[m] + s[1]) / n[1]),
            (f[w++] = (i[y] + s[2]) / n[2]),
            v !== -1 && g !== -1 && (f[v++] = (i[g] + s[3]) / n[3]);
        return u === "RGBA"
          ...
          if (o) {
            ...
            if (c != null) {
              ...
              if (
                (e !== void 0 &&
                  ...
                  ((d = e.resizedHeight), (m = e.resizedWidth)),
                e !== void 0)
              ) {
                ...
                (a.tensorFormat = "RGBA"), (a.height = d), (a.width = m);
              } else (a.tensorFormat = "RGBA"), (a.height = d), (a.width = m);
              c.drawImage(i, 0, 0), (s = c.getImageData(0, 0, m, d).data);
            } else throw new Error("Can not access image data");
          } else if (t) {
            let f, c;
            if (
              ...
              e.resizedWidth !== void 0 &&
              e.resizedHeight !== void 0
                ? ((f = e.resizedHeight), (c = e.resizedWidth))
                : ((f = i.height), (c = i.width)),
              e !== void 0 && (a = e),
              (a.format = "RGBA"),
              (a.height = f),
              (a.width = c),
              ...
              let m = l(d);
              if (m != null)
                m.putImageData(i, 0, 0), (s = m.getImageData(0, 0, c, f).data);
              else throw new Error("Can not access image data");
            } else s = i.data;
          } else if (r) {
            if (e === void 0)
            ...
            if (c != null) {
              let d = i.height,
                m = i.width;
              return (
                c.drawImage(i, 0, 0, m, d),
                (s = c.getImageData(0, 0, m, d).data),
                (a.height = d),
                (a.width = m),
                Nn(s, a)
              );
              ...
              return new Promise((f, c) => {
                ...
                (y.crossOrigin = "Anonymous"),
                  ...
                  (y.onload = () => {
                    (d.width = y.width),
                      (d.height = y.height),
                      m.drawImage(y, 0, 0, d.width, d.height);
                    let g = m.getImageData(0, 0, d.width, d.height);
                    (a.height = d.height),
                      (a.width = d.width),
                      f(Nn(g.data, a));
                  });
      ...
      (le = new Map([
        ...
        (Ti = () => {
          if (!xi) {
            ...
            i &&
              (le.set("int64", BigInt64Array), He.set(BigInt64Array, "int64")),
              e &&
                (le.set("uint64", BigUint64Array),
                He.set(BigUint64Array, "uint64")),
              o
                ? (le.set("float16", Float16Array),
                  He.set(Float16Array, "float16"))
                : le.set("float16", Uint16Array);
          }
        });
    });
  var vi,
  ...
  var Cn,
    ...
    Rn = x(() => {
      ...
      Fn();
      (Cn = (i, e) => {
        (typeof Tt.trace > "u" ? !Tt.wasm.trace : !Tt.trace) ||
        ...
        (Zt = (i) => {
          (typeof Tt.trace > "u" ? !Tt.wasm.trace : !Tt.trace) || Si("END", i);
        });
    });
  var _r,
    Oi = x(() => {
        ...
        async run(e, o, t) {
          ...
          for (let l in a)
            if (Object.hasOwnProperty.call(a, l)) {
              ...
              f instanceof et
                ? (u[l] = f)
                : (u[l] = new et(f.type, f.data, f.dims));
            }
          return Zt(), u;
        }
        async release() {
        ...
        static async create(e, o, t, r) {
          ...
          if (typeof e == "string") {
            ...
            if (typeof o == "object" && o !== null) s = o;
              ...
              if (((c = o), !Number.isSafeInteger(c)))
                throw new RangeError("'byteOffset' must be an integer.");
              if (c < 0 || c >= f.byteLength)
                throw new RangeError(
                  `'byteOffset' is out of range [0, ${f.byteLength}).`
                );
              if (((d = e.byteLength - c), typeof t == "number")) {
                if (((d = t), !Number.isSafeInteger(d)))
                  throw new RangeError("'byteLength' must be an integer.");
                if (d <= 0 || c + d > f.byteLength)
                  throw new RangeError(
                    `'byteLength' is out of range (0, ${f.byteLength - c}].`
                  );
          ...
          convertHandlerReturnTypeToMapOfTensors(e) {
            ...
            for (let t in e)
              if (Object.hasOwnProperty.call(e, t)) {
                ...
                r instanceof et
                  ? (o[t] = r)
                  : (o[t] = new et(r.type, r.data, r.dims));
              }
            return o;
          }
          async lazyResetGrad() {
  ...
  function Yt(i, e, o, t) {
    if (e === void 0) return Lc(i);
    if (o === void 0) Or(i, e, 1);
    else if (typeof o == "number" && t === void 0) Or(i, e, o);
    else if (typeof o == "string" && t === void 0) Or(i, o, 1, e);
    else if (typeof o == "string" && typeof t == "number") Or(i, o, t, e);
    else throw new TypeError("input is valid");
  }
  function Lc(i) {
    return {
      verbose: Yt.verbose.bind(null, i),
      info: Yt.info.bind(null, i),
      warning: Yt.warning.bind(null, i),
      error: Yt.error.bind(null, i),
      fatal: Yt.fatal.bind(null, i),
    };
  }
  function Or(i, e, o, t) {
    let r = qe[t || ""] || qe[""];
    Ci[i] < Ci[r.minimalSeverity] ||
      (r.logDateTime && (e = `${new Date().toISOString()}|${e}`),
      r.logSourceLocation,
      Dc[r.provider].log(i, e, t));
  }
  var Mn,
    Vn,
    Ci,
      ...
      ((u) => {
        ...
        function s(l, f) {
          if (l === "*") n(f);
            ...
            let c = qe[l] || Ri;
            qe[l] = {
              provider: f.provider || c.provider,
              minimalSeverity: f.minimalSeverity || c.minimalSeverity,
              logDateTime:
                f.logDateTime === void 0 ? c.logDateTime : f.logDateTime,
              logSourceLocation:
      ...
      (z = Yt),
        ...
        (Dr = class {
          ...
          begin(e, o, t) {
            ...
            if (t === void 0) {
              let r = Ar();
              return this.flush(r), new Pr(e, o, r, (n) => this.endSync(n));
            } else {
              let r = t.beginTimer();
              return new Pr(e, o, 0, async (n) => this.end(n), r, t);
            }
          }
          async end(e) {
            ...
            this._timingEvents.length < this._maxNumberEvents &&
              (this._timingEvents.push(
                new Er(e.category, e.name, e.startTime, o)
              ),
              this.flush(o));
          }
          endSync(e) {
  ...
  function fe(i, e) {
    ...
    return e
      ? ((i >>>= 0),
        (r = 0 <= i && i < 256) && ((t = Wi[i]), t)
          ? t
          : ((o = V(i, 0, !0)), r && (Wi[i] = o), o))
      : ((i |= 0),
        (r = -128 <= i && i < 128) && ((t = zi[i]), t)
          ? t
          : ((o = V(i, i < 0 ? -1 : 0, !1)), r && (zi[i] = o), o));
  }
  function St(i, e) {
    if (isNaN(i)) return e ? qt : Bt;
    if (e) {
      if (i < 0) return qt;
      if (i >= Xi) return Zi;
    } else {
    ...
    return i < 0 ? St(-i, e).neg() : V(i % Ee | 0, (i / Ee) | 0, e);
  }
  function V(i, e, o) {
    return new H(i, e, o);
  }
  function Wn(i, e, o) {
    ...
    if (t === 0) return Wn(i.substring(1), e, o).neg();
    for (var r = St(Lr(o, 8)), n = Bt, s = 0; s < i.length; s += 8) {
      var a = Math.min(8, i.length - s),
        u = parseInt(i.substring(s, s + a), o);
      if (a < 8) {
        var l = St(Lr(o, a));
        n = n.mul(l).add(St(u));
      } else (n = n.mul(r)), (n = n.add(St(u)));
    }
  ...
  function Ft(i, e) {
    return typeof i == "number"
      ...
      : typeof i == "string"
      ? Wn(i, e)
      : V(i.low, i.high, typeof e == "boolean" ? e : i.unsigned);
  }
  var _t,
    zi,
    Wi,
    ...
    Hn = x(() => {
      ...
      I.toString = function (e) {
        ...
        for (var n = St(Lr(e, 6), this.unsigned), s = this, a = ""; ; ) {
          var u = s.div(n),
      ...
      I.compare = function (e) {
        if ((ct(e) || (e = Ft(e)), this.eq(e))) return 0;
      ...
      I.comp = I.compare;
      I.negate = function () {
        return !this.unsigned && this.eq(yt) ? yt : this.not().add(Pe);
      };
      I.neg = I.negate;
      I.add = function (e) {
        ct(e) || (e = Ft(e));
        ...
        return (
          ...
          (f += o + s),
          (f &= 65535),
          V((d << 16) | m, (f << 16) | c, this.unsigned)
        );
      };
      I.subtract = function (e) {
        return ct(e) || (e = Ft(e)), this.add(e.neg());
      };
      I.sub = I.subtract;
      I.multiply = function (e) {
        if (this.isZero()) return this;
        if ((ct(e) || (e = Ft(e)), _t)) {
          var o = _t.mul(this.low, this.high, e.low, e.high);
          return V(o, _t.get_high(), this.unsigned);
        }
        if (e.isZero()) return this.unsigned ? qt : Bt;
        if (this.eq(yt)) return e.isOdd() ? yt : Bt;
        if (e.eq(yt)) return this.isOdd() ? yt : Bt;
        if (this.isNegative())
          return e.isNegative()
            ? this.neg().mul(e.neg())
            : this.neg().mul(e).neg();
        if (e.isNegative()) return this.mul(e.neg()).neg();
        if (this.lt(ji) && e.lt(ji))
          return St(this.toNumber() * e.toNumber(), this.unsigned);
        var t = this.high >>> 16,
          r = this.high & 65535,
          n = this.low >>> 16,
          s = this.low & 65535,
        ...
        return (
          ...
          (c += t * f + r * l + n * u + s * a),
          (c &= 65535),
          V((m << 16) | y, (c << 16) | d, this.unsigned)
        );
      };
      I.mul = I.multiply;
      I.divide = function (e) {
        if ((ct(e) || (e = Ft(e)), e.isZero())) throw Error("division by zero");
        if (_t) {
          if (
            !this.unsigned &&
            ...
            return this;
          var o = (this.unsigned ? _t.div_u : _t.div_s)(
            this.low,
            this.high,
            e.low,
            e.high
        ...
        if (this.isZero()) return this.unsigned ? qt : Bt;
        var t, r, n;
        if (this.unsigned) {
          if ((e.unsigned || (e = e.toUnsigned()), e.gt(this))) return qt;
          if (e.gt(this.shru(1))) return Ki;
          n = qt;
        } else {
          if (this.eq(yt)) {
            if (e.eq(Pe) || e.eq(zn)) return yt;
            if (e.eq(yt)) return Pe;
            var s = this.shr(1);
            return (
              (t = s.div(e).shl(1)),
              t.eq(Bt)
          ...
          } else if (e.eq(yt)) return this.unsigned ? qt : Bt;
          if (this.isNegative())
            return e.isNegative()
              ? this.neg().div(e.neg())
              : this.neg().div(e).neg();
        ...
        for (r = this; r.gte(e); ) {
          ...
          for (
            ...
            (t -= u), (l = St(t, this.unsigned)), (f = l.mul(e));
          l.isZero() && (l = Pe), (n = n.add(l)), (r = r.sub(f));
        }
        return n;
      };
      I.div = I.divide;
      I.modulo = function (e) {
        if ((ct(e) || (e = Ft(e)), _t)) {
          var o = (this.unsigned ? _t.rem_u : _t.rem_s)(
            this.low,
            this.high,
            e.low,
            e.high
      ...
      I.countTrailingZeros = function () {
        return this.low ? Ui(this.low) : Ui(this.high) + 32;
      };
      ...
      I.shiftRight = function (e) {
        return (
          ...
          (e &= 63) === 0
            ...
            : V(this.high >> (e - 32), this.high >= 0 ? 0 : -1, this.unsigned)
        );
      };
      I.shr = I.shiftRight;
      I.shiftRightUnsigned = function (e) {
        return (
          ...
          (e &= 63) === 0
            ...
            : e === 32
            ? V(this.high, 0, this.unsigned)
            : V(this.high >>> (e - 32), 0, this.unsigned)
        );
      };
      ...
      I.rotateLeft = function (e) {
        ...
        return (
          ...
          (e &= 63) === 0
            ? this
            : e === 32
            ? V(this.high, this.low, this.unsigned)
            : e < 32
            ? ((o = 32 - e),
              V(
      ...
      H.fromBytes = function (e, o, t) {
        return t ? H.fromBytesLE(e, o) : H.fromBytesBE(e, o);
      };
      H.fromBytesLE = function (e, o) {
        return new H(
  ...
  var b,
    $r = x(() => {
      ...
      b.Long.create = function (i, e) {
        return i == 0 && e == 0 ? b.Long.ZERO : new b.Long(i, e);
      };
      b.Long.prototype.toFloat64 = function () {
        return (this.low >>> 0) + this.high * 4294967296;
      };
      b.Long.prototype.equals = function (i) {
        return this.low == i.low && this.high == i.high;
      };
      b.Long.ZERO = new b.Long(0, 0);
      b.Builder = function (i) {
        if (i) var e = i;
        else var e = 1024;
      ...
      b.Builder.prototype.forceDefaults = function (i) {
      ...
      b.Builder.prototype.prep = function (i, e) {
        ...
        for (
          ...
          (this.bb = b.Builder.growByteBuffer(this.bb)),
            (this.space += this.bb.capacity() - t);
        }
        this.pad(o);
      };
      b.Builder.prototype.pad = function (i) {
        for (var e = 0; e < i; e++) this.bb.writeInt8(--this.space, 0);
      };
      b.Builder.prototype.writeInt8 = function (i) {
        this.bb.writeInt8((this.space -= 1), i);
      };
      b.Builder.prototype.writeInt16 = function (i) {
        this.bb.writeInt16((this.space -= 2), i);
      };
      b.Builder.prototype.writeInt32 = function (i) {
        this.bb.writeInt32((this.space -= 4), i);
      };
      b.Builder.prototype.writeInt64 = function (i) {
        this.bb.writeInt64((this.space -= 8), i);
      };
      b.Builder.prototype.writeFloat32 = function (i) {
        this.bb.writeFloat32((this.space -= 4), i);
      };
      b.Builder.prototype.writeFloat64 = function (i) {
        this.bb.writeFloat64((this.space -= 8), i);
      };
      b.Builder.prototype.addInt8 = function (i) {
        this.prep(1, 0), this.writeInt8(i);
      };
      b.Builder.prototype.addInt16 = function (i) {
        this.prep(2, 0), this.writeInt16(i);
      };
      b.Builder.prototype.addInt32 = function (i) {
        this.prep(4, 0), this.writeInt32(i);
      };
      b.Builder.prototype.addInt64 = function (i) {
        this.prep(8, 0), this.writeInt64(i);
      };
      b.Builder.prototype.addFloat32 = function (i) {
        this.prep(4, 0), this.writeFloat32(i);
      };
      b.Builder.prototype.addFloat64 = function (i) {
        this.prep(8, 0), this.writeFloat64(i);
      };
      b.Builder.prototype.addFieldInt8 = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addInt8(e), this.slot(i));
      };
      b.Builder.prototype.addFieldInt16 = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addInt16(e), this.slot(i));
      };
      b.Builder.prototype.addFieldInt32 = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addInt32(e), this.slot(i));
      };
      b.Builder.prototype.addFieldInt64 = function (i, e, o) {
        (this.force_defaults || !e.equals(o)) &&
          (this.addInt64(e), this.slot(i));
      };
      b.Builder.prototype.addFieldFloat32 = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addFloat32(e), this.slot(i));
      };
      b.Builder.prototype.addFieldFloat64 = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addFloat64(e), this.slot(i));
      };
      b.Builder.prototype.addFieldOffset = function (i, e, o) {
        (this.force_defaults || e != o) && (this.addOffset(e), this.slot(i));
      };
      b.Builder.prototype.addFieldStruct = function (i, e, o) {
        e != o && (this.nested(e), this.slot(i));
      };
      b.Builder.prototype.nested = function (i) {
        if (i != this.offset())
      ...
      b.Builder.prototype.slot = function (i) {
        this.vtable[i] = this.offset();
      };
      b.Builder.prototype.offset = function () {
        return this.bb.capacity() - this.space;
      };
      b.Builder.growByteBuffer = function (i) {
        var e = i.capacity();
        if (e & 3221225472)
          throw new Error(
        ...
        var o = e << 1,
          t = b.ByteBuffer.allocate(o);
        return t.setPosition(o - e), t.bytes().set(i.bytes(), o - e), t;
      };
      b.Builder.prototype.addOffset = function (i) {
        this.prep(b.SIZEOF_INT, 0),
          this.writeInt32(this.offset() - i + b.SIZEOF_INT);
      };
      b.Builder.prototype.startObject = function (i) {
        this.notNested(),
      ...
      b.Builder.prototype.endObject = function () {
        ...
        t: for (e = 0; e < this.vtables.length; e++) {
          ...
          if (r == this.bb.readInt16(a)) {
            for (var u = b.SIZEOF_SHORT; u < r; u += b.SIZEOF_SHORT)
      ...
      b.Builder.prototype.finish = function (i, e, o) {
        var t = o ? b.SIZE_PREFIX_LENGTH : 0;
        if (e) {
          var r = e;
          if (
            (this.prep(
              this.minalign,
              b.SIZEOF_INT + b.FILE_IDENTIFIER_LENGTH + t
            ),
            r.length != b.FILE_IDENTIFIER_LENGTH)
          )
            throw new Error(
              "FlatBuffers: file identifier must be length " +
                b.FILE_IDENTIFIER_LENGTH
            );
          for (var n = b.FILE_IDENTIFIER_LENGTH - 1; n >= 0; n--)
            this.writeInt8(r.charCodeAt(n));
        }
        this.prep(this.minalign, b.SIZEOF_INT + t),
          this.addOffset(i),
          t && this.addInt32(this.bb.capacity() - this.space),
          this.bb.setPosition(this.space);
      };
      b.Builder.prototype.finishSizePrefixed = function (i, e) {
        this.finish(i, e, !0);
      };
      b.Builder.prototype.requiredField = function (i, e) {
      ...
      b.Builder.prototype.startVector = function (i, e, o) {
        this.notNested(),
          (this.vector_num_elems = e),
          this.prep(b.SIZEOF_INT, i * e),
          this.prep(o, i * e);
      };
      b.Builder.prototype.endVector = function () {
        return this.writeInt32(this.vector_num_elems), this.offset();
      };
      b.Builder.prototype.createString = function (i) {
      ...
      b.Builder.prototype.createLong = function (i, e) {
        return b.Long.create(i, e);
      };
      b.ByteBuffer = function (i) {
        (this.bytes_ = i), (this.position_ = 0);
      };
      b.ByteBuffer.allocate = function (i) {
        return new b.ByteBuffer(new Uint8Array(i));
      };
      ...
      b.ByteBuffer.prototype.setPosition = function (i) {
        this.position_ = i;
      };
      b.ByteBuffer.prototype.capacity = function () {
        return this.bytes_.length;
      };
      b.ByteBuffer.prototype.readInt8 = function (i) {
        return (this.readUint8(i) << 24) >> 24;
      };
      b.ByteBuffer.prototype.readUint8 = function (i) {
        return this.bytes_[i];
      };
      b.ByteBuffer.prototype.readInt16 = function (i) {
        return (this.readUint16(i) << 16) >> 16;
      };
      b.ByteBuffer.prototype.readUint16 = function (i) {
        return this.bytes_[i] | (this.bytes_[i + 1] << 8);
      };
      b.ByteBuffer.prototype.readInt32 = function (i) {
        return (
          this.bytes_[i] |
          (this.bytes_[i + 1] << 8) |
          (this.bytes_[i + 2] << 16) |
      ...
      b.ByteBuffer.prototype.readUint32 = function (i) {
        return this.readInt32(i) >>> 0;
      };
      b.ByteBuffer.prototype.readInt64 = function (i) {
        return new b.Long(this.readInt32(i), this.readInt32(i + 4));
      };
      b.ByteBuffer.prototype.readUint64 = function (i) {
        return new b.Long(this.readUint32(i), this.readUint32(i + 4));
      };
      b.ByteBuffer.prototype.readFloat32 = function (i) {
        return (b.int32[0] = this.readInt32(i)), b.float32[0];
      };
      b.ByteBuffer.prototype.readFloat64 = function (i) {
        return (
          (b.int32[b.isLittleEndian ? 0 : 1] = this.readInt32(i)),
          (b.int32[b.isLittleEndian ? 1 : 0] = this.readInt32(i + 4)),
          b.float64[0]
        );
      };
      b.ByteBuffer.prototype.writeInt8 = function (i, e) {
        this.bytes_[i] = e;
      };
      b.ByteBuffer.prototype.writeUint8 = function (i, e) {
        this.bytes_[i] = e;
      };
      b.ByteBuffer.prototype.writeInt16 = function (i, e) {
        (this.bytes_[i] = e), (this.bytes_[i + 1] = e >> 8);
      };
      b.ByteBuffer.prototype.writeUint16 = function (i, e) {
        (this.bytes_[i] = e), (this.bytes_[i + 1] = e >> 8);
      };
      b.ByteBuffer.prototype.writeInt32 = function (i, e) {
        (this.bytes_[i] = e),
          (this.bytes_[i + 1] = e >> 8),
          (this.bytes_[i + 2] = e >> 16),
          (this.bytes_[i + 3] = e >> 24);
      };
      b.ByteBuffer.prototype.writeUint32 = function (i, e) {
        (this.bytes_[i] = e),
          (this.bytes_[i + 1] = e >> 8),
          (this.bytes_[i + 2] = e >> 16),
          (this.bytes_[i + 3] = e >> 24);
      };
      b.ByteBuffer.prototype.writeInt64 = function (i, e) {
        this.writeInt32(i, e.low), this.writeInt32(i + 4, e.high);
      };
      b.ByteBuffer.prototype.writeUint64 = function (i, e) {
        this.writeUint32(i, e.low), this.writeUint32(i + 4, e.high);
      };
      b.ByteBuffer.prototype.writeFloat32 = function (i, e) {
        (b.float32[0] = e), this.writeInt32(i, b.int32[0]);
      };
      b.ByteBuffer.prototype.writeFloat64 = function (i, e) {
        (b.float64[0] = e),
          this.writeInt32(i, b.int32[b.isLittleEndian ? 0 : 1]),
          this.writeInt32(i + 4, b.int32[b.isLittleEndian ? 1 : 0]);
      };
      b.ByteBuffer.prototype.getBufferIdentifier = function () {
        if (
          this.bytes_.length <
          this.position_ + b.SIZEOF_INT + b.FILE_IDENTIFIER_LENGTH
        )
          throw new Error(
            "FlatBuffers: ByteBuffer is too short to contain an identifier."
          );
        for (var i = "", e = 0; e < b.FILE_IDENTIFIER_LENGTH; e++)
          i += String.fromCharCode(
            this.readInt8(this.position_ + b.SIZEOF_INT + e)
          );
        return i;
      };
      b.ByteBuffer.prototype.__offset = function (i, e) {
        var o = i - this.readInt32(i);
        return e < this.readInt16(o) ? this.readInt16(o + e) : 0;
      };
      b.ByteBuffer.prototype.__union = function (i, e) {
        return (i.bb_pos = e + this.readInt32(e)), (i.bb = this), i;
      };
      b.ByteBuffer.prototype.__string = function (i, e) {
        i += this.readInt32(i);
        var o = this.readInt32(i),
          t = "",
          r = 0;
        if (((i += b.SIZEOF_INT), e === b.Encoding.UTF8_BYTES))
      ...
      b.ByteBuffer.prototype.__indirect = function (i) {
        return i + this.readInt32(i);
      };
      b.ByteBuffer.prototype.__vector = function (i) {
        return i + this.readInt32(i) + b.SIZEOF_INT;
      };
      b.ByteBuffer.prototype.__vector_len = function (i) {
        return this.readInt32(i + this.readInt32(i));
      };
      b.ByteBuffer.prototype.__has_identifier = function (i) {
        if (i.length != b.FILE_IDENTIFIER_LENGTH)
          throw new Error(
            "FlatBuffers: file identifier must be length " +
              b.FILE_IDENTIFIER_LENGTH
          );
        for (var e = 0; e < b.FILE_IDENTIFIER_LENGTH; e++)
          if (
            i.charCodeAt(e) != this.readInt8(this.position_ + b.SIZEOF_INT + e)
          )
            return !1;
        return !0;
      };
      b.ByteBuffer.prototype.createLong = function (i, e) {
        return b.Long.create(i, e);
      };
    });
  var P,
        ...
        ((t) => {
          ...
          ((n) => {
            ...
            ((v) => (
              ...
              (v[(v.FLOATS = 6)] = "FLOATS"),
              (v[(v.INTS = 7)] = "INTS"),
              (v[(v.STRINGS = 8)] = "STRINGS"),
              (v[(v.TENSORS = 9)] = "TENSORS"),
              (v[(v.GRAPHS = 10)] = "GRAPHS"),
              (v[(v.SPARSE_TENSOR = 11)] = "SPARSE_TENSOR"),
              (v[(v.SPARSE_TENSORS = 12)] = "SPARSE_TENSORS")
            ))((r = n.AttributeType ||= {}));
          })((o = t.fbs ||= {}));
        })((i = e.experimental ||= {}));
      })((P ||= {}));
        ...
        ((t) => {
          ...
          ((n) => {
            ...
            ((k) => (
              ...
              (k[(k.STRING = 8)] = "STRING"),
              (k[(k.BOOL = 9)] = "BOOL"),
              (k[(k.FLOAT16 = 10)] = "FLOAT16"),
              (k[(k.DOUBLE = 11)] = "DOUBLE"),
              (k[(k.UINT32 = 12)] = "UINT32"),
              (k[(k.UINT64 = 13)] = "UINT64"),
              (k[(k.COMPLEX64 = 14)] = "COMPLEX64"),
              (k[(k.COMPLEX128 = 15)] = "COMPLEX128"),
              (k[(k.BFLOAT16 = 16)] = "BFLOAT16"),
              (k[(k.FLOAT8E4M3FN = 17)] = "FLOAT8E4M3FN"),
              (k[(k.FLOAT8E4M3FNUZ = 18)] = "FLOAT8E4M3FNUZ"),
              (k[(k.FLOAT8E5M2 = 19)] = "FLOAT8E5M2"),
              (k[(k.FLOAT8E5M2FNUZ = 20)] = "FLOAT8E5M2FNUZ")
            ))((r = n.TensorDataType ||= {}));
          })((o = t.fbs ||= {}));
        })((i = e.experimental ||= {}));
      })((P ||= {}));
          ...
          ((n) => {
            class r {
              ...
              static getSizePrefixedRootAsShape(a, u) {
                return (
                  a.setPosition(a.position() + b.SIZE_PREFIX_LENGTH),
                  (u || new r()).__init(
                    a.readInt32(a.position()) + a.position(),
                    a
                  )
        ...
        ((t) => {
          ...
          ((n) => {
            class r {
              ...
              static createNode(a, u, l, f, c, d, m, y, g, T, _, w, v, L) {
                return (
                  r.startNode(a),
                  r.addName(a, u),
                  r.addDocString(a, l),
                  r.addDomain(a, f),
                  r.addSinceVersion(a, c),
                  r.addIndex(a, d),
                  r.addOpType(a, m),
                  r.addType(a, y),
                  r.addExecutionProviderType(a, g),
                  r.addInputs(a, T),
                  r.addOutputs(a, _),
                  r.addAttributes(a, w),
                  r.addInputArgCounts(a, v),
                  r.addImplicitInputs(a, L),
                  r.endNode(a)
                );
              }
            }
        ...
        ((t) => {
          ...
          ((n) => {
            class r {
              ...
              static createTensor(a, u, l, f, c, d, m) {
                return (
                  r.startTensor(a),
                  r.addName(a, u),
                  r.addDocString(a, l),
          ...
          ((n) => {
            class r {
              ...
              floats(a) {
                ...
                return u
                  ? this.bb.readFloat32(
                      this.bb.__vector(this.bb_pos + u) + a * 4
                    )
                  : 0;
              }
              floatsLength() {
              ...
              static createAttribute(a, u, l, f, c, d, m, y, g, T, _, w, v, L) {
                return (
                  r.startAttribute(a),
                  r.addName(a, u),
                  r.addDocString(a, l),
        ...
        ((t) => {
          ...
          ((n) => {
            class r {
              ...
              static createGraph(a, u, l, f, c, d, m, y, g) {
                return (
                  r.startGraph(a),
                  r.addInitializers(a, u),
                  r.addNodeArgs(a, l),
                  r.addNodes(a, f),
                  r.addMaxNodeIndex(a, c),
                  r.addNodeEdges(a, d),
                  r.addInputs(a, m),
                  r.addOutputs(a, y),
                  r.addSparseInitializers(a, g),
                  r.endGraph(a)
                );
              }
            }
        ...
        ((t) => {
          ...
          ((n) => {
            class r {
              ...
              static createModel(a, u, l, f, c, d, m, y, g, T) {
                return (
                  r.startModel(a),
                  r.addIrVersion(a, u),
                  r.addOpsetImport(a, l),
                  r.addProducerName(a, f),
                  r.addProducerVersion(a, c),
                  r.addDomain(a, d),
                  r.addModelVersion(a, m),
                  r.addDocString(a, y),
                  r.addGraph(a, g),
                  r.addGraphDocString(a, T),
                  r.endModel(a)
                );
              }
            }
          ...
          ((n) => {
            class r {
              ...
              kernelDefHashes(a) {
                ...
                return u
                  ? this.bb.readUint64(
                      this.bb.__vector(this.bb_pos + u) + a * 8
                    )
                  : this.bb.createLong(0, 0);
              }
  ...
  var na = tt((ra) => {
    ...
    var Nt;
    kr.encode = function (e, o, t) {
      for (var r = null, n = [], s = 0, a = 0, u; o < t; ) {
        var l = e[o++];
        switch (a) {
          case 0:
            (n[s++] = De[l >> 2]), (u = (l & 3) << 4), (a = 1);
            break;
          case 1:
            (n[s++] = De[u | (l >> 4)]), (u = (l & 15) << 2), (a = 2);
            break;
          case 2:
            (n[s++] = De[u | (l >> 6)]), (n[s++] = De[l & 63]), (a = 0);
            break;
        }
        s > 8191 &&
    ...
    var ta = "invalid encoding";
    kr.decode = function (e, o, t) {
      for (var r = t, n = 0, s, a = 0; a < e.length; ) {
        var u = e.charCodeAt(a++);
        if (u === 61 && n > 1) break;
        if ((u = ea[u]) === void 0) throw Error(ta);
        switch (n) {
          case 0:
            (s = u), (n = 1);
            break;
  ...
  var ia = tt((wb, oa) => {
    ...
    Br.prototype.on = function (e, o, t) {
      return (
  ...
  var pa = tt((vb, ca) => {
      ...
      return (
        typeof Float32Array < "u"
          ...
          : (function () {
              ...
              (i.writeFloatLE = e.bind(null, sa)),
                (i.writeFloatBE = e.bind(null, ua));
              function o(t, r, n) {
                var s = t(r, n),
                  a = (s >> 31) * 2 + 1,
                  u = (s >>> 23) & 255,
              ...
              (i.readFloatLE = o.bind(null, la)),
                (i.readFloatBE = o.bind(null, fa));
            })(),
        typeof Float64Array < "u"
          ...
          : (function () {
              ...
              (i.writeDoubleLE = e.bind(null, sa, 0, 4)),
                (i.writeDoubleBE = e.bind(null, ua, 4, 0));
              function o(t, r, n, s, a) {
                ...
                return c === 2047
                  ...
                  : c === 0
                  ? f * 5e-324 * d
                  : f * Math.pow(2, c - 1075) * (d + 4503599627370496);
              }
              (i.readDoubleLE = o.bind(null, la, 0, 4)),
                (i.readDoubleBE = o.bind(null, fa, 4, 0));
            })(),
        i
      );
    }
    ...
    function la(i, e) {
      return (
        (i[e] | (i[e + 1] << 8) | (i[e + 2] << 16) | (i[e + 3] << 24)) >>> 0
      );
    }
    function fa(i, e) {
      return (
        ...
        (u = e[o++]),
          u < 128
            ...
            ? ((u =
              ...
              (s[a++] = 56320 + (u & 1023)))
            : (s[a++] =
                ((u & 15) << 12) | ((e[o++] & 63) << 6) | (e[o++] & 63)),
          a > 8191 &&
            ((n || (n = [])).push(String.fromCharCode.apply(String, s)),
            (a = 0));
      return n
  ...
  var xa = tt((Sb, ga) => {
    ...
    var ce = (it.zero = new it(0, 0));
    ce.toNumber = function () {
      return 0;
    };
    ce.zzEncode = ce.zzDecode = function () {
      return this;
    };
    ce.length = function () {
      return 1;
    };
    var Cc = (it.zeroHash = "\0\0\0\0\0\0\0\0");
    it.fromNumber = function (e) {
      if (e === 0) return ce;
      var o = e < 0;
      o && (e = -e);
      var t = e >>> 0,
    ...
    it.from = function (e) {
      if (typeof e == "number") return it.fromNumber(e);
      if (Xe.isString(e))
        if (Xe.Long) e = Xe.Long.fromString(e);
        else return it.fromNumber(parseInt(e, 10));
      return e.low || e.high ? new it(e.low >>> 0, e.high >>> 0) : ce;
    };
    it.prototype.toNumber = function (e) {
      if (!e && this.hi >>> 31) {
        var o = (~this.lo + 1) >>> 0,
          t = ~this.hi >>> 0;
    ...
    it.prototype.toLong = function (e) {
      return Xe.Long
        ? new Xe.Long(this.lo | 0, this.hi | 0, !!e)
        : { low: this.lo | 0, high: this.hi | 0, unsigned: !!e };
    };
    var Qt = String.prototype.charCodeAt;
    it.fromHash = function (e) {
      return e === Cc
        ? ce
        : new it(
            (Qt.call(e, 0) |
    ...
    it.prototype.zzEncode = function () {
      var e = this.hi >> 31;
      return (
    ...
    it.prototype.zzDecode = function () {
      var e = -(this.lo & 1);
      return (
  ...
  var te = tt((jn) => {
    ...
    E.longFromHash = function (e, o) {
      var t = E.LongBits.fromHash(e);
      return E.Long ? E.Long.fromBits(t.lo, t.hi, o) : t.toNumber(!!o);
    };
    function Ta(i, e, o) {
    ...
    E.newError = wa;
    E.ProtocolError = wa("ProtocolError");
  ...
  var to = tt((Ab, Sa) => {
    ...
    Ot.Array !== Array &&
      (G.alloc = Ot.pool(G.alloc, Ot.Array.prototype.subarray));
    G.prototype._push = function (e, o, t) {
      return (
        (this.tail = this.tail.next = new Ke(e, o, t)), (this.len += o), this
      );
    };
    function Zn(i, e, o) {
      e[o] = i & 255;
    ...
    Yn.prototype = Object.create(Ke.prototype);
    Yn.prototype.fn = Gc;
    ...
    G.prototype.int32 = function (e) {
      return e < 0 ? this._push(Qn, 10, Fr.fromNumber(e)) : this.uint32(e);
    };
    ...
    G.prototype.bytes = function (e) {
      var o = e.length >>> 0;
      if (!o) return this._push(Zn, 1, 0);
      if (Ot.isString(e)) {
        var t = G.alloc((o = va.length(e)));
        va.decode(e, t, 0), (e = t);
      }
      return this.uint32(o)._push(Mc, o, e);
    };
    G.prototype.string = function (e) {
      var o = Ia.length(e);
      return o ? this.uint32(o)._push(Ia.write, o, e) : this._push(Zn, 1, 0);
    };
    G.prototype.fork = function () {
      return (
        (this.states = new Rc(this)),
        (this.head = this.tail = new Ke(Jn, 0, 0)),
        (this.len = 0),
        this
      );
    };
    G.prototype.reset = function () {
      return (
        this.states
          ...
          : ((this.head = this.tail = new Ke(Jn, 0, 0)), (this.len = 0)),
        this
      );
    };
    ...
    G._configure = function (i) {
      (Xn = i), (G.create = _a()), Xn._configure();
    };
  });
  var Pa = tt((Pb, Aa) => {
    "use strict";
    Aa.exports = Mt;
    var Oa = to();
    (Mt.prototype = Object.create(Oa.prototype)).constructor = Mt;
    var ee = te();
    function Mt() {
      Oa.call(this);
    }
    Mt._configure = function () {
      (Mt.alloc = ee._Buffer_allocUnsafe),
        (Mt.writeBytesBuffer =
          ee.Buffer &&
          ee.Buffer.prototype instanceof Uint8Array &&
          ee.Buffer.prototype.set.name === "set"
            ? function (e, o, t) {
                o.set(e, t);
              }
            : function (e, o, t) {
    ...
    Mt.prototype.bytes = function (e) {
      ee.isString(e) && (e = ee._Buffer_from(e, "base64"));
      var o = e.length >>> 0;
      return this.uint32(o), o && this._push(Mt.writeBytesBuffer, o, e), this;
    };
    function Vc(i, e, o) {
      i.length < 40
        ? ee.utf8.write(i, e, o)
    ...
    Mt.prototype.string = function (e) {
      var o = ee.Buffer.byteLength(e);
      return this.uint32(o), o && this._push(Vc, o, e), this;
    };
    Mt._configure();
  });
  var no = tt((Eb, ka) => {
    ...
    var Ea =
        typeof Uint8Array < "u"
          ? function (e) {
              if (e instanceof Uint8Array || Array.isArray(e)) return new K(e);
      ...
      $a = function () {
        return Ct.Buffer
          ? function (o) {
              return (K.create = function (r) {
                return Ct.Buffer.isBuffer(r) ? new ro(r) : Ea(r);
              })(o);
            }
          : Ea;
      };
    K.create = $a();
    K.prototype._slice =
      Ct.Array.prototype.subarray || Ct.Array.prototype.slice;
    K.prototype.uint32 = (function () {
      var e = 4294967295;
      return function () {
        if (
    ...
    function eo() {
      ...
      if (this.len - this.pos > 4) {
        ...
        for (; e < 3; ++e) {
          if (this.pos >= this.len) throw Rt(this);
          if (
            ((i.lo = (i.lo | ((this.buf[this.pos] & 127) << (e * 7))) >>> 0),
            this.buf[this.pos++] < 128)
          )
      ...
      if (this.len - this.pos > 4) {
        for (; e < 5; ++e)
          if (
            ((i.hi =
              (i.hi | ((this.buf[this.pos] & 127) << (e * 7 + 3))) >>> 0),
            this.buf[this.pos++] < 128)
          )
            return i;
      } else
    ...
    K.prototype.fixed32 = function () {
      if (this.pos + 4 > this.len) throw Rt(this, 4);
      return Nr(this.buf, (this.pos += 4));
    };
    K.prototype.sfixed32 = function () {
      if (this.pos + 4 > this.len) throw Rt(this, 4);
      return Nr(this.buf, (this.pos += 4)) | 0;
    };
    function Da() {
      if (this.pos + 8 > this.len) throw Rt(this, 8);
      return new La(
        Nr(this.buf, (this.pos += 4)),
        Nr(this.buf, (this.pos += 4))
      );
    }
    K.prototype.float = function () {
      if (this.pos + 4 > this.len) throw Rt(this, 4);
      var e = Ct.float.readFloatLE(this.buf, this.pos);
      return (this.pos += 4), e;
    };
    K.prototype.double = function () {
      if (this.pos + 8 > this.len) throw Rt(this, 4);
      var e = Ct.float.readDoubleLE(this.buf, this.pos);
      return (this.pos += 8), e;
    };
    K.prototype.bytes = function () {
      var e = this.uint32(),
        o = this.pos,
        t = this.pos + e;
      if (t > this.len) throw Rt(this, e);
      if (((this.pos += e), Array.isArray(this.buf)))
        return this.buf.slice(o, t);
      if (o === t) {
        var r = Ct.Buffer;
    ...
    K.prototype.string = function () {
      var e = this.bytes();
      return Uc.read(e, 0, e.length);
    };
    K.prototype.skip = function (e) {
      if (typeof e == "number") {
        if (this.pos + e > this.len) throw Rt(this, e);
        this.pos += e;
      } else
        do if (this.pos >= this.len) throw Rt(this);
        while (this.buf[this.pos++] & 128);
      return this;
    };
    K.prototype.skipType = function (i) {
      switch (i) {
        case 0:
          this.skip();
          break;
    ...
    K._configure = function (i) {
      (ro = i), (K.create = $a()), ro._configure();
      var e = Ct.Long ? "toLong" : "toNumber";
      Ct.merge(K.prototype, {
        int64: function () {
          return eo.call(this)[e](!1);
        },
        uint64: function () {
          return eo.call(this)[e](!0);
        },
        sint64: function () {
          return eo.call(this).zzDecode()[e](!1);
        },
        fixed64: function () {
          return Da.call(this)[e](!0);
        },
        sfixed64: function () {
          return Da.call(this)[e](!1);
        },
      });
    };
  });
  var Ca = tt((Db, Na) => {
    ...
    Na.exports = pe;
    var Fa = no();
    (pe.prototype = Object.create(Fa.prototype)).constructor = pe;
    var Ba = te();
    function pe(i) {
      Fa.call(this, i);
    }
    pe._configure = function () {
      Ba.Buffer && (pe.prototype._slice = Ba.Buffer.prototype.slice);
    };
  ...
  var Ga = tt((Lb, Ra) => {
    ...
    Ra.exports = Je;
    var oo = te();
    (Je.prototype = Object.create(oo.EventEmitter.prototype)).constructor = Je;
    function Je(i, e, o) {
    ...
    Je.prototype.rpcCall = function i(e, o, t, r, n) {
      if (!r) throw TypeError("request must be specified");
      var s = this;
      if (!n) return oo.asPromise(i, s, e, o, t, r);
      if (!s.rpcImpl) {
        setTimeout(function () {
  ...
  var qa = tt((Ha) => {
    ...
    function Wa() {
      gt.util._configure(),
        gt.Writer._configure(gt.BufferWriter),
        gt.Reader._configure(gt.BufferReader);
    }
    Wa();
  });
  var Xa = tt((Fb, ja) => {
  ...
  var Le = tt((Nb, Ka) => {
    ...
    var q = Xa(),
      ...
      J = q.Writer,
      h = q.util,
      p = q.roots.default || (q.roots.default = {});
    p.onnx = (function () {
      var i = {};
      return (
        (i.Version = (function () {
        ...
        (i.AttributeProto = (function () {
          ...
          return (
            ...
            (e.prototype.type = 0),
            (e.prototype.f = 0),
            (e.prototype.i = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
            (e.prototype.s = h.newBuffer([])),
            (e.prototype.t = null),
            (e.prototype.g = null),
            (e.prototype.sparseTensor = null),
            (e.prototype.tp = null),
            (e.prototype.floats = h.emptyArray),
            (e.prototype.ints = h.emptyArray),
            (e.prototype.strings = h.emptyArray),
            (e.prototype.tensors = h.emptyArray),
            (e.prototype.graphs = h.emptyArray),
            (e.prototype.sparseTensors = h.emptyArray),
            (e.prototype.typeProtos = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if (
                ...
                t.t != null &&
                  ...
                  p.onnx.TensorProto.encode(t.t, r.uint32(42).fork()).ldelim(),
                t.g != null &&
                  Object.hasOwnProperty.call(t, "g") &&
                  p.onnx.GraphProto.encode(t.g, r.uint32(50).fork()).ldelim(),
              ...
              if (
                ...
                t.tp != null &&
                  ...
                  p.onnx.TypeProto.encode(t.tp, r.uint32(114).fork()).ldelim(),
                t.typeProtos != null && t.typeProtos.length)
              )
                for (var n = 0; n < t.typeProtos.length; ++n)
                  p.onnx.TypeProto.encode(
                    t.typeProtos[n],
                    r.uint32(122).fork()
                  ).ldelim();
              if (
                ...
                t.sparseTensor != null &&
                  ...
                  p.onnx.SparseTensorProto.encode(
                    t.sparseTensor,
                    r.uint32(178).fork()
                  ).ldelim(),
            ...
            (e.decode = function (t, r) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 5: {
                    s.t = p.onnx.TensorProto.decode(t, t.uint32());
                    break;
                  }
                  case 6: {
                    s.g = p.onnx.GraphProto.decode(t, t.uint32());
                    break;
                  }
                  case 22: {
                    s.sparseTensor = p.onnx.SparseTensorProto.decode(
                      t,
                      t.uint32()
                    );
                    break;
                  ...
                  case 14: {
                    s.tp = p.onnx.TypeProto.decode(t, t.uint32());
                    break;
                  }
                  case 7: {
                    if (
                  ...
                  case 10: {
                    (s.tensors && s.tensors.length) || (s.tensors = []),
                      s.tensors.push(p.onnx.TensorProto.decode(t, t.uint32()));
                    break;
                  }
                  case 11: {
                    (s.graphs && s.graphs.length) || (s.graphs = []),
                      s.graphs.push(p.onnx.GraphProto.decode(t, t.uint32()));
                    break;
                  }
                  case 23: {
                    (s.sparseTensors && s.sparseTensors.length) ||
                      ...
                      s.sparseTensors.push(
                        p.onnx.SparseTensorProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 15: {
                    (s.typeProtos && s.typeProtos.length) ||
                      (s.typeProtos = []),
                      s.typeProtos.push(p.onnx.TypeProto.decode(t, t.uint32()));
                    break;
                  }
                  default:
                    t.skipType(a & 7);
            ...
            (e.verify = function (t) {
              ...
              if (
                ...
                !h.isString(t.refAttrName)
              )
                return "refAttrName: string expected";
              if (
                t.docString != null &&
                t.hasOwnProperty("docString") &&
                !h.isString(t.docString)
              )
              ...
              if (
                ...
                t.hasOwnProperty("i") &&
                !h.isInteger(t.i) &&
                !(t.i && h.isInteger(t.i.low) && h.isInteger(t.i.high))
              )
                return "i: integer|Long expected";
              if (
                t.s != null &&
                t.hasOwnProperty("s") &&
                !((t.s && typeof t.s.length == "number") || h.isString(t.s))
              )
                return "s: buffer expected";
              if (t.t != null && t.hasOwnProperty("t")) {
                var r = p.onnx.TensorProto.verify(t.t);
                if (r) return "t." + r;
              }
              if (t.g != null && t.hasOwnProperty("g")) {
                var r = p.onnx.GraphProto.verify(t.g);
                if (r) return "g." + r;
              }
              if (t.sparseTensor != null && t.hasOwnProperty("sparseTensor")) {
                var r = p.onnx.SparseTensorProto.verify(t.sparseTensor);
                if (r) return "sparseTensor." + r;
              }
              if (t.tp != null && t.hasOwnProperty("tp")) {
                var r = p.onnx.TypeProto.verify(t.tp);
                if (r) return "tp." + r;
              }
              ...
              if (t.ints != null && t.hasOwnProperty("ints")) {
                ...
                for (var n = 0; n < t.ints.length; ++n)
                  if (
                    !h.isInteger(t.ints[n]) &&
                    !(
                      t.ints[n] &&
                      h.isInteger(t.ints[n].low) &&
                      h.isInteger(t.ints[n].high)
                    )
                  )
              ...
              if (t.strings != null && t.hasOwnProperty("strings")) {
                ...
                for (var n = 0; n < t.strings.length; ++n)
                  if (
                    !(
                      (t.strings[n] &&
                        typeof t.strings[n].length == "number") ||
                      h.isString(t.strings[n])
                    )
                  )
              ...
              if (t.tensors != null && t.hasOwnProperty("tensors")) {
                ...
                for (var n = 0; n < t.tensors.length; ++n) {
                  var r = p.onnx.TensorProto.verify(t.tensors[n]);
              ...
              if (t.graphs != null && t.hasOwnProperty("graphs")) {
                ...
                for (var n = 0; n < t.graphs.length; ++n) {
                  var r = p.onnx.GraphProto.verify(t.graphs[n]);
                  if (r) return "graphs." + r;
                }
              }
              if (
                t.sparseTensors != null &&
                t.hasOwnProperty("sparseTensors")
              ) {
                if (!Array.isArray(t.sparseTensors))
                  return "sparseTensors: array expected";
                for (var n = 0; n < t.sparseTensors.length; ++n) {
                  var r = p.onnx.SparseTensorProto.verify(t.sparseTensors[n]);
              ...
              if (t.typeProtos != null && t.hasOwnProperty("typeProtos")) {
                ...
                for (var n = 0; n < t.typeProtos.length; ++n) {
                  var r = p.onnx.TypeProto.verify(t.typeProtos[n]);
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.AttributeProto) return t;
              var r = new p.onnx.AttributeProto();
              switch (
                (t.name != null && (r.name = String(t.name)),
                t.refAttrName != null &&
                  (r.refAttrName = String(t.refAttrName)),
              ...
              if (
                ...
                t.i != null &&
                  (h.Long
                    ? ((r.i = h.Long.fromValue(t.i)).unsigned = !1)
                    : typeof t.i == "string"
                    ? (r.i = parseInt(t.i, 10))
                    : typeof t.i == "number"
                    ? (r.i = t.i)
                ...
                t.s != null &&
                  (typeof t.s == "string"
                    ? h.base64.decode(
                        t.s,
                        (r.s = h.newBuffer(h.base64.length(t.s))),
                        0
                      )
                ...
                r.t = p.onnx.TensorProto.fromObject(t.t);
              }
              if (t.g != null) {
                if (typeof t.g != "object")
                  throw TypeError(".onnx.AttributeProto.g: object expected");
                r.g = p.onnx.GraphProto.fromObject(t.g);
              }
              if (t.sparseTensor != null) {
                ...
                r.sparseTensor = p.onnx.SparseTensorProto.fromObject(
                  t.sparseTensor
                );
              }
              if (t.tp != null) {
                ...
                r.tp = p.onnx.TypeProto.fromObject(t.tp);
              }
              if (t.floats) {
              ...
              if (t.strings) {
                ...
                for (var n = 0; n < t.strings.length; ++n)
                  typeof t.strings[n] == "string"
                    ? h.base64.decode(
                        t.strings[n],
                        (r.strings[n] = h.newBuffer(
                          h.base64.length(t.strings[n])
                        )),
                        0
                      )
              ...
              if (t.tensors) {
                ...
                for (var n = 0; n < t.tensors.length; ++n) {
                  ...
                  r.tensors[n] = p.onnx.TensorProto.fromObject(t.tensors[n]);
                }
              }
              if (t.graphs) {
                ...
                for (var n = 0; n < t.graphs.length; ++n) {
                  ...
                  r.graphs[n] = p.onnx.GraphProto.fromObject(t.graphs[n]);
                }
              }
              if (t.sparseTensors) {
                if (!Array.isArray(t.sparseTensors))
                ...
                for (var n = 0; n < t.sparseTensors.length; ++n) {
                  ...
                  r.sparseTensors[n] = p.onnx.SparseTensorProto.fromObject(
                    t.sparseTensors[n]
                  );
                }
              }
              if (t.typeProtos) {
                ...
                for (var n = 0; n < t.typeProtos.length; ++n) {
                  ...
                  r.typeProtos[n] = p.onnx.TypeProto.fromObject(
                    t.typeProtos[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                if (((n.name = ""), (n.f = 0), h.Long)) {
                  var s = new h.Long(0, 0, !1);
                  n.i =
                    r.longs === String
                      ? s.toString()
                      : r.longs === Number
                ...
                r.bytes === String
                  ? (n.s = "")
                  : ((n.s = []), r.bytes !== Array && (n.s = h.newBuffer(n.s))),
                  (n.t = null),
                  (n.g = null),
                  (n.docString = ""),
                  (n.tp = null),
              ...
              if (
                ...
                t.i != null &&
                  ...
                  (typeof t.i == "number"
                    ...
                    : (n.i =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.i)
                          : r.longs === Number
                          ? new h.LongBits(
                              t.i.low >>> 0,
                              t.i.high >>> 0
                ...
                t.s != null &&
                  ...
                  (n.s =
                    r.bytes === String
                      ? h.base64.encode(t.s, 0, t.s.length)
                      : r.bytes === Array
                      ? Array.prototype.slice.call(t.s)
                      : t.s),
                t.t != null &&
                  t.hasOwnProperty("t") &&
                  (n.t = p.onnx.TensorProto.toObject(t.t, r)),
                t.g != null &&
                  t.hasOwnProperty("g") &&
                  (n.g = p.onnx.GraphProto.toObject(t.g, r)),
              ...
              if (t.ints && t.ints.length) {
                ...
                for (var a = 0; a < t.ints.length; ++a)
                  typeof t.ints[a] == "number"
                    ...
                    : (n.ints[a] =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.ints[a])
                          : r.longs === Number
                          ? new h.LongBits(
                              t.ints[a].low >>> 0,
                              t.ints[a].high >>> 0
              ...
              if (t.strings && t.strings.length) {
                ...
                for (var a = 0; a < t.strings.length; ++a)
                  n.strings[a] =
                    r.bytes === String
                      ? h.base64.encode(t.strings[a], 0, t.strings[a].length)
                      : r.bytes === Array
              ...
              if (t.tensors && t.tensors.length) {
                ...
                for (var a = 0; a < t.tensors.length; ++a)
                  n.tensors[a] = p.onnx.TensorProto.toObject(t.tensors[a], r);
              }
              if (t.graphs && t.graphs.length) {
                n.graphs = [];
                for (var a = 0; a < t.graphs.length; ++a)
                  n.graphs[a] = p.onnx.GraphProto.toObject(t.graphs[a], r);
              }
              if (
                (t.docString != null &&
                  t.hasOwnProperty("docString") &&
                ...
                t.tp != null &&
                  t.hasOwnProperty("tp") &&
                  (n.tp = p.onnx.TypeProto.toObject(t.tp, r)),
                t.typeProtos && t.typeProtos.length)
              ) {
                n.typeProtos = [];
                for (var a = 0; a < t.typeProtos.length; ++a)
                  n.typeProtos[a] = p.onnx.TypeProto.toObject(
                    t.typeProtos[a],
                    r
                  );
              }
              if (
                (t.type != null &&
                  ...
                  (n.type =
                    r.enums === String
                      ? p.onnx.AttributeProto.AttributeType[t.type] === void 0
                        ? t.type
                        : p.onnx.AttributeProto.AttributeType[t.type]
                      : t.type),
                t.refAttrName != null &&
                  t.hasOwnProperty("refAttrName") &&
                ...
                t.sparseTensor != null &&
                  ...
                  (n.sparseTensor = p.onnx.SparseTensorProto.toObject(
                    t.sparseTensor,
                    r
                  )),
                ...
                for (var a = 0; a < t.sparseTensors.length; ++a)
                  n.sparseTensors[a] = p.onnx.SparseTensorProto.toObject(
                    t.sparseTensors[a],
                    r
                  );
              }
            ...
            (e.prototype.toJSON = function () {
              return this.constructor.toObject(this, q.util.toJSONOptions);
            }),
          ...
          return (
            ...
            (e.encode = function (t, r) {
              return (
                ...
                t.type != null &&
                  Object.hasOwnProperty.call(t, "type") &&
                  p.onnx.TypeProto.encode(t.type, r.uint32(18).fork()).ldelim(),
                t.docString != null &&
                  Object.hasOwnProperty.call(t, "docString") &&
            ...
            (e.decode = function (t, r) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 2: {
                    s.type = p.onnx.TypeProto.decode(t, t.uint32());
                    break;
                  }
                  case 3: {
                    s.docString = t.string();
            ...
            (e.verify = function (t) {
              ...
              if (
                ...
                return "name: string expected";
              if (t.type != null && t.hasOwnProperty("type")) {
                var r = p.onnx.TypeProto.verify(t.type);
                if (r) return "type." + r;
              }
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.ValueInfoProto) return t;
              var r = new p.onnx.ValueInfoProto();
              if (
                (t.name != null && (r.name = String(t.name)), t.type != null)
              ) {
                if (typeof t.type != "object")
                  throw TypeError(".onnx.ValueInfoProto.type: object expected");
                r.type = p.onnx.TypeProto.fromObject(t.type);
              }
              return (
            ...
            (e.toObject = function (t, r) {
              ...
              return (
                ...
                t.type != null &&
                  t.hasOwnProperty("type") &&
                  (n.type = p.onnx.TypeProto.toObject(t.type, r)),
                t.docString != null &&
                  t.hasOwnProperty("docString") &&
                  (n.docString = t.docString),
                n
        ...
        (i.NodeProto = (function () {
          function e(o) {
            if (
              ((this.input = []), (this.output = []), (this.attribute = []), o)
            )
              for (var t = Object.keys(o), r = 0; r < t.length; ++r)
                o[t[r]] != null && (this[t[r]] = o[t[r]]);
          }
          return (
            (e.prototype.input = h.emptyArray),
            (e.prototype.output = h.emptyArray),
            (e.prototype.name = ""),
            (e.prototype.opType = ""),
            (e.prototype.domain = ""),
            (e.prototype.attribute = h.emptyArray),
            (e.prototype.docString = ""),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if ((r || (r = J.create()), t.input != null && t.input.length))
                ...
                switch (a >>> 3) {
                  ...
                  case 5: {
                    (s.attribute && s.attribute.length) || (s.attribute = []),
                      s.attribute.push(
                        p.onnx.AttributeProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 6: {
            ...
            (e.verify = function (t) {
              ...
              if (t.attribute != null && t.hasOwnProperty("attribute")) {
                ...
                for (var r = 0; r < t.attribute.length; ++r) {
                  var n = p.onnx.AttributeProto.verify(t.attribute[r]);
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.NodeProto) return t;
              var r = new p.onnx.NodeProto();
              if (t.input) {
              ...
              if (
                ...
                for (var n = 0; n < t.attribute.length; ++n) {
                  ...
                  r.attribute[n] = p.onnx.AttributeProto.fromObject(
                    t.attribute[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                for (var s = 0; s < t.attribute.length; ++s)
                  n.attribute[s] = p.onnx.AttributeProto.toObject(
                    t.attribute[s],
                    r
                  );
              }
        ...
        (i.TrainingInfoProto = (function () {
          function e(o) {
            if (
              ((this.initializationBinding = []), (this.updateBinding = []), o)
            )
              for (var t = Object.keys(o), r = 0; r < t.length; ++r)
                o[t[r]] != null && (this[t[r]] = o[t[r]]);
          }
          return (
            ...
            (e.prototype.initializationBinding = h.emptyArray),
            (e.prototype.updateBinding = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if (
                ...
                t.initializationBinding != null &&
                  t.initializationBinding.length)
              )
                for (var n = 0; n < t.initializationBinding.length; ++n)
                  p.onnx.StringStringEntryProto.encode(
            ...
            (e.decode = function (t, r) {
              ...
              for (
                var n = r === void 0 ? t.len : t.pos + r,
                  s = new p.onnx.TrainingInfoProto();
                t.pos < n;
                ...
                switch (a >>> 3) {
                  case 1: {
                    s.initialization = p.onnx.GraphProto.decode(t, t.uint32());
                    break;
                  }
                  case 2: {
                    s.algorithm = p.onnx.GraphProto.decode(t, t.uint32());
                    break;
                  }
                  case 3: {
                    (s.initializationBinding &&
                      s.initializationBinding.length) ||
                      (s.initializationBinding = []),
                      s.initializationBinding.push(
                        p.onnx.StringStringEntryProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 4: {
            ...
            (e.verify = function (t) {
              ...
              if (
                ...
                var r = p.onnx.GraphProto.verify(t.initialization);
                if (r) return "initialization." + r;
              }
              if (t.algorithm != null && t.hasOwnProperty("algorithm")) {
                var r = p.onnx.GraphProto.verify(t.algorithm);
              ...
              if (
                ...
                for (var n = 0; n < t.initializationBinding.length; ++n) {
                  var r = p.onnx.StringStringEntryProto.verify(
                    t.initializationBinding[n]
                  );
              ...
              if (
                t.updateBinding != null &&
                t.hasOwnProperty("updateBinding")
              ) {
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.TrainingInfoProto) return t;
              var r = new p.onnx.TrainingInfoProto();
              if (t.initialization != null) {
                if (typeof t.initialization != "object")
                  throw TypeError(
                    ".onnx.TrainingInfoProto.initialization: object expected"
                  );
                r.initialization = p.onnx.GraphProto.fromObject(
                  t.initialization
                );
              }
              if (t.algorithm != null) {
                ...
                r.algorithm = p.onnx.GraphProto.fromObject(t.algorithm);
              }
              if (t.initializationBinding) {
                ...
                for (var n = 0; n < t.initializationBinding.length; ++n) {
                  ...
                  r.initializationBinding[n] =
                    p.onnx.StringStringEntryProto.fromObject(
                      t.initializationBinding[n]
                    );
                }
              }
              if (t.updateBinding) {
                ...
                for (var n = 0; n < t.updateBinding.length; ++n) {
                  ...
                  r.updateBinding[n] = p.onnx.StringStringEntryProto.fromObject(
                    t.updateBinding[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                t.initialization != null &&
                  t.hasOwnProperty("initialization") &&
                  (n.initialization = p.onnx.GraphProto.toObject(
                    t.initialization,
                    r
                  )),
                t.algorithm != null &&
                  t.hasOwnProperty("algorithm") &&
                  (n.algorithm = p.onnx.GraphProto.toObject(t.algorithm, r)),
                ...
                for (var s = 0; s < t.initializationBinding.length; ++s)
                  n.initializationBinding[s] =
                    p.onnx.StringStringEntryProto.toObject(
              ...
              if (t.updateBinding && t.updateBinding.length) {
                ...
                for (var s = 0; s < t.updateBinding.length; ++s)
                  n.updateBinding[s] = p.onnx.StringStringEntryProto.toObject(
                    t.updateBinding[s],
                    r
                  );
              }
        ...
        (i.ModelProto = (function () {
          ...
          return (
            (e.prototype.irVersion = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
            (e.prototype.opsetImport = h.emptyArray),
            (e.prototype.producerName = ""),
            (e.prototype.producerVersion = ""),
            (e.prototype.domain = ""),
            (e.prototype.modelVersion = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
            (e.prototype.docString = ""),
            (e.prototype.graph = null),
            (e.prototype.metadataProps = h.emptyArray),
            (e.prototype.trainingInfo = h.emptyArray),
            (e.prototype.functions = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if (
                ...
                for (var n = 0; n < t.opsetImport.length; ++n)
                  p.onnx.OperatorSetIdProto.encode(
                    t.opsetImport[n],
                    r.uint32(66).fork()
                  ).ldelim();
                ...
                switch (a >>> 3) {
                  ...
                  case 8: {
                    (s.opsetImport && s.opsetImport.length) ||
                      (s.opsetImport = []),
                      s.opsetImport.push(
                        p.onnx.OperatorSetIdProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 2: {
                  ...
                  case 7: {
                    s.graph = p.onnx.GraphProto.decode(t, t.uint32());
                    break;
                  }
                  case 14: {
                  ...
                  case 20: {
                    (s.trainingInfo && s.trainingInfo.length) ||
                      (s.trainingInfo = []),
                      s.trainingInfo.push(
                        p.onnx.TrainingInfoProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 25: {
                    (s.functions && s.functions.length) || (s.functions = []),
                      s.functions.push(
                        p.onnx.FunctionProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  default:
            ...
            (e.verify = function (t) {
              ...
              if (
                ...
                !h.isInteger(t.irVersion) &&
                !(
                  t.irVersion &&
                  h.isInteger(t.irVersion.low) &&
                  h.isInteger(t.irVersion.high)
                )
              )
              ...
              if (t.opsetImport != null && t.hasOwnProperty("opsetImport")) {
                ...
                for (var r = 0; r < t.opsetImport.length; ++r) {
                  var n = p.onnx.OperatorSetIdProto.verify(t.opsetImport[r]);
              ...
              if (
                ...
                !h.isString(t.producerName)
              )
                return "producerName: string expected";
              if (
                t.producerVersion != null &&
                t.hasOwnProperty("producerVersion") &&
                !h.isString(t.producerVersion)
              )
              ...
              if (
                ...
                !h.isInteger(t.modelVersion) &&
                !(
                  t.modelVersion &&
                  h.isInteger(t.modelVersion.low) &&
                  h.isInteger(t.modelVersion.high)
                )
              )
              ...
              if (t.graph != null && t.hasOwnProperty("graph")) {
                var n = p.onnx.GraphProto.verify(t.graph);
                if (n) return "graph." + n;
              }
              if (
                t.metadataProps != null &&
                t.hasOwnProperty("metadataProps")
              ) {
                if (!Array.isArray(t.metadataProps))
                  return "metadataProps: array expected";
                for (var r = 0; r < t.metadataProps.length; ++r) {
                  var n = p.onnx.StringStringEntryProto.verify(
                    t.metadataProps[r]
                  );
              ...
              if (t.trainingInfo != null && t.hasOwnProperty("trainingInfo")) {
                ...
                for (var r = 0; r < t.trainingInfo.length; ++r) {
                  var n = p.onnx.TrainingInfoProto.verify(t.trainingInfo[r]);
              ...
              if (t.functions != null && t.hasOwnProperty("functions")) {
                ...
                for (var r = 0; r < t.functions.length; ++r) {
                  var n = p.onnx.FunctionProto.verify(t.functions[r]);
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.ModelProto) return t;
              var r = new p.onnx.ModelProto();
              if (
                (t.irVersion != null &&
                  (h.Long
                    ? ((r.irVersion = h.Long.fromValue(t.irVersion)).unsigned =
                        !1)
                ...
                for (var n = 0; n < t.opsetImport.length; ++n) {
                  ...
                  r.opsetImport[n] = p.onnx.OperatorSetIdProto.fromObject(
                    t.opsetImport[n]
                  );
                }
              }
              if (
                ...
                t.modelVersion != null &&
                  (h.Long
                    ? ((r.modelVersion = h.Long.fromValue(
                        t.modelVersion
                      )).unsigned = !1)
                ...
                r.graph = p.onnx.GraphProto.fromObject(t.graph);
              }
              if (t.metadataProps) {
                if (!Array.isArray(t.metadataProps))
                  throw TypeError(
                ...
                for (var n = 0; n < t.metadataProps.length; ++n) {
                  ...
                  r.metadataProps[n] = p.onnx.StringStringEntryProto.fromObject(
                    t.metadataProps[n]
                  );
                }
              }
              if (t.trainingInfo) {
                ...
                for (var n = 0; n < t.trainingInfo.length; ++n) {
                  ...
                  r.trainingInfo[n] = p.onnx.TrainingInfoProto.fromObject(
                    t.trainingInfo[n]
                  );
                }
              }
              if (t.functions) {
                ...
                for (var n = 0; n < t.functions.length; ++n) {
                  ...
                  r.functions[n] = p.onnx.FunctionProto.fromObject(
                    t.functions[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                (t.irVersion != null &&
                  ...
                  (typeof t.irVersion == "number"
                    ...
                    : (n.irVersion =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.irVersion)
                          : r.longs === Number
                          ? new h.LongBits(
                              t.irVersion.low >>> 0,
                              t.irVersion.high >>> 0
                ...
                t.modelVersion != null &&
                  ...
                  (typeof t.modelVersion == "number"
                    ...
                    : (n.modelVersion =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.modelVersion)
                          : r.longs === Number
                          ? new h.LongBits(
                              t.modelVersion.low >>> 0,
                              t.modelVersion.high >>> 0
                ...
                t.graph != null &&
                  ...
                  (n.graph = p.onnx.GraphProto.toObject(t.graph, r)),
                t.opsetImport && t.opsetImport.length)
              ) {
                n.opsetImport = [];
                for (var a = 0; a < t.opsetImport.length; ++a)
                  n.opsetImport[a] = p.onnx.OperatorSetIdProto.toObject(
                    t.opsetImport[a],
                    r
                  );
              }
              if (t.metadataProps && t.metadataProps.length) {
                ...
                for (var a = 0; a < t.metadataProps.length; ++a)
                  n.metadataProps[a] = p.onnx.StringStringEntryProto.toObject(
                    t.metadataProps[a],
                    r
                  );
              }
              if (t.trainingInfo && t.trainingInfo.length) {
                ...
                for (var a = 0; a < t.trainingInfo.length; ++a)
                  n.trainingInfo[a] = p.onnx.TrainingInfoProto.toObject(
                    t.trainingInfo[a],
                    r
                  );
              }
              if (t.functions && t.functions.length) {
                ...
                for (var a = 0; a < t.functions.length; ++a)
                  n.functions[a] = p.onnx.FunctionProto.toObject(
                    t.functions[a],
                    r
                  );
              }
        ...
        (i.StringStringEntryProto = (function () {
          ...
          return (
            ...
            (e.decode = function (t, r) {
              ...
              for (
                var n = r === void 0 ? t.len : t.pos + r,
                  s = new p.onnx.StringStringEntryProto();
                t.pos < n;
            ...
            (e.verify = function (t) {
              return typeof t != "object" || t === null
                ? "object expected"
                : t.key != null && t.hasOwnProperty("key") && !h.isString(t.key)
                ? "key: string expected"
                : t.value != null &&
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.StringStringEntryProto) return t;
              var r = new p.onnx.StringStringEntryProto();
              return (
        ...
        (i.TensorAnnotation = (function () {
          ...
          return (
            ...
            (e.prototype.quantParameterTensorNames = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.TensorAnnotation) return t;
              var r = new p.onnx.TensorAnnotation();
              if (
        ...
        (i.GraphProto = (function () {
          ...
          return (
            (e.prototype.node = h.emptyArray),
            (e.prototype.name = ""),
            (e.prototype.initializer = h.emptyArray),
            (e.prototype.sparseInitializer = h.emptyArray),
            (e.prototype.docString = ""),
            (e.prototype.input = h.emptyArray),
            (e.prototype.output = h.emptyArray),
            (e.prototype.valueInfo = h.emptyArray),
            (e.prototype.quantizationAnnotation = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if ((r || (r = J.create()), t.node != null && t.node.length))
                for (var n = 0; n < t.node.length; ++n)
                  p.onnx.NodeProto.encode(
                    t.node[n],
                    r.uint32(10).fork()
                  ).ldelim();
              if (
              ...
              if (
                ...
                for (var n = 0; n < t.quantizationAnnotation.length; ++n)
                  p.onnx.TensorAnnotation.encode(
                ...
                switch (a >>> 3) {
                  case 1: {
                    (s.node && s.node.length) || (s.node = []),
                      s.node.push(p.onnx.NodeProto.decode(t, t.uint32()));
                    break;
                  }
                  case 2: {
                    s.name = t.string();
                  ...
                  case 5: {
                    (s.initializer && s.initializer.length) ||
                      (s.initializer = []),
                      s.initializer.push(
                        p.onnx.TensorProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 15: {
                  ...
                  case 11: {
                    (s.input && s.input.length) || (s.input = []),
                      s.input.push(p.onnx.ValueInfoProto.decode(t, t.uint32()));
                    break;
                  }
                  case 12: {
                    (s.output && s.output.length) || (s.output = []),
                      s.output.push(
                        p.onnx.ValueInfoProto.decode(t, t.uint32())
                      );
                    break;
                  }
                  case 13: {
                  ...
                  case 14: {
                    (s.quantizationAnnotation &&
                      ...
                      s.quantizationAnnotation.push(
                        p.onnx.TensorAnnotation.decode(t, t.uint32())
                      );
                    break;
                  }
                  default:
            ...
            (e.verify = function (t) {
              ...
              if (t.node != null && t.hasOwnProperty("node")) {
                ...
                for (var r = 0; r < t.node.length; ++r) {
                  var n = p.onnx.NodeProto.verify(t.node[r]);
                  if (n) return "node." + n;
                }
              }
              if (
              ...
              if (t.initializer != null && t.hasOwnProperty("initializer")) {
                ...
                for (var r = 0; r < t.initializer.length; ++r) {
                  var n = p.onnx.TensorProto.verify(t.initializer[r]);
              ...
              if (
                ...
                for (var r = 0; r < t.sparseInitializer.length; ++r) {
                  var n = p.onnx.SparseTensorProto.verify(
                    t.sparseInitializer[r]
                  );
              ...
              if (t.input != null && t.hasOwnProperty("input")) {
                if (!Array.isArray(t.input)) return "input: array expected";
                for (var r = 0; r < t.input.length; ++r) {
                  var n = p.onnx.ValueInfoProto.verify(t.input[r]);
                  if (n) return "input." + n;
                }
              }
              if (t.output != null && t.hasOwnProperty("output")) {
                if (!Array.isArray(t.output)) return "output: array expected";
                for (var r = 0; r < t.output.length; ++r) {
                  var n = p.onnx.ValueInfoProto.verify(t.output[r]);
              ...
              if (t.valueInfo != null && t.hasOwnProperty("valueInfo")) {
                ...
                for (var r = 0; r < t.valueInfo.length; ++r) {
                  var n = p.onnx.ValueInfoProto.verify(t.valueInfo[r]);
              ...
              if (
                ...
                for (var r = 0; r < t.quantizationAnnotation.length; ++r) {
                  var n = p.onnx.TensorAnnotation.verify(
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.GraphProto) return t;
              var r = new p.onnx.GraphProto();
              if (t.node) {
                ...
                for (var n = 0; n < t.node.length; ++n) {
                  ...
                  r.node[n] = p.onnx.NodeProto.fromObject(t.node[n]);
                }
              }
              if (
                (t.name != null && (r.name = String(t.name)), t.initializer)
              ) {
                if (!Array.isArray(t.initializer))
                  throw TypeError(
                ...
                for (var n = 0; n < t.initializer.length; ++n) {
                  ...
                  r.initializer[n] = p.onnx.TensorProto.fromObject(
                    t.initializer[n]
                  );
                }
              }
              if (t.sparseInitializer) {
                ...
                for (var n = 0; n < t.sparseInitializer.length; ++n) {
                  ...
                  r.sparseInitializer[n] = p.onnx.SparseTensorProto.fromObject(
                    t.sparseInitializer[n]
                  );
                }
              }
              if (
                ...
                for (var n = 0; n < t.input.length; ++n) {
                  ...
                  r.input[n] = p.onnx.ValueInfoProto.fromObject(t.input[n]);
                }
              }
              if (t.output) {
                if (!Array.isArray(t.output))
                ...
                for (var n = 0; n < t.output.length; ++n) {
                  ...
                  r.output[n] = p.onnx.ValueInfoProto.fromObject(t.output[n]);
                }
              }
              if (t.valueInfo) {
                if (!Array.isArray(t.valueInfo))
                ...
                for (var n = 0; n < t.valueInfo.length; ++n) {
                  ...
                  r.valueInfo[n] = p.onnx.ValueInfoProto.fromObject(
                    t.valueInfo[n]
                  );
                }
              }
              if (t.quantizationAnnotation) {
                ...
                for (var n = 0; n < t.quantizationAnnotation.length; ++n) {
                  ...
                  r.quantizationAnnotation[n] =
                    p.onnx.TensorAnnotation.fromObject(
                      t.quantizationAnnotation[n]
                    );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                for (var s = 0; s < t.node.length; ++s)
                  n.node[s] = p.onnx.NodeProto.toObject(t.node[s], r);
              }
              if (
                (t.name != null &&
                  t.hasOwnProperty("name") &&
                ...
                for (var s = 0; s < t.initializer.length; ++s)
                  n.initializer[s] = p.onnx.TensorProto.toObject(
                    t.initializer[s],
                    r
                  );
              }
              if (
                ...
                n.input = [];
                for (var s = 0; s < t.input.length; ++s)
                  n.input[s] = p.onnx.ValueInfoProto.toObject(t.input[s], r);
              }
              if (t.output && t.output.length) {
                n.output = [];
                for (var s = 0; s < t.output.length; ++s)
                  n.output[s] = p.onnx.ValueInfoProto.toObject(t.output[s], r);
              }
              if (t.valueInfo && t.valueInfo.length) {
                n.valueInfo = [];
                for (var s = 0; s < t.valueInfo.length; ++s)
                  n.valueInfo[s] = p.onnx.ValueInfoProto.toObject(
                    t.valueInfo[s],
                    r
                  );
              }
              if (t.quantizationAnnotation && t.quantizationAnnotation.length) {
                ...
                for (var s = 0; s < t.quantizationAnnotation.length; ++s)
                  n.quantizationAnnotation[s] =
                    p.onnx.TensorAnnotation.toObject(
              ...
              if (t.sparseInitializer && t.sparseInitializer.length) {
                ...
                for (var s = 0; s < t.sparseInitializer.length; ++s)
                  n.sparseInitializer[s] = p.onnx.SparseTensorProto.toObject(
        ...
        (i.TensorProto = (function () {
          ...
          return (
            (e.prototype.dims = h.emptyArray),
            (e.prototype.dataType = 0),
            (e.prototype.segment = null),
            (e.prototype.floatData = h.emptyArray),
            (e.prototype.int32Data = h.emptyArray),
            (e.prototype.stringData = h.emptyArray),
            (e.prototype.int64Data = h.emptyArray),
            (e.prototype.name = ""),
            (e.prototype.docString = ""),
            (e.prototype.rawData = h.newBuffer([])),
            (e.prototype.externalData = h.emptyArray),
            (e.prototype.dataLocation = 0),
            (e.prototype.doubleData = h.emptyArray),
            (e.prototype.uint64Data = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if ((r || (r = J.create()), t.dims != null && t.dims.length)) {
                r.uint32(10).fork();
              ...
              if (
                ...
                t.segment != null &&
                  ...
                  p.onnx.TensorProto.Segment.encode(
                    t.segment,
                    r.uint32(26).fork()
                  ).ldelim(),
            ...
            (e.decode = function (t, r) {
              ...
              for (
                ...
                switch (a >>> 3) {
                  ...
                  case 3: {
                    s.segment = p.onnx.TensorProto.Segment.decode(
                      t,
                      t.uint32()
                    );
                    break;
                  ...
                  case 4: {
                    if (
                      ((s.floatData && s.floatData.length) ||
                        (s.floatData = []),
                      (a & 7) === 2)
                    )
                      for (var u = t.uint32() + t.pos; t.pos < u; )
                  ...
                  case 5: {
                    if (
                      ((s.int32Data && s.int32Data.length) ||
                        (s.int32Data = []),
                      (a & 7) === 2)
                    )
                      for (var u = t.uint32() + t.pos; t.pos < u; )
                  ...
                  case 6: {
                    (s.stringData && s.stringData.length) ||
                      (s.stringData = []),
                  ...
                  case 7: {
                    if (
                      ((s.int64Data && s.int64Data.length) ||
                        (s.int64Data = []),
                      (a & 7) === 2)
                    )
                      for (var u = t.uint32() + t.pos; t.pos < u; )
            ...
            (e.verify = function (t) {
              ...
              if (t.dims != null && t.hasOwnProperty("dims")) {
                ...
                for (var r = 0; r < t.dims.length; ++r)
                  if (
                    !h.isInteger(t.dims[r]) &&
                    !(
                      t.dims[r] &&
                      h.isInteger(t.dims[r].low) &&
                      h.isInteger(t.dims[r].high)
                    )
                  )
              ...
              if (
                ...
                !h.isInteger(t.dataType)
              )
                return "dataType: integer expected";
              if (t.segment != null && t.hasOwnProperty("segment")) {
                var n = p.onnx.TensorProto.Segment.verify(t.segment);
              ...
              if (t.int64Data != null && t.hasOwnProperty("int64Data")) {
                ...
                for (var r = 0; r < t.int64Data.length; ++r)
                  if (
                    !h.isInteger(t.int64Data[r]) &&
                    !(
                      t.int64Data[r] &&
                      h.isInteger(t.int64Data[r].low) &&
                      h.isInteger(t.int64Data[r].high)
                    )
                  )
              ...
              if (t.uint64Data != null && t.hasOwnProperty("uint64Data")) {
                ...
                for (var r = 0; r < t.uint64Data.length; ++r)
                  if (
                    !h.isInteger(t.uint64Data[r]) &&
                    !(
                      t.uint64Data[r] &&
                      h.isInteger(t.uint64Data[r].low) &&
                      h.isInteger(t.uint64Data[r].high)
                    )
                  )
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.TensorProto) return t;
              var r = new p.onnx.TensorProto();
              if (t.dims) {
              ...
              if (
                ...
                r.segment = p.onnx.TensorProto.Segment.fromObject(t.segment);
              }
              if (t.floatData) {
                if (!Array.isArray(t.floatData))
                  throw TypeError(
              ...
              if (t.stringData) {
                ...
                for (var n = 0; n < t.stringData.length; ++n)
                  typeof t.stringData[n] == "string"
                    ? h.base64.decode(
                        t.stringData[n],
                        (r.stringData[n] = h.newBuffer(
                          h.base64.length(t.stringData[n])
                        )),
                        0
                      )
              ...
              if (t.int64Data) {
                ...
                for (var n = 0; n < t.int64Data.length; ++n)
                  h.Long
                    ? ((r.int64Data[n] = h.Long.fromValue(
                        t.int64Data[n]
                      )).unsigned = !1)
              ...
              if (
                ...
                t.rawData != null &&
                  (typeof t.rawData == "string"
                    ? h.base64.decode(
                        t.rawData,
                        (r.rawData = h.newBuffer(h.base64.length(t.rawData))),
                        0
                      )
                ...
                for (var n = 0; n < t.externalData.length; ++n) {
                  ...
                  r.externalData[n] = p.onnx.StringStringEntryProto.fromObject(
                    t.externalData[n]
                  );
                }
              }
              ...
              if (t.uint64Data) {
                ...
                for (var n = 0; n < t.uint64Data.length; ++n)
                  h.Long
                    ? ((r.uint64Data[n] = h.Long.fromValue(
                        t.uint64Data[n]
                      )).unsigned = !0)
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                r.defaults &&
                  ...
                  r.bytes === String
                    ...
                    : ((n.rawData = []),
                      r.bytes !== Array &&
                        (n.rawData = h.newBuffer(n.rawData))),
                  (n.docString = ""),
                ...
                for (var s = 0; s < t.dims.length; ++s)
                  typeof t.dims[s] == "number"
                    ...
                    : (n.dims[s] =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.dims[s])
                          : r.longs === Number
                          ? new h.LongBits(
                              t.dims[s].low >>> 0,
                              t.dims[s].high >>> 0
              ...
              if (
                ...
                t.segment != null &&
                  ...
                  (n.segment = p.onnx.TensorProto.Segment.toObject(
                    t.segment,
                    r
                  )),
              ...
              if (t.int64Data && t.int64Data.length) {
                ...
                for (var s = 0; s < t.int64Data.length; ++s)
                  typeof t.int64Data[s] == "number"
                    ...
                    : (n.int64Data[s] =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.int64Data[s])
                          : r.longs === Number
                          ? new h.LongBits(
                              t.int64Data[s].low >>> 0,
              ...
              if (
                ...
                t.rawData != null &&
                  ...
                  (n.rawData =
                    r.bytes === String
                      ? h.base64.encode(t.rawData, 0, t.rawData.length)
                      : r.bytes === Array
              ...
              if (t.uint64Data && t.uint64Data.length) {
                ...
                for (var s = 0; s < t.uint64Data.length; ++s)
                  typeof t.uint64Data[s] == "number"
                    ...
                    : (n.uint64Data[s] =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.uint64Data[s])
                          : r.longs === Number
                          ? new h.LongBits(
              ...
              if (
                ...
                for (var s = 0; s < t.externalData.length; ++s)
                  n.externalData[s] = p.onnx.StringStringEntryProto.toObject(
                    t.externalData[s],
                    r
                  );
              }
              return (
                t.dataLocation != null &&
                  ...
                  (n.dataLocation =
                    r.enums === String
                      ? p.onnx.TensorProto.DataLocation[t.dataLocation] ===
                        void 0
                        ? t.dataLocation
                        : p.onnx.TensorProto.DataLocation[t.dataLocation]
                      : t.dataLocation),
            ...
            (e.Segment = (function () {
              ...
              return (
                (o.prototype.begin = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
                (o.prototype.end = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
                (o.create = function (r) {
                  return new o(r);
                }),
                ...
                (o.decode = function (r, n) {
                  ...
                  for (
                    var s = n === void 0 ? r.len : r.pos + n,
                      a = new p.onnx.TensorProto.Segment();
                    r.pos < s;
                ...
                (o.decodeDelimited = function (r) {
                  return (
                    r instanceof S || (r = new S(r)), this.decode(r, r.uint32())
                  );
                }),
                (o.verify = function (r) {
                  return typeof r != "object" || r === null
                    ...
                    : r.begin != null &&
                      ...
                      !(
                        r.begin &&
                        h.isInteger(r.begin.low) &&
                        h.isInteger(r.begin.high)
                      )
                    ...
                    : r.end != null &&
                      ...
                      !(
                        r.end &&
                        h.isInteger(r.end.low) &&
                        h.isInteger(r.end.high)
                      )
                    ? "end: integer|Long expected"
                    : null;
                }),
                (o.fromObject = function (r) {
                  if (r instanceof p.onnx.TensorProto.Segment) return r;
                  var n = new p.onnx.TensorProto.Segment();
                  return (
                    r.begin != null &&
                      (h.Long
                        ? ((n.begin = h.Long.fromValue(r.begin)).unsigned = !1)
                        : typeof r.begin == "string"
                        ? (n.begin = parseInt(r.begin, 10))
                        : typeof r.begin == "number"
                        ? (n.begin = r.begin)
                        : typeof r.begin == "object" &&
                          (n.begin = new h.LongBits(
                            r.begin.low >>> 0,
                            r.begin.high >>> 0
                          ).toNumber())),
                    r.end != null &&
                      (h.Long
                        ? ((n.end = h.Long.fromValue(r.end)).unsigned = !1)
                        : typeof r.end == "string"
                        ? (n.end = parseInt(r.end, 10))
                        : typeof r.end == "number"
                        ? (n.end = r.end)
                        : typeof r.end == "object" &&
                          (n.end = new h.LongBits(
                            r.end.low >>> 0,
                            r.end.high >>> 0
                          ).toNumber())),
                    n
                  ...
                  return (
                    r.begin != null &&
                      ...
                      (typeof r.begin == "number"
                        ...
                        : (s.begin =
                            n.longs === String
                              ? h.Long.prototype.toString.call(r.begin)
                              : n.longs === Number
                              ? new h.LongBits(
                                  r.begin.low >>> 0,
                                  r.begin.high >>> 0
                    ...
                    r.end != null &&
                      ...
                      (typeof r.end == "number"
                        ...
                        : (s.end =
                            n.longs === String
                              ? h.Long.prototype.toString.call(r.end)
                              : n.longs === Number
                              ? new h.LongBits(
                                  r.end.low >>> 0,
                                  r.end.high >>> 0
            ...
            (e.DataLocation = (function () {
              var o = {},
                t = Object.create(o);
              return (
                (t[(o[0] = "DEFAULT")] = 0), (t[(o[1] = "EXTERNAL")] = 1), t
              );
            })()),
            e
          );
        ...
        (i.SparseTensorProto = (function () {
          ...
          return (
            ...
            (e.decode = function (t, r) {
              ...
              for (
                var n = r === void 0 ? t.len : t.pos + r,
                  s = new p.onnx.SparseTensorProto();
                t.pos < n;
                ...
                switch (a >>> 3) {
                  case 1: {
                    s.values = p.onnx.TensorProto.decode(t, t.uint32());
                    break;
                  }
                  case 2: {
                    s.indices = p.onnx.TensorProto.decode(t, t.uint32());
                    break;
                  }
                  case 3: {
                    if (
            ...
            (e.verify = function (t) {
              ...
              if (t.values != null && t.hasOwnProperty("values")) {
                var r = p.onnx.TensorProto.verify(t.values);
                if (r) return "values." + r;
              }
              if (t.indices != null && t.hasOwnProperty("indices")) {
                var r = p.onnx.TensorProto.verify(t.indices);
              ...
              if (t.dims != null && t.hasOwnProperty("dims")) {
                ...
                for (var n = 0; n < t.dims.length; ++n)
                  if (
                    !h.isInteger(t.dims[n]) &&
                    !(
                      t.dims[n] &&
                      h.isInteger(t.dims[n].low) &&
                      h.isInteger(t.dims[n].high)
                    )
                  )
                    return "dims: integer|Long[] expected";
              }
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.SparseTensorProto) return t;
              var r = new p.onnx.SparseTensorProto();
              if (t.values != null) {
                if (typeof t.values != "object")
                  throw TypeError(
                    ".onnx.SparseTensorProto.values: object expected"
                  );
                r.values = p.onnx.TensorProto.fromObject(t.values);
              }
              if (t.indices != null) {
                ...
                r.indices = p.onnx.TensorProto.fromObject(t.indices);
              }
              if (t.dims) {
                if (!Array.isArray(t.dims))
                  throw TypeError(
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                t.values != null &&
                  ...
                  (n.values = p.onnx.TensorProto.toObject(t.values, r)),
                t.indices != null &&
                  t.hasOwnProperty("indices") &&
                  (n.indices = p.onnx.TensorProto.toObject(t.indices, r)),
                t.dims && t.dims.length)
              ) {
                n.dims = [];
                for (var s = 0; s < t.dims.length; ++s)
        ...
        (i.TensorShapeProto = (function () {
          ...
          return (
            (e.prototype.dim = h.emptyArray),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
              if ((r || (r = J.create()), t.dim != null && t.dim.length))
                for (var n = 0; n < t.dim.length; ++n)
                  p.onnx.TensorShapeProto.Dimension.encode(
                    t.dim[n],
                    r.uint32(10).fork()
                  ).ldelim();
              return r;
                ...
                switch (a >>> 3) {
                  case 1: {
                    (s.dim && s.dim.length) || (s.dim = []),
                      s.dim.push(
                        p.onnx.TensorShapeProto.Dimension.decode(t, t.uint32())
                      );
                    break;
                  }
                  default:
            ...
            (e.verify = function (t) {
              ...
              if (t.dim != null && t.hasOwnProperty("dim")) {
                ...
                for (var r = 0; r < t.dim.length; ++r) {
                  var n = p.onnx.TensorShapeProto.Dimension.verify(t.dim[r]);
                  if (n) return "dim." + n;
                }
              }
              return null;
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.TensorShapeProto) return t;
              var r = new p.onnx.TensorShapeProto();
              if (t.dim) {
                ...
                for (var n = 0; n < t.dim.length; ++n) {
                  ...
                  r.dim[n] = p.onnx.TensorShapeProto.Dimension.fromObject(
                    t.dim[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              var n = {};
              if (
                ((r.arrays || r.defaults) && (n.dim = []),
                t.dim && t.dim.length)
              ) {
                n.dim = [];
                for (var s = 0; s < t.dim.length; ++s)
                  n.dim[s] = p.onnx.TensorShapeProto.Dimension.toObject(
                    t.dim[s],
                    r
                  );
              }
            ...
            (e.Dimension = (function () {
              ...
              return (
                Object.defineProperty(o.prototype, "value", {
                  get: h.oneOfGetter((t = ["dimValue", "dimParam"])),
                  set: h.oneOfSetter(t),
                }),
                (o.create = function (n) {
                  return new o(n);
                ...
                (o.decode = function (n, s) {
                  ...
                  for (
                    var a = s === void 0 ? n.len : n.pos + s,
                      u = new p.onnx.TensorShapeProto.Dimension();
                    n.pos < a;
                ...
                (o.verify = function (n) {
                  ...
                  if (
                    ...
                    ((s.value = 1),
                    !h.isInteger(n.dimValue) &&
                      !(
                        n.dimValue &&
                        h.isInteger(n.dimValue.low) &&
                        h.isInteger(n.dimValue.high)
                      ))
                  )
                    return "dimValue: integer|Long expected";
                  if (n.dimParam != null && n.hasOwnProperty("dimParam")) {
                    if (s.value === 1) return "value: multiple values";
                    if (((s.value = 1), !h.isString(n.dimParam)))
                      return "dimParam: string expected";
                  }
                  return n.denotation != null &&
                    n.hasOwnProperty("denotation") &&
                    !h.isString(n.denotation)
                    ? "denotation: string expected"
                    : null;
                }),
                (o.fromObject = function (n) {
                  if (n instanceof p.onnx.TensorShapeProto.Dimension) return n;
                  var s = new p.onnx.TensorShapeProto.Dimension();
                  return (
                    n.dimValue != null &&
                      (h.Long
                        ? ((s.dimValue = h.Long.fromValue(
                            n.dimValue
                          )).unsigned = !1)
                        ...
                        : typeof n.dimValue == "object" &&
                          (s.dimValue = new h.LongBits(
                            n.dimValue.low >>> 0,
                            n.dimValue.high >>> 0
                          ).toNumber())),
                    n.dimParam != null && (s.dimParam = String(n.dimParam)),
                    n.denotation != null &&
                      (s.denotation = String(n.denotation)),
                    s
                  );
                }),
                  ...
                  return (
                    ...
                    n.dimValue != null &&
                      ...
                      (typeof n.dimValue == "number"
                        ...
                        : (a.dimValue =
                            s.longs === String
                              ? h.Long.prototype.toString.call(n.dimValue)
                              : s.longs === Number
                              ? new h.LongBits(
                                  n.dimValue.low >>> 0,
                                  n.dimValue.high >>> 0
          ...
          return (
            ...
            (e.encode = function (r, n) {
              return (
                ...
                r.tensorType != null &&
                  ...
                  p.onnx.TypeProto.Tensor.encode(
                    r.tensorType,
                    n.uint32(10).fork()
                  ).ldelim(),
                r.sequenceType != null &&
                  Object.hasOwnProperty.call(r, "sequenceType") &&
                  p.onnx.TypeProto.Sequence.encode(
                    r.sequenceType,
                    n.uint32(34).fork()
                  ).ldelim(),
                r.mapType != null &&
                  Object.hasOwnProperty.call(r, "mapType") &&
                  p.onnx.TypeProto.Map.encode(
                    r.mapType,
                    n.uint32(42).fork()
                  ).ldelim(),
                r.denotation != null &&
                ...
                r.sparseTensorType != null &&
                  ...
                  p.onnx.TypeProto.SparseTensor.encode(
                    r.sparseTensorType,
                    n.uint32(66).fork()
                  ).ldelim(),
                r.optionalType != null &&
                  Object.hasOwnProperty.call(r, "optionalType") &&
                  p.onnx.TypeProto.Optional.encode(
                    r.optionalType,
                    n.uint32(74).fork()
                  ).ldelim(),
                n
            ...
            (e.decode = function (r, n) {
              ...
              for (
                ...
                switch (u >>> 3) {
                  case 1: {
                    a.tensorType = p.onnx.TypeProto.Tensor.decode(
                      r,
                      r.uint32()
                    );
                    break;
                  ...
                  case 4: {
                    a.sequenceType = p.onnx.TypeProto.Sequence.decode(
                      r,
                      r.uint32()
                    );
                    break;
                  ...
                  case 5: {
                    a.mapType = p.onnx.TypeProto.Map.decode(r, r.uint32());
                    break;
                  }
                  case 9: {
                    a.optionalType = p.onnx.TypeProto.Optional.decode(
                      r,
                      r.uint32()
                    );
                    break;
                  ...
                  case 8: {
                    a.sparseTensorType = p.onnx.TypeProto.SparseTensor.decode(
                      r,
                      r.uint32()
                    );
                    break;
            ...
            (e.verify = function (r) {
              ...
              if (r.tensorType != null && r.hasOwnProperty("tensorType")) {
                n.value = 1;
                {
                  var s = p.onnx.TypeProto.Tensor.verify(r.tensorType);
              ...
              if (r.sequenceType != null && r.hasOwnProperty("sequenceType")) {
                ...
                n.value = 1;
                {
                  var s = p.onnx.TypeProto.Sequence.verify(r.sequenceType);
              ...
              if (r.mapType != null && r.hasOwnProperty("mapType")) {
                ...
                n.value = 1;
                {
                  var s = p.onnx.TypeProto.Map.verify(r.mapType);
              ...
              if (r.optionalType != null && r.hasOwnProperty("optionalType")) {
                ...
                n.value = 1;
                {
                  var s = p.onnx.TypeProto.Optional.verify(r.optionalType);
              ...
              if (
                ...
                n.value = 1;
                {
                  var s = p.onnx.TypeProto.SparseTensor.verify(
                    r.sparseTensorType
                  );
              ...
              return r.denotation != null &&
                ...
                !h.isString(r.denotation)
                ? "denotation: string expected"
                : null;
            }),
            (e.fromObject = function (r) {
              if (r instanceof p.onnx.TypeProto) return r;
              var n = new p.onnx.TypeProto();
              if (r.tensorType != null) {
                if (typeof r.tensorType != "object")
                  throw TypeError(
                    ".onnx.TypeProto.tensorType: object expected"
                  );
                n.tensorType = p.onnx.TypeProto.Tensor.fromObject(r.tensorType);
              }
              if (r.sequenceType != null) {
                ...
                n.sequenceType = p.onnx.TypeProto.Sequence.fromObject(
                  r.sequenceType
                );
              }
              if (r.mapType != null) {
                ...
                n.mapType = p.onnx.TypeProto.Map.fromObject(r.mapType);
              }
              if (r.optionalType != null) {
                ...
                n.optionalType = p.onnx.TypeProto.Optional.fromObject(
                  r.optionalType
                );
              }
              if (r.sparseTensorType != null) {
                ...
                n.sparseTensorType = p.onnx.TypeProto.SparseTensor.fromObject(
                  r.sparseTensorType
                );
              }
              return (
            ...
            (e.toObject = function (r, n) {
              ...
              return (
                ...
                r.tensorType != null &&
                  ...
                  ((s.tensorType = p.onnx.TypeProto.Tensor.toObject(
                    r.tensorType,
                    n
                  )),
                ...
                r.sequenceType != null &&
                  ...
                  ((s.sequenceType = p.onnx.TypeProto.Sequence.toObject(
                    r.sequenceType,
                    n
                  )),
                ...
                r.mapType != null &&
                  ...
                  ((s.mapType = p.onnx.TypeProto.Map.toObject(r.mapType, n)),
                ...
                r.sparseTensorType != null &&
                  r.hasOwnProperty("sparseTensorType") &&
                  ((s.sparseTensorType = p.onnx.TypeProto.SparseTensor.toObject(
                    r.sparseTensorType,
                    n
                  )),
                ...
                r.optionalType != null &&
                  ...
                  ((s.optionalType = p.onnx.TypeProto.Optional.toObject(
                    r.optionalType,
                    n
                  )),
              ...
              return (
                ...
                (t.encode = function (n, s) {
                  return (
                    ...
                    n.shape != null &&
                      ...
                      p.onnx.TensorShapeProto.encode(
                        n.shape,
                        s.uint32(18).fork()
                      ).ldelim(),
                    s
                ...
                (t.decode = function (n, s) {
                  ...
                  for (
                    ...
                    switch (l >>> 3) {
                      ...
                      case 2: {
                        u.shape = p.onnx.TensorShapeProto.decode(n, n.uint32());
                        break;
                      }
                      default:
                        n.skipType(l & 7);
                ...
                (t.verify = function (n) {
                  ...
                  if (
                    ...
                    !h.isInteger(n.elemType)
                  )
                    return "elemType: integer expected";
                  if (n.shape != null && n.hasOwnProperty("shape")) {
                    var s = p.onnx.TensorShapeProto.verify(n.shape);
                    if (s) return "shape." + s;
                  }
                  return null;
                }),
                (t.fromObject = function (n) {
                  if (n instanceof p.onnx.TypeProto.Tensor) return n;
                  var s = new p.onnx.TypeProto.Tensor();
                  if (
                    ...
                    s.shape = p.onnx.TensorShapeProto.fromObject(n.shape);
                  }
                  return s;
                }),
                (t.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.shape != null &&
                      ...
                      (a.shape = p.onnx.TensorShapeProto.toObject(n.shape, s)),
                    a
                  );
                }),
            ...
            (e.Sequence = (function () {
              ...
              return (
                ...
                (t.decode = function (n, s) {
                  ...
                  for (
                    var a = s === void 0 ? n.len : n.pos + s,
                      u = new p.onnx.TypeProto.Sequence();
                    n.pos < a;
                    ...
                    switch (l >>> 3) {
                      case 1: {
                        u.elemType = p.onnx.TypeProto.decode(n, n.uint32());
                        break;
                      }
                      default:
                        n.skipType(l & 7);
                ...
                (t.verify = function (n) {
                  ...
                  if (n.elemType != null && n.hasOwnProperty("elemType")) {
                    var s = p.onnx.TypeProto.verify(n.elemType);
                    if (s) return "elemType." + s;
                  }
                  return null;
                }),
                (t.fromObject = function (n) {
                  if (n instanceof p.onnx.TypeProto.Sequence) return n;
                  var s = new p.onnx.TypeProto.Sequence();
                  if (n.elemType != null) {
                    if (typeof n.elemType != "object")
                      throw TypeError(
                        ".onnx.TypeProto.Sequence.elemType: object expected"
                      );
                    s.elemType = p.onnx.TypeProto.fromObject(n.elemType);
                  }
                  return s;
                }),
                (t.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.elemType != null &&
                      n.hasOwnProperty("elemType") &&
                      (a.elemType = p.onnx.TypeProto.toObject(n.elemType, s)),
                    a
                  );
                }),
                (t.prototype.toJSON = function () {
              ...
              return (
                ...
                (t.decode = function (n, s) {
                  ...
                  for (
                    ...
                    switch (l >>> 3) {
                      ...
                      case 2: {
                        u.valueType = p.onnx.TypeProto.decode(n, n.uint32());
                        break;
                      }
                      default:
                        n.skipType(l & 7);
                ...
                (t.verify = function (n) {
                  ...
                  if (
                    ...
                    !h.isInteger(n.keyType)
                  )
                    return "keyType: integer expected";
                  if (n.valueType != null && n.hasOwnProperty("valueType")) {
                    var s = p.onnx.TypeProto.verify(n.valueType);
                    if (s) return "valueType." + s;
                  }
                  return null;
                }),
                (t.fromObject = function (n) {
                  if (n instanceof p.onnx.TypeProto.Map) return n;
                  var s = new p.onnx.TypeProto.Map();
                  if (
                    ...
                    s.valueType = p.onnx.TypeProto.fromObject(n.valueType);
                  }
                  return s;
                }),
                (t.toObject = function (n, s) {
                  ...
                  return (
                    ...
                    n.valueType != null &&
                      ...
                      (a.valueType = p.onnx.TypeProto.toObject(n.valueType, s)),
                    a
                  );
                }),
                (t.prototype.toJSON = function () {
            ...
            (e.Optional = (function () {
              ...
              return (
                ...
                (t.decode = function (n, s) {
                  ...
                  for (
                    var a = s === void 0 ? n.len : n.pos + s,
                      u = new p.onnx.TypeProto.Optional();
                    n.pos < a;
                ...
                (t.fromObject = function (n) {
                  if (n instanceof p.onnx.TypeProto.Optional) return n;
                  var s = new p.onnx.TypeProto.Optional();
                  if (n.elemType != null) {
                    if (typeof n.elemType != "object")
                      throw TypeError(
            ...
            (e.SparseTensor = (function () {
              ...
              return (
                ...
                (t.decode = function (n, s) {
                  ...
                  for (
                    var a = s === void 0 ? n.len : n.pos + s,
                      u = new p.onnx.TypeProto.SparseTensor();
                    n.pos < a;
                ...
                (t.fromObject = function (n) {
                  if (n instanceof p.onnx.TypeProto.SparseTensor) return n;
                  var s = new p.onnx.TypeProto.SparseTensor();
                  if (
                    (n.elemType != null && (s.elemType = n.elemType | 0),
                    n.shape != null)
                  ) {
        ...
        (i.OperatorSetIdProto = (function () {
          ...
          return (
            (e.prototype.domain = ""),
            (e.prototype.version = h.Long ? h.Long.fromBits(0, 0, !1) : 0),
            (e.create = function (t) {
              return new e(t);
            }),
            (e.encode = function (t, r) {
            ...
            (e.decode = function (t, r) {
              ...
              for (
                var n = r === void 0 ? t.len : t.pos + r,
                  s = new p.onnx.OperatorSetIdProto();
                t.pos < n;
            ...
            (e.verify = function (t) {
              return typeof t != "object" || t === null
                ...
                : t.version != null &&
                  ...
                  !h.isInteger(t.version) &&
                  !(
                    t.version &&
                    h.isInteger(t.version.low) &&
                    h.isInteger(t.version.high)
                  )
                ? "version: integer|Long expected"
                : null;
            }),
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.OperatorSetIdProto) return t;
              var r = new p.onnx.OperatorSetIdProto();
              return (
                t.domain != null && (r.domain = String(t.domain)),
                t.version != null &&
                  (h.Long
                    ? ((r.version = h.Long.fromValue(t.version)).unsigned = !1)
                    : typeof t.version == "string"
                    ? (r.version = parseInt(t.version, 10))
                    : typeof t.version == "number"
                    ? (r.version = t.version)
                    : typeof t.version == "object" &&
                      (r.version = new h.LongBits(
                        t.version.low >>> 0,
                        t.version.high >>> 0
                      ).toNumber())),
                r
              ...
              return (
                ...
                t.version != null &&
                  ...
                  (typeof t.version == "number"
                    ...
                    : (n.version =
                        r.longs === String
                          ? h.Long.prototype.toString.call(t.version)
                          : r.longs === Number
                          ? new h.LongBits(
                              t.version.low >>> 0,
                              t.version.high >>> 0
        ...
        (i.OperatorStatus = (function () {
          var e = {},
            o = Object.create(e);
          return (
            (o[(e[0] = "EXPERIMENTAL")] = 0), (o[(e[1] = "STABLE")] = 1), o
          );
        })()),
        (i.FunctionProto = (function () {
          ...
          return (
            ...
            (e.prototype.output = h.emptyArray),
            (e.prototype.attribute = h.emptyArray),
            (e.prototype.attributeProto = h.emptyArray),
            (e.prototype.node = h.emptyArray),
            (e.prototype.docString = ""),
            (e.prototype.opsetImport = h.emptyArray),
            (e.prototype.domain = ""),
            ...
            (e.verify = function (t) {
              ...
              if (
                ...
                for (var r = 0; r < t.attributeProto.length; ++r) {
                  var n = p.onnx.AttributeProto.verify(t.attributeProto[r]);
            ...
            (e.fromObject = function (t) {
              if (t instanceof p.onnx.FunctionProto) return t;
              var r = new p.onnx.FunctionProto();
              ...
              if (t.attributeProto) {
                ...
                for (var n = 0; n < t.attributeProto.length; ++n) {
                  ...
                  r.attributeProto[n] = p.onnx.AttributeProto.fromObject(
                    t.attributeProto[n]
                  );
                }
              }
            ...
            (e.toObject = function (t, r) {
              ...
              if (
                ...
                for (var s = 0; s < t.opsetImport.length; ++s)
                  n.opsetImport[s] = p.onnx.OperatorSetIdProto.toObject(
                    t.opsetImport[s],
                    r
                  );
              }
              if (
                ...
                for (var s = 0; s < t.attributeProto.length; ++s)
                  n.attributeProto[s] = p.onnx.AttributeProto.toObject(
                    t.attributeProto[s],
                    r
                  );
              }
      ...
      (de = class {
        ...
        (dt = class i {
          ...
          static calc(e, o, t, r, n) {
            ...
            if (s) {
              if (r && !A.areEqual(s, e.dims)) return;
              let a = A.size(s),
                u = r ? e : new rt(s, n || e.type);
              if (s.length === 0) u.set([], t(e.get([]), o.get([])));
              else {
                let l = new Array(s.length),
                  f = new Array(e.dims.length),
                  c = new Array(o.dims.length),
                  d = 0,
                  m = 0,
                  y = !1,
                  g = !1;
                e.dims.length === 0 && ((d = e.get([])), (y = !0)),
                  o.dims.length === 0 && ((m = o.get([])), (g = !0));
                let T;
                for (let _ = 0; _ < a; _++) {
                  T = _;
                  for (let w = s.length - 1; w >= 0; w--)
                    (l[w] = T % s[w]), (T = Math.floor(T / s[w]));
                  y || (i.fillIndex(l, e.dims, f), (d = e.get(f))),
                    g || (i.fillIndex(l, o.dims, c), (m = o.get(c))),
                    u.set(l, t(d, m));
                }
              }
              return u;
        ...
        (Cr = class {
          static getShapeOfGemmResult(e, o, t, r, n) {
            ...
            if (n && !dt.isValidBroadcast(n, [s, u]))
        ...
        (ut = class i {
          static tensorDataTypeFromProto(e) {
            switch (e) {
              case j.onnx.TensorProto.DataType.INT8:
                return "int8";
              case j.onnx.TensorProto.DataType.UINT8:
                return "uint8";
              case j.onnx.TensorProto.DataType.BOOL:
                return "bool";
              case j.onnx.TensorProto.DataType.INT16:
                return "int16";
              case j.onnx.TensorProto.DataType.UINT16:
                return "uint16";
              case j.onnx.TensorProto.DataType.INT32:
                return "int32";
              case j.onnx.TensorProto.DataType.UINT32:
                return "uint32";
              case j.onnx.TensorProto.DataType.FLOAT:
                return "float32";
              case j.onnx.TensorProto.DataType.DOUBLE:
                return "float64";
              case j.onnx.TensorProto.DataType.STRING:
                return "string";
              case j.onnx.TensorProto.DataType.INT64:
                return "int32";
              case j.onnx.TensorProto.DataType.UINT64:
                return "uint32";
              default:
                throw new Error(
                  `unsupported data type: ${j.onnx.TensorProto.DataType[e]}`
                );
            }
          }
          static tensorDataTypeStringToEnum(e) {
            switch (e) {
              case "int8":
                return j.onnx.TensorProto.DataType.INT8;
              case "uint8":
                return j.onnx.TensorProto.DataType.UINT8;
              case "bool":
                return j.onnx.TensorProto.DataType.BOOL;
              case "int16":
                return j.onnx.TensorProto.DataType.INT16;
              case "uint16":
                return j.onnx.TensorProto.DataType.UINT16;
              case "int32":
                return j.onnx.TensorProto.DataType.INT32;
              case "uint32":
                return j.onnx.TensorProto.DataType.UINT32;
              case "float32":
                return j.onnx.TensorProto.DataType.FLOAT;
              case "float64":
                return j.onnx.TensorProto.DataType.DOUBLE;
              case "string":
                return j.onnx.TensorProto.DataType.STRING;
              case "int64":
                return j.onnx.TensorProto.DataType.INT64;
              case "uint64":
                return j.onnx.TensorProto.DataType.UINT64;
              default:
                throw new Error(`unsupported data type: ${e}`);
            }
          }
          static tensorDimsFromProto(e) {
            return e.map((o) => (jt.isLong(o) ? o.toNumber() : o));
          }
          ...
          static tensorDimsFromORTFormat(e) {
            ...
            for (let t = 0; t < e.dimsLength(); t++)
              o.push(xt.longToNumber(e.dims(t)));
            return o;
          }
        ...
        (xt = class {
          ...
          static isLong(e) {
            return jt.isLong(e) || e instanceof b.Long;
          }
        }),
        (A = class i {
          static size(e) {
          ...
          static incrementIndex(e, o, t) {
            if (o.length === 0 || e.length === 0)
              throw new Error(
                "Index incrementing unsupported for scalar Tensor"
              );
            if (t === void 0) t = o.length;
            else if (t <= 0 || t > o.length)
              throw new Error("Incorrect axis to increment on");
            for (let r = t - 1; r >= 0 && (e[r]++, !(e[r] < o[r])); --r)
              e[r] = 0;
          }
          ...
          static validateDimsAndCalcSize(e) {
            ...
            for (let t of e) {
              ...
              if (t < 0 || t > 2147483647)
                throw new TypeError(
                  `Invalid shape: length ${t} is not allowed`
                );
              o *= t;
            }
            return o;
            ...
            if (u && u !== "NOTSET")
              switch (u) {
                ...
                case "SAME_UPPER":
                  ...
                  {
                    let c = ((e + o - 1) / o - 1) * o + r - e;
                    return (
                      (n[s] = Math.floor(
                        u === "SAME_LOWER" ? (c + 1) / 2 : c / 2
                      )),
                      (n[a] = c - n[s]),
                      Math.floor((e + c - r) / o + 1)
                    );
                  }
                default:
        ...
        (me = -34028234663852886e22),
        (be = 34028234663852886e22);
    });
  function Wc(i) {
    switch (i) {
      case "bool":
  ...
  function Ja(i) {
    switch (i) {
      case N.onnx.TensorProto.DataType.UINT8:
      case N.onnx.TensorProto.DataType.INT8:
      case N.onnx.TensorProto.DataType.BOOL:
        return 1;
      case N.onnx.TensorProto.DataType.UINT16:
      case N.onnx.TensorProto.DataType.INT16:
        return 2;
      case N.onnx.TensorProto.DataType.FLOAT:
      case N.onnx.TensorProto.DataType.INT32:
      case N.onnx.TensorProto.DataType.UINT32:
        return 4;
      case N.onnx.TensorProto.DataType.INT64:
      case N.onnx.TensorProto.DataType.DOUBLE:
      case N.onnx.TensorProto.DataType.UINT64:
        return 8;
      default:
        throw new Error(
          `cannot calculate sizeof() on type ${N.onnx.TensorProto.DataType[i]}`
        );
    }
  }
  function Hc(i, e) {
  ...
  function so(i, e) {
    if (
      e === N.onnx.TensorProto.DataType.INT64 ||
      e === ao.TensorDataType.INT64
    ) {
      if (i.greaterThanOrEqual(2147483648) || i.lessThan(-2147483648))
        throw new TypeError("int64 is not supported");
    } else if (
      e === N.onnx.TensorProto.DataType.UINT32 ||
      e === ao.TensorDataType.UINT32 ||
      e === N.onnx.TensorProto.DataType.UINT64 ||
      e === ao.TensorDataType.UINT64
    ) {
      if (i.greaterThanOrEqual(4294967296) || i.lessThan(0))
        throw new TypeError("uint64 is not supported");
    } else
      throw new TypeError(`not a LONG type: ${N.onnx.TensorProto.DataType[e]}`);
    return i.toNumber();
  }
  function Za(i, e, o) {
    switch (e) {
      ...
      case N.onnx.TensorProto.DataType.INT64:
        return so(
          jt.fromBits(i.getUint32(o, !0), i.getUint32(o + 4, !0), !1),
          e
        );
      case N.onnx.TensorProto.DataType.DOUBLE:
      ...
      case N.onnx.TensorProto.DataType.UINT64:
        return so(
          jt.fromBits(i.getUint32(o, !0), i.getUint32(o + 4, !0), !0),
          e
        );
      default:
        throw new Error(
          `cannot read from DataView for type ${N.onnx.TensorProto.DataType[e]}`
        );
    }
  }
  var Ya,
    ...
    ye = x(() => {
      ...
      N = Ae(Le());
      U();
      (ao = P.experimental.fbs),
        (rt = class i {
          constructor(e, o, t, r, n, s = Ya.Guid.create()) {
            this.dims = e;
            this.type = o;
            this.dataProvider = t;
            ...
            this.cache = n;
            this.dataId = s;
            this.size = A.validateDimsAndCalcSize(e);
            let a = this.size,
          ...
          get floatData() {
            switch (this.type) {
              ...
              default:
                throw new TypeError(
                  "data type is not float (float32, float64)"
                );
            }
          }
          get numberData() {
          ...
          get(e) {
            return this.data[A.indicesToOffset(e, this.strides)];
          }
          set(e, o) {
            this.data[A.indicesToOffset(e, this.strides)] = o;
          }
          async getData() {
            return (
              this.cache === void 0 &&
          ...
          get strides() {
            return (
              this._strides || (this._strides = A.computeStrides(this.dims)),
              this._strides
            );
          }
          static fromProto(e) {
            ...
            let o = ut.tensorDataTypeFromProto(e.dataType),
              t = ut.tensorDimsFromProto(e.dims),
              r = new i(t, o);
            if (o === "string")
              ...
              for (let a = 0; a < n.length; a++) {
                let u = n[a];
                jt.isLong(u) ? (s[a] = so(u, e.dataType)) : (s[a] = u);
              }
            }
            return r;
          }
          ...
          static fromOrtTensor(e) {
            if (!e)
              throw new Error("cannot construct Value from an empty tensor");
            let o = ut.tensorDimsFromORTFormat(e),
              t = ut.tensorDataTypeFromProto(e.dataType()),
              r = new i(o, t);
            if (t === "string")
  ...
  var os,
    ...
    as = x(() => {
      ...
      Vt();
      ge();
      (os = { name: "pack", inputNames: ["A"], inputTypes: [1] }),
        (Kc = (i, e) => {
          let o = D(i.session.backend.glContext.version),
            t = e.dims,
            r = t.length,
            n = e.dims.length,
            s = ht(n),
            a = Fe("rc", n),
            u = Yc(n, a, t[t.length - 2], t[t.length - 1]),
            l;
          r === 0
            ? (l = [1, 1])
            : r === 1
...
`;
  ...
  var Qc,
    ...
    ls = x(() => {
      ...
      `;
          ...
          let a = D(i.session.backend.glContext.version),
            u = `
      ${ep(r)}
      ${rp(n)}
      ${Ut()}
  ...
  var fo,
    fs = x(() => {
      ...
      fo = (i, e) => {
        let o = e.shape,
          t = D(i.session.backend.glContext.version),
          r = `
  ...
  var cs,
    ...
    ds = x(() => {
      ...
      Vt();
      ge();
      (cs = { name: "unpack", inputNames: ["A"], inputTypes: [2] }),
        (np = (i, e) => {
          let o = e.dims.length,
            t = Fe("rc", o),
            r = t.slice(-2),
            n = ht(o),
            s = Ut(),
            u = e.dims.length === 0 ? "" : op(o, t),
            l = o <= 1 ? "rc" : `vec2(${r.join(",")})`,
            f = D(i.session.backend.glContext.version),
            c = `
    ${s}
    void main() {
      ...
      (Gr = class {
        ...
        (Qe = class {
          ...
          encode(e, o) {
            ...
            return (
              this.channelSize === 1 &&
                (z.verbose("Encoder", "Exploding into a larger array"),
                (t = this.allocate(o)),
    ...
    ms = x(() => {
      ...
      (er = (i, e, o) => {
        let t = o === 0 || o === 1 ? 1 : 4,
          ...
          a =
            o === 4
              ? e.map((u, l) => (l === e.length - 1 ? u * 4 : u))
              : void 0;
        return co(i, e, t, a, { isPacked: r, reverseWH: n, breakAxis: s });
      }),
        (hs = (i, e, o) => {
          let t = er(i, e, o);
      ...
      (ap = (i, e) => {
        ...
        (Vr = class {
          ...
          calculateTextureWidthAndHeight(e, o) {
            return hs(this.session.layoutStrategy, e, o);
          }
          executeProgram(e, o) {
          ...
          getOrCreateTextureData(e, o) {
            ...
            if (!t) {
              let r = er(this.session.layoutStrategy, e.dims, o);
              if (o === 4) {
                let a = e.dims;
                if (a.length === 4) {
                  let u = [a[0], Math.ceil((a[1] * a[2] * a[3]) / 4)],
                    l = er(this.session.layoutStrategy, u, o),
                    f = e.numberData;
                  if ((a[1] * a[2] * a[3]) % 4 !== 0) {
                    let c = a[0],
                      d = a[1] * a[2] * a[3],
                      m = Math.ceil((d * 1) / 4) * 4,
                      y = c * m;
                    f = new Float32Array(y);
                    for (let g = 0; g < c; ++g) {
                      let T = g * d,
                        _ = g * m + (g % 1) * d;
                      f.set(e.numberData.subarray(T, T + d), _);
                    }
                  }
              ...
              if (o === 2) {
                let n = co(this.session.layoutStrategy, e.dims, 1, [], {
                    reverseWH: !0,
                  }),
          ...
          reshapeUnpacked(e, o) {
            let t = this.getOrCreateTextureData(e, 0),
              r = {
                ...
                strides: A.computeStrides(o),
                unpackedShape: o,
              };
            return this.createTextureDataFromTexture(r, e.type, t.texture)
              .tensor;
          }
          reshapePacked(e, o) {
          ...
          pack(e) {
            return this.executeProgram(is(this, e.tensor), [e.tensor]);
          }
          unpack(e) {
            return this.executeProgram(ps(this, e.tensor), [e.tensor]);
          }
        });
    });
  var po,
  ...
  var gs,
    ...
    ws = x(() => {
      ...
      (gs = {
        ...
        (xs = (i, e, o) => (
          up(e),
          [i.run({ ...gs, cacheHint: o.cacheKey, get: () => sp(i, e, o) }, e)]
        )),
        (Ts = (i) => {
          let e = i.attributes.getFloat("epsilon", 1e-5),
            o = i.attributes.getFloat("momentum", 0.9),
            t = i.attributes.getInt("spatial", 1);
          return F({ epsilon: e, momentum: o, spatial: t });
        }),
        (sp = (i, e, o) => {
          let t = D(i.session.backend.glContext.version),
            r = e[0].dims.length,
  ...
  var Pt,
    ...
    Bs = x(() => {
      ...
      (Pt = (i, e, o, t = e[0].type, r) => {
        ...
        (Ip = (i, e, o, t = e[0].type) => {
          let r = i.session.pack ? 2 : 0,
            n = !A.areEqual(e[0].dims, e[1].dims),
            s = e[0].dims,
            a = i.session.pack;
          if (n) {
            let f = dt.calcShape(e[0].dims, e[1].dims, !1);
            if (!f)
              throw new Error("Can't perform binary op on the given tensors");
            s = f;
            let c = s.length,
              d = e[0].dims.length !== 0 ? e[0].dims.length : 1,
              m = e[1].dims.length !== 0 ? e[1].dims.length : 1,
              y =
                e[0].dims.length !== 0
      ...
      float process(int indices[${c}]) {
        ...
        return ${o.name}(_A(aindices), _B(bindices));
          ...
          let u = D(i.session.backend.glContext.version),
            l = `
    ${o.body}
    void main() {
    ...
    `;
        ...
        (vs = (i, e) => [i.run(Pt(i, e, fp()), e)]),
        (Is = (i, e) => [i.run(Pt(i, e, yp(), "bool"), e)]),
        (_s = (i, e) => [i.run(Pt(i, e, cp()), e)]),
        (Ss = (i, e) => [i.run(Pt(i, e, hp(), "bool"), e)]),
        (Os = (i, e) => [i.run(Pt(i, e, mp(), "bool"), e)]),
        (As = (i, e) => [i.run(Pt(i, e, bp(), "bool"), e)]),
        (Ps = (i, e) => [i.run(Pt(i, e, pp()), e)]),
        (Es = (i, e) => [i.run(Pt(i, e, gp(), "bool"), e)]),
        (Ds = (i, e) => [i.run(Pt(i, e, Tp()), e)]),
        (Ls = (i, e) => [i.run(Pt(i, e, wp()), e)]),
        ($s = (i, e) => [i.run(Pt(i, e, dp()), e)]),
        (ks = (i, e) => [i.run(Pt(i, e, xp(), "bool"), e)]);
    });
  var Fs,
    Ns,
    Sp,
    Cs = x(() => {
      "use strict";
      U();
      (Fs = (i, e, o) => (Sp(e), [i.cast(e[0], o)])),
        (Ns = (i) => ut.tensorDataTypeFromProto(i.attributes.getInt("to"))),
        (Sp = (i) => {
      ...
      (Op = (i, e) => ({
        ...
        (Ap = (i, e, o, t) => {
          ...
          for (let B = 1; B < o.length; B++) {
            let Q = o[B].dims.slice();
            for (let pt = 0; pt < r.length; pt++)
              if (pt === t) n[t] += Q[pt];
              else if (r[pt] !== Q[pt])
          ...
          d[0] = f[0][t];
          for (let B = 1; B < d.length; B++) d[B] = d[B - 1] + f[B][t];
          let m = c[t],
            y = c.slice(-2),
            g = c.join(),
            T = `if (${m} < ${d[0]}) {
        return getChannel(
          ...
          T += `
            return getChannel(
              getX${_}(${Wr(c, m, w)}),
              vec2(${Wr(y, m, w)}));`;
          let v = D(i.session.backend.glContext.version),
            L = `
          ${l}
        ...
        (Rs = (i, e, o) => {
          let t = Op(e.length, o.cacheKey);
          return { ...t, get: () => Ap(i, t, e, o.axis) };
        }),
        (Wr = (i, e, o) => {
          let t = i.indexOf(e);
      ...
      (Ms = (i, e, o) => (
        ...
        (Ep = (i, e, o, t) => {
          ...
          let s = n.length,
            ...
            u = 0;
          for (let m = 0; m < a.length; ++m) (u += o[m].dims[t]), (a[m] = u);
          let l = "";
          o.length < 5 ? (l = Vs(a)) : (l = Lp(a));
          let f = $p(o.length, s),
            c = kp(a),
            d = `
        ${f}
        ...
        (Dp = (i, e, o) => {
          let t = Pp(e.length, o.cacheKey);
          return { ...t, get: () => Ep(i, t, e, o.axis) };
        }),
        (Vs = (i) => `int getTextureWhereDataResides(int index) {
      ${i
        .map(
...
`)
        ...
        (Us = (i) => F({ axis: i.attributes.getInt("axis") })),
        (Bp = (i) => {
  ...
  var Qp,
    ...
    xo = x(() => {
      ...
      (Qp = (i, e, o, t) => {
        let r = i.session.pack ? 2 : 0,
          n = D(i.session.backend.glContext.version);
        return {
          ...e,
     ...
     `,
        ...
        (Z = (i, e, o, t) => {
          ...
          return { ...n, get: () => Qp(i, n, e, o) };
        }),
        (Ws = (i, e) => [i.run(Z(i, e[0], Fp()), e)]),
        (Hs = (i, e) => [i.run(Z(i, e[0], Np()), e)]),
        (qs = (i, e) => [i.run(Z(i, e[0], Cp()), e)]),
        (js = (i, e) => [i.run(Z(i, e[0], Rp()), e)]),
        (yo = (i, e, o) => [
          i.run(Z(i, e[0], ho(o.min, o.max), o.cacheKey), e),
        ]),
        (Xs = (i) =>
          F({
            min: i.attributes.getFloat("min", me),
            max: i.attributes.getFloat("max", be),
          })),
        (Ks = (i, e) => {
          let o = td(i, e);
          return yo(i, [e[0]], o);
        ...
        (td = (i, e) => {
          ...
          let o = e.length >= 3 ? e[1].numberData[0] : me,
            t = e.length >= 3 ? e[2].numberData[0] : be;
          return F({ min: o, max: t });
        }),
        (Js = (i, e) => [i.run(Z(i, e[0], Gp()), e)]),
        (Zs = (i, e) => [i.run(Z(i, e[0], Mp()), e)]),
        (Ys = (i, e, o) => [i.run(Z(i, e[0], Vp(o.alpha), o.cacheKey), e)]),
        (Qs = (i) => F({ alpha: i.attributes.getFloat("alpha", 1) })),
        (tu = (i, e) => [i.run(Z(i, e[0], Up()), e)]),
        (eu = (i, e) => [i.run(Z(i, e[0], zp()), e)]),
        (go = (i, e) => [i.run(Z(i, e[0], Wp()), e)]),
        (ru = (i, e, o) => [i.run(Z(i, e[0], Hp(o.alpha), o.cacheKey), e)]),
        (nu = (i) => F({ alpha: i.attributes.getFloat("alpha", 0.01) })),
        (ou = (i, e) => [i.run(Z(i, e[0], qp()), e)]),
        (iu = (i, e) => [i.run(Z(i, e[0], jp()), e)]),
        (au = (i, e) => [i.run(Z(i, e[0], Xp()), e)]),
        (su = (i, e) => [i.run(Z(i, e[0], mo()), e)]),
        (uu = (i, e) => [i.run(Z(i, e[0], bo()), e)]),
        (lu = (i, e) => [i.run(Z(i, e[0], Kp()), e)]),
        (fu = (i, e) => [i.run(Z(i, e[0], Jp()), e)]),
        (cu = (i, e) => [i.run(Z(i, e[0], Zp()), e)]),
        (pu = (i, e) => [i.run(Z(i, e[0], Yp()), e)]);
    });
  function zt(i) {
    let e;
    switch (i.activation) {
  ...
  var Ne,
    xe = x(() => {
      ...
      Ne = (i) => {
        ...
        if (e === "Clip") {
          let [o, t] = i.getFloats("activation_params", [me, be]);
          return {
            activation: e,
            clipMax: t,
            clipMin: o,
    ...
    hu = x(() => {
      ...
      (rd = (i, e) => ({
        ...
        (nd = (i, e, o, t) => {
          ...
          let l = Ce(s, a, t.dilations, t.pads, t.strides),
            f = D(i.session.backend.glContext.version),
            { activationFunction: c, applyActivation: d } = zt(t),
            m = `
...
`;
        ...
        (du = (i, e, o) => {
          let t = rd(e.length > 2, o.cacheKey);
          return { ...t, get: () => nd(i, e, t, o) };
        });
    });
  var od,
    id,
    ...
    bu = x(() => {
      ...
      (od = (i) => ({
        ...
        (id = (i, e, o, t, r, n) => {
          let s = o.dims,
            ...
            l = 3,
            f = r.length,
            c = [a[1] * a[2] * a[3], r[2] * r[3]],
            d = a[2] * a[3],
            m = Ut(),
            y = D(i.session.backend.glContext.version),
            g = "";
          for (let _ = 0; _ <= 1; _++)
            for (let w = 0; w <= 1; w++)
              g += `
      ...
      void main() {
        ivec2 rc = getOutputCoords();
          ...
          return {
            ...e,
            output: { dims: c, type: o.type, textureType: 2 },
            shaderSource: T,
            hasMain: !0,
          };
        }),
        (mu = (i, e, o, t, r) => {
          let n = od(r.cacheKey);
          return { ...n, get: () => id(i, n, e, o, t, r) };
        });
    });
  function sd(i, e, o) {
    let t = e[0].dims,
      r = e[1].dims,
      n = dt.calcShape(t, r, !0);
    if (!n) throw new Error("Can't use matmul on the given tensors");
    let s = ht(n.length),
      a = Gt(),
      { activationFunction: u, applyActivation: l } = zt(o),
      f = e.length > 2,
      c = f ? "value += getBiasForMatmul();" : "",
      d = f ? `${wo(s, a, e[2].dims, n, !1)}` : "",
      m = n.length,
      y = t.length,
      g = r.length,
      T = t[t.length - 1],
  ...
  function To(i, e) {
    let o = ad(i.length > 2, e.activationCacheKey);
    return { ...o, get: () => sd(o, i, e) };
  }
  function wo(i, e, o, t, r) {
    let n = "",
      s = o.length,
      a = t.length,
      u = a - s;
    a < 2 && s > 0
      ? (n = "coords")
      : (n = o.map((g, T) => `coords.${e[T + u]}`).join(", "));
    let f = dt.getBroadcastDims(o, t).map((g) => `coords.${e[g + u]} = 0;`)
        .join(`
`),
      d = A.size(o) === 1,
      m = "vec4(outputValue.xx, outputValue.yy)";
    return (
      d && (m = "vec4(outputValue.x)"),
      r
        ? `
...
float getBiasForMatmul() {
  ...
  var yu,
    ...
    qr = x(() => {
      ...
      vo();
      (yu = (i, e, o) => (
        ud(e), i.session.pack ? [i.run(jr(i, e, o), e)] : [i.run(To(e, o), e)]
      )),
        (gu = (i) => Ne(i.attributes)),
        (ad = (i, e) => ({
          name: "MatMul",
  ...
  function cd(i, e, o, t) {
    let r = [],
      ...
      c = f - u,
      d = f - l;
    (r = s.map((v, L) => `coords.${e[L + c]}`)),
      (r[u - 1] = "i*2"),
      r.join(", "),
      (n = a.map((v, L) => `coords.${e[L + d]}`)),
      (n[l - 2] = "i*2"),
      n.join(", ");
    let m = dt.getBroadcastDims(s, t),
      y = dt.getBroadcastDims(a, t),
      g = m.map((v) => `coords.${e[v + c]} = 0;`).join(`
`),
  ...
  var ld,
    ...
    vo = x(() => {
      ...
      (ld = (i, e) => ({
        ...
        (fd = (i, e, o, t) => {
          let r = o.length > 2,
            ...
            s = o[0].dims,
            a = o[1].dims,
            u = dt.calcShape(s, a, !0),
            l = !A.areEqual(o[0].dims, o[1].dims);
          ...
          let f = s[s.length - 1],
            ...
            T = u.length,
            _ = Gt(),
            { activationFunction: w, applyActivation: v } = zt(t),
            L = r ? `${wo(g, _, o[2].dims, u, !0)}` : "",
            B = l ? `${cd(g, _, o, u)}` : "",
            Q = l ? "getAAtOutCoordsMatmul(i)" : `getA(${pd(_, d)})`,
            pt = l ? "getBAtOutCoordsMatmul(i)" : `getB(${dd(_, m)})`,
            Ht = l
              ? ""
              : `${g} rc =
      ...
      `,
        ...
        (jr = (i, e, o) => {
          let t = ld(e.length > 2, o.activationCacheKey);
          return { ...t, get: () => fd(i, t, e, o) };
        });
    });
  var xu,
    Tu = x(() => {
      ...
      xu = (i, e, o) => {
        let t = e[0].dims,
          r = e[1].dims,
          n = Ce(t, r, o.dilations, o.pads, o.strides),
          s = i.run(mu(i, e[0], e[1], n, o), [e[0]]),
      ...
      (bd = (i, e) => ({
        ...
        (yd = (i, e, o, t, r) => {
          let n = o[0].dims,
            ...
            c = A.computeStrides(u),
            [d, m] = i.calculateTextureWidthAndHeight(u, 4),
            y = t.length,
            g = o.length < 3 ? "0.0" : "_B(b)",
            T = Math.ceil((n[1] * s[2] * s[3]) / 4),
            { activationFunction: _, applyActivation: w } = zt(r),
            v = D(i.session.backend.glContext.version),
            L = `
${_}
float process(int indices[${y}]) {
  ...
  return value;
        ...
        (vu = (i, e, o, t) => {
          let r = bd(e.length > 2, t);
          return { ...r, get: () => yd(i, r, e, o, t) };
        });
    });
  var Ce,
    So,
    ...
    Hr = x(() => {
      ...
      (Ce = (i, e, o, t, r) => {
        let n = i[0],
          ...
          a = s.length,
          u = e[0],
          f = e.slice(2).map((y, g) => y + (y - 1) * (o[g] - 1)),
          d = s
            .map((y, g) => y + t[g] + t[g + a])
            .map((y, g) => Math.floor((y - f[g] + r[g]) / r[g]));
        return [n, u].concat(...d);
      }),
        (So = (i, e, o) => (vd(e, o), gd(i, e, o))),
        (gd = (i, e, o) => {
          let t = wd(o, e),
            r = i.session.pack,
        ...
        (Td = (i, e, o) => {
          let t = e[0].dims,
            r = e[1].dims,
            n = Ce(t, r, o.dilations, o.pads, o.strides),
            s = i.run(wu(i, e[0], e[1], n, o), [e[0]]),
            a = e.length === 3 ? [s, e[1], e[2]] : [s, e[1]];
          return i.run(vu(i, e, n, o), a);
        }),
        (wd = (i, e) => {
          ...
          return (
            Object.assign(r, { kernelShape: o, pads: t, cacheKey: i.cacheKey }),
            r
          );
        }),
        (Oo = (i) => {
  ...
  var Id,
    ...
    Ou = x(() => {
      ...
      R();
      xe();
      (Id = (i, e, o, t, r, n) => (i - 1) * e + o + (t - 1) * r + 1 - n),
        (_d = (i, e, o, t, r) => {
        ...
        (Sd = (i, e, o, t, r, n, s, a) => {
          let u = i.length - 2,
            l = a.length === 0;
          for (let f = 0; f < u; ++f) {
            let c = l ? i[f + 2] * n[f] : a[f],
              d = Id(i[f + 2], n[f], r[f], e[f], o[f], c);
            _d(d, t, r, f, f + u),
              l &&
                a.push(
                  n[f] * (i[f + 2] - 1) +
        ...
        (Pd = (i, e, o, t) => {
          let n = e.length > 2 ? "getB(output_channel)" : "0.0",
            ...
            c = D(i.session.backend.glContext.version),
            { activationFunction: d, applyActivation: m } = zt(t),
            y = `
  const ivec2 strides = ivec2(${t.strides[0]}, ${t.strides[1]});
  const ivec2 pads = ivec2(${t.pads[0]}, ${t.pads[1]});
  ${d}
...
`;
        ...
        (Ed = (i, e, o) => {
          let t = Ad(e.length > 2, o.cacheKey);
          return { ...t, get: () => Pd(i, e, t, o) };
        }),
        (Dd = (i, e, o) => i.run(Ed(i, e, o), e)),
        (Ld = (i, e) => {
          let o = i.kernelShape.slice();
          if (i.kernelShape.length === 0)
          ...
          let t = i.pads.slice(),
            ...
            n = e[0].dims;
          Sd(n, o, i.dilations, i.autoPad, t, i.strides, i.outputPadding, r);
  ...
  var Au,
    ...
    Xr = x(() => {
      ...
      U();
      R();
      (Au = { name: "Transpose", inputNames: ["A"], inputTypes: [0] }),
        (Te = (i, e, o) => (
          Nd(e),
          [
            i.run(
              { ...Au, cacheHint: o.cacheKey, get: () => kd(i, e[0], o.perm) },
              e
            ),
          ]
        )),
        (Pu = (i) => F({ perm: i.attributes.getInts("perm", []) })),
        (kd = (i, e, o) => {
          let t = e.dims;
          o = Eu(t, o);
          let r = Bd(t, o),
      ...
      float process(int indices[${n}]) {
        ...
        (Bd = (i, e) => ((e = Eu(i, e)), A.sortBasedOnPerm(i, e))),
        (Fd = (i, e, o) => {
          let t = [];
...
`)
    ...
    $u = x(() => {
      ...
      (Du = (i, e, o) => {
        ...
        (Cd = (i) => {
          if (i.length !== 1)
            throw new Error(
              `DepthToSpace expect 1 inputs, but got ${i.length}`
            );
  ...
  var ku,
    ...
    Fu = x(() => {
      ...
      (ku = (i, e, o) => {
        Rd(e, o);
        let t = A.flattenShape(e[0].dims, o);
        return [i.reshapeUnpacked(e[0], t)];
      }),
        (Bu = (i) => i.attributes.getInt("axis", 1)),
        (Rd = (i, e) => {
          if (!i || i.length !== 1)
  ...
  var Nu,
    ...
    Ru = x(() => {
      ...
      U();
      R();
      (Nu = (i, e, o) => (Ud(e, o.axis), [i.run(Vd(i, e, o), e)])),
        (Cu = (i) => F({ axis: i.attributes.getInt("axis", 0) })),
        (Gd = { name: "Gather", inputNames: ["A", "B"], inputTypes: [0, 0] }),
        (Md = (i, e, o, t) => {
          let r = o[0].dims.slice(),
            n = o[1].dims.slice(),
            s = new Array(r.length + n.length - 1);
          t = A.normalizeAxis(t, r.length);
          let a = [];
      ...
      float process(int outputIdx[${u}]) {
        ...
        (Vd = (i, e, o) => {
          let t = { ...Gd, cacheHint: o.cacheKey };
          return { ...t, get: () => Md(i, t, e, o.axis) };
        }),
        (Ud = (i, e) => {
          if (!i || i.length !== 2)
  ...
  var Ao,
    ...
    Uu = x(() => {
      ...
      U();
      R();
      (Ao = (i, e, o) => (Hd(e, o), [i.run(zd(e, o), e)])),
        (Gu = (i, e) => {
          ...
          return F({ transA: o, transB: t, alpha: r, beta: n, isOptionalC: e });
        }),
        (Mu = (i) => Gu(i, !1)),
        (Vu = (i) => Gu(i, !0)),
        (zd = (i, e) => {
          ...
          return { ...o, get: () => Wd(o, i, e) };
        }),
        (Wd = (i, e, o) => {
          let t = e[0].dims.slice(),
            r = e[1].dims.slice(),
            [n, s] = Cr.getShapeOfGemmResult(
              t,
              o.transA,
              r,
              o.transB,
          ...
          let f = a.length,
            c = e.length === 3 ? `int c[${e[2].dims.length}];` : "",
            d = e.length === 3 ? "bcastIndices_C(indices, c);" : "",
            m = e.length === 3 ? "value += beta * _C(c);" : "",
            y = `
  ...
  var zu,
    ...
    Hu = x(() => {
      ...
      at();
      R();
      (zu = (i, e, o) => (Jd(e), [i.run(Xd(i, e, o), e)])),
        (Wu = (i) => {
          let e = i.attributes.getFloat("scale"),
            o = i.attributes.getFloats("bias");
          return F({ scale: e, bias: o });
        }),
        (qd = { name: "ImageScaler", inputNames: ["X"], inputTypes: [0] }),
        (jd = (i, e, o, t) => {
          let r = o[0].dims.slice(),
            n = r.length,
            a = `
      ...
      float process(int indices[${n}]) {
        ...
        (Xd = (i, e, o) => {
          let t = { ...qd, cacheHint: o.cacheKey };
          return { ...t, get: () => jd(i, t, e, o) };
        }),
        (Kd = (i) => {
...
`)
  ...
  var ju,
    ...
    Ku = x(() => {
      ...
      (ju = (i, e, o) => {
        rh(e);
        let t = i.run(Yd(e[0]), e);
        return [i.run(eh(i, e[0], o, t.dims), [e[0], t, e[1], e[2]])];
      }),
        (Xu = (i) => i.attributes.getFloat("epsilon", 1e-5)),
        (qu = {
      ...
      vec4 process(int[2] indices) {
        ...
        (th = (i, e, o, t, r) => {
          let n = D(i.session.backend.glContext.version),
      ...
      float process(int[4] indices) {
        ...
        (eh = (i, e, o, t) => {
          let r = { ...Qd, cacheHint: `${o}` };
          return { ...r, get: () => th(i, r, e, o, t) };
        }),
        (rh = (i) => {
          if (!i || i.length !== 3)
  ...
  function oh(i, e) {
    return { ...Yu, cacheHint: e.cacheKey, get: () => nh(i, e) };
  }
  var Ju,
    Zu,
    Yu,
    ...
    Qu = x(() => {
      ...
      (Ju = (i, e, o) => (ih(e), [i.run(oh(e, o), e)])),
        (Zu = (i) => {
          ...
          return F({ alpha: e, beta: o, bias: t, size: r });
        }),
        (Yu = { name: "LRN", inputNames: ["X"], inputTypes: [0] });
      ih = (i) => {
  ...
  var ah,
    ...
    nl = x(() => {
      ...
      X();
      R();
      (ah = { name: "Pad", inputNames: ["A"], inputTypes: [0] }),
        (Po = (i, e, o) => (
          lh(e),
          [
            i.run(
              { ...ah, cacheHint: o.cacheKey, get: () => uh(i, e[0], o) },
              e
            ),
          ]
        )),
        (tl = (i) => {
          ...
          return F({ mode: e, value: o, pads: t });
        }),
        (el = (i, e, o) => {
          fh(e);
          let t = sh(i, e, o);
        ...
        (rl = (i) => i.attributes.getString("mode", "constant")),
        (sh = (i, e, o) => {
          if (
            !i.session.isInitializer(e[1].dataId) ||
          ...
          return F({ mode: o, pads: t, value: r });
        }),
        (uh = (i, e, o) => {
          let t = A.padShape(e.dims.slice(), o.pads),
            r = t.length,
            s = `
      ${ch(i, e, o)}
      float process(int[${r}] indices) {
        ...
        (ch = (i, e, o) => {
          let t = D(i.session.backend.glContext.version),
            ...
            s = A.computeStrides(e.dims);
          switch (o.mode) {
            case "constant":
              return ph(t, e.dims, s, r, n, o.pads, o.value);
            case "reflect":
              return dh(t, e.dims, s, r, n, o.pads);
            case "edge":
              return hh(t, e.dims, s, r, n, o.pads);
            default:
  ...
  var il,
    ...
    bl = x(() => {
      ...
      (il = (i, e, o) => {
        ...
        return [i.run({ ...t, get: () => sl(e, t, !1, o) }, e)];
      }),
        (al = (i) => {
      ...
      `;
        ...
        (ul = (i, e, o) => {
          ...
          return [i.run({ ...t, get: () => sl(e, t, !0, o) }, e)];
        }),
        (ll = (i) => {
        ...
        (fl = (i, e, o) => {
          ...
          return [i.run({ ...t, get: () => pl(e, t, !1, o) }, e)];
        }),
        (cl = (i) => {
          let e = i.attributes.getString("auto_pad", "NOTSET"),
            o = i.attributes.getInt("ceil_mode", 0),
    ...
    `;
        ...
        (dl = (i, e, o) => {
          let t = i[0].dims.slice(),
            ...
            u = e.pads.slice();
          he.adjustPoolAttributes(o, t, n, s, a, u);
          let l = he.computePoolOutputShape(o, t, s, a, n, u, e.autoPad),
            f = Object.assign({}, e);
          return (
            r
              ? Object.assign(f, {
        ...
        (ol = { name: "GlobalMaxPool", inputNames: ["X"], inputTypes: [0] }),
        (hl = (i, e) => (
          Jr(e), [i.run({ ...ol, get: () => pl(e, ol, !0, mh) }, e)]
        )),
        (Jr = (i) => {
          if (!i || i.length !== 1)
        ...
        (ml = (i, e, o, t, r) => {
          ...
          for (int i = 0; i < ${s}; i++) {
            ...
            ${o}
              ...
              let g = e.kernelShape[e.kernelShape.length - 2],
                T = e.strides[e.strides.length - 2],
                _ = e.pads[e.pads.length / 2 - 2],
                w = e.pads[e.pads.length - 2],
                v = i[n - 2];
              _ + w !== 0
                ? (d = `
            for (int j = 0; j < ${g}; j++) {
      ...
      `;
            ...
            let s = A.size(e.kernelShape),
              a = A.computeStrides(e.kernelShape),
              u = a.length,
              l = e.pads.length,
              f = bh(u),
              c = Kr(i, "inputDims"),
              d = Kr(e.pads, "pads"),
              m = Kr(a, "kernelStrides"),
              y = Kr(e.strides, "strides"),
              g = e.pads.reduce((w, v) => w + v),
              T = "";
            return (
              g
                ? (T = `
  ...
  var we,
    ...
    _l = x(() => {
      ...
      (we = (i, e, o, t, r) => {
        ...
        return [
          i.run(
            { ...n, cacheHint: o.cacheKey, get: () => yh(i, e, o, t, r, n) },
            e
          ),
        ];
      }),
        (ne = (i) => {
          ...
          return F({ axes: e, keepDims: o });
        }),
        (yh = (i, e, o, t, r, n) => {
          let s = [],
            a = e[0].dims.length || 1,
            u = [],
            l = A.normalizeAxes(o.axes, e[0].dims.length),
            f = r(e, l),
            c = f[1];
          for (let y = 0; y < e[0].dims.length; y++)
            l.indexOf(y) >= 0 || l.length === 0
              ? (o.keepDims && s.push(1),
                (c = `
          for(int j${y} = 0; j${y} < ${e[0].dims[y]}; j${y}++) {
            ...
            ${c}
              ...
              : (u.push(`inputIdx[${y}] = outputIdx[${s.length}];`),
                s.push(e[0].dims[y]));
          let m = `
...
value = _A(inputIdx);`,
        ...
        (vl = (i, e, o) =>
          we(i, e, o, "ReduceLogSum", () => [
            "value = 0.0;",
            "value += _A(inputIdx);",
            "value = log(value);",
          ])),
        (Il = (i, e, o) =>
          we(i, e, o, "ReduceLogSumSquare", () => [
            "float t; value = 0.0;",
  ...
  var Sl,
    Ol = x(() => {
      ...
      U();
      Sl = (i, e) => {
        let o = A.calculateReshapedDims(e[0].dims, e[1].integerData);
  ...
  var Al,
    ...
    Lo = x(() => {
      ...
      X();
      R();
      (Al = { name: "Upsample", inputNames: ["X"], inputTypes: [0] }),
        (Eo = (i, e, o) => (
          Do(e, o),
          [i.run({ ...Al, cacheHint: o.cacheKey, get: () => xh(i, e, o) }, e)]
        )),
        (Pl = (i) => or(i, 7)),
        (El = (i) => or(i, 9)),
        (or = (i, e) => {
          ...
          let r = [];
          e < 9 && ((r = i.attributes.getFloats("scales")), Zr(r, t, o));
          ...
          if (
            ...
            throw new Error(
              `coordinate_transform_mode '${s}' is not supported`
            );
          ...
          let f = i.attributes.getFloat("cubic_coeff_a", -0.75),
            c = i.attributes.getInt("exclude_outside", 0) !== 0;
          if (c && t !== "cubic")
            throw new Error(
        ...
        (xh = (i, e, o) => {
          let t = D(i.session.backend.glContext.version),
            ...
            s = e[0].dims.map((g, T) => Math.floor(g * o.scales[T])),
      ...
      `;
          for (let g = l - 1; g >= 0; g--)
            (f[g] = g === l - 1 ? 1 : f[g + 1] * s[g + 1]),
              (c[g] = g === l - 1 ? 1 : c[g + 1] * e[0].dims[g + 1]),
              (d += `
            ...
            variables: [
              {
                ...
                data: o.scales.map((g) => Math.ceil(g)),
              },
            ],
          };
        }),
  ...
  var $o,
    ...
    $l = x(() => {
      ...
      ge();
      Lo();
      ($o = { name: "Resize", inputNames: ["A"], inputTypes: [2] }),
        (ko = (i, e, o) => (
          Do(e, o),
          [i.run({ ...$o, cacheHint: o.cacheKey, get: () => Th(i, e, o) }, e)]
        )),
        (Dl = (i) => or(i, 10)),
        (Ll = (i) => or(i, 11)),
        (Th = (i, e, o) => {
          ...
          if (o.mode !== "linear")
            throw new Error(
              `resize (packed) does not support mode: '${o.mode}'`
            );
        ...
        (wh = (i, e) => {
          ...
          if (r.length === 0) {
            ...
            if (a && a.size !== 0) {
              ...
              (n = Array.from(u.integerData)),
                (r = Ih(n, t, e.mode, e.isResize));
            }
  ...
  var Bo,
    ...
    Gl = x(() => {
      ...
      U();
      R();
      (Bo = { name: "Slice", inputNames: ["A"], inputTypes: [0] }),
        (Fl = (i, e, o) => (
          Sh(e),
          [
            i.run(
              { ...Bo, cacheHint: o.cacheKey, get: () => Cl(i, e[0], o) },
              e
            ),
          ]
        )),
        (Nl = (i) => {
          ...
          return F({ starts: e, ends: o, axes: t });
        }),
        (Cl = (i, e, o) => {
          let t =
              o.axes.length === 0 ? e.dims.slice(0).map((c, d) => d) : o.axes,
            r = A.normalizeAxes(t, e.dims.length),
            n = o.starts.map((c, d) =>
              c > e.dims[r[d]] - 1
                ? e.dims[r[d]]
                : A.normalizeAxis(c, e.dims[r[d]])
            ),
            s = o.ends.map((c, d) =>
              c > e.dims[r[d]] - 1
                ? e.dims[r[d]]
          ...
          for (let c = 0; c < r.length; c++)
            (a[r[c]] = s[c] - n[c]),
              n[c] > 0 && u.push(`outputIdx[${r[c]}] += ${n[c]};`);
          let f = `
      ...
      `)}
        ...
        (Rl = (i, e) => {
          ...
          let o = Oh(i, e);
          return [
            i.run({ ...Bo, cacheHint: o.cacheKey, get: () => Cl(i, e[0], o) }, [
              e[0],
            ]),
          ];
        }),
        ...
        (Ah = (i) => {
          ...
          if (
            i.length >= 4 &&
            (i[3].type !== "int32" || i[3].dims.length !== 1)
          )
            throw new Error("Invalid input type.");
          if (
            i.length >= 5 &&
            (i[4].type !== "int32" || i[4].dims.length !== 1)
          )
            throw new Error("Invalid input type.");
        });
    });
  var Ml,
    ...
    Kl = x(() => {
      ...
      R();
      Xr();
      (Ml = { name: "SoftmaxComputeMax", inputNames: ["A"], inputTypes: [0] }),
        (Vl = {
        ...
        (zl = (i, e, o) => {
          Xl(e);
          let t = e[0].dims.slice(),
            r = A.normalizeAxis(o.axis, t.length),
            n = A.sizeToDimension(t, r),
            s = A.sizeFromDimension(t, r);
          return jl(i, e, o, n, s);
        }),
        (Wl = (i) => F({ axis: i.attributes.getInt("axis", 1) })),
        (Hl = (i) => F({ axis: i.attributes.getInt("axis", -1) })),
        (ql = (i, e, o) => {
          Xl(e);
          let t = e[0].dims.slice(),
            r = A.normalizeAxis(o.axis, t.length),
            ...
            f;
          s &&
            ((u = Array.from({ length: n }).map((y, g) => g)),
            (u[r] = n - 1),
            (u[n - 1] = r),
            u.map((y) => a.push(t[y])),
            (f = F({ perm: u })),
            (l = Te(i, e, f)));
          let c = s ? A.sizeToDimension(a, n - 1) : A.sizeToDimension(t, n - 1),
            d = s
              ? A.sizeFromDimension(a, n - 1)
              : A.sizeFromDimension(t, n - 1),
            m = jl(i, s ? l : e, o, c, d);
          return s ? Te(i, m, f) : m;
        }),
        (jl = (i, e, o, t, r) => {
          let n = Ph(i, e[0], t, r, [t]),
            s = i.run({ ...Ml, cacheHint: o.cacheKey, get: () => n }, e),
            a = Eh(i, e[0], t, r, n.output.dims, [t]),
            u = i.run({ ...Vl, cacheHint: o.cacheKey, get: () => a }, [
              e[0],
              s,
            ]),
            l = Dh(i, e[0], t, r, n.output.dims, a.output.dims);
          return [
            i.run({ ...Ul, cacheHint: o.cacheKey, get: () => l }, [e[0], s, u]),
          ];
        }),
        (Ph = (i, e, o, t, r) => {
      ...
      float process(int[${a}] indices) {
        ...
        (Eh = (i, e, o, t, r, n) => {
          ...
          let l = D(i.session.backend.glContext.version),
            f = `
  ...
  var Jl,
    ...
    Ql = x(() => {
      ...
      U();
      R();
      (Jl = { name: "Split", inputNames: ["A"], inputTypes: [0] }),
        (Zl = (i, e, o) => {
          kh(e);
          let t = A.normalizeAxis(o.axis, e[0].dims.length),
            r = Lh(i, e, t, o),
            n = [];
          for (let s = 0; s < r; ++s)
            n.push(
        ...
        (Yl = (i) => {
          let e = i.attributes.getInt("axis", 0),
            ...
            t = i.outputs.length;
          return F({ axis: e, split: o, numOutputs: t });
        }),
        (Lh = (i, e, o, t) => {
          let [, r] = Ze.splitShape(e[0].dims, o, t.split, t.numOutputs);
          return r.length;
        }),
        ($h = (i, e, o, t, r) => {
          let [n, s] = Ze.splitShape(e.dims, t, o.split, o.numOutputs),
            a = s[r],
            u = n[r],
            f = `
  ...
  var Fo,
    ...
    rf = x(() => {
      ...
      (Fo = (i, e, o) => {
        Bh(e);
        let t = A.squeezeShape(e[0].dims, o);
        return [i.reshapeUnpacked(e[0], t)];
      }),
        (tf = (i, e) => (Fh(e), Fo(i, [e[0]], Array.from(e[1].integerData)))),
        (ef = (i) => i.attributes.getInts("axes")),
        (Bh = (i) => {
          if (!i || i.length !== 1)
...
`)}
  ...
  var No,
    ...
    ff = x(() => {
      ...
      (No = (i, e, o) => {
        Mh(e);
        let t = A.unsqueezeShape(e[0].dims, o);
        return [i.reshapeUnpacked(e[0], t)];
      }),
        (uf = (i, e) => (Vh(e), No(i, [e[0]], Array.from(e[1].integerData)))),
        (lf = (i) => i.attributes.getInts("axes")),
        (Mh = (i) => {
          if (!i || i.length !== 1)
  ...
  var cf,
    pf = x(() => {
      ...
      cf = [
        ...
        ["Concat", "", "4+", Ms, Us],
        ["Conv", "", "1+", So, Oo],
        ["ConvTranspose", "", "1+", _u, Su],
        ["Cos", "", "7+", Zs],
        ["Div", "", "7+", _s],
        ["Dropout", "", "7+", go],
        ["DepthToSpace", "", "1+", Du, Lu],
        ["Equal", "", "7+", Ss],
        ["Elu", "", "6+", Ys, Qs],
        ["Exp", "", "6+", tu],
        ["Flatten", "", "1+", ku, Bu],
        ["Floor", "", "6+", eu],
        ["FusedConv", "com.microsoft", "1+", So, Oo],
        ["Gather", "", "1+", Nu, Cu],
        ["Gemm", "", "7-10", Ao, Mu],
        ["Gemm", "", "11+", Ao, Vu],
        ["GlobalAveragePool", "", "1+", ul, ll],
        ["GlobalMaxPool", "", "1+", hl],
        ["Greater", "", "7+", Os],
        ["Identity", "", "1+", go],
        ["ImageScaler", "", "1+", zu, Wu],
        ["InstanceNormalization", "", "6+", ju, Xu],
        ["LeakyRelu", "", "6+", ru, nu],
        ["Less", "", "7+", As],
        ["LRN", "", "1+", Ju, Zu],
        ["Log", "", "6+", ou],
        ...
        ["Pow", "", "7+", Ds],
        ["PRelu", "", "7+", Ls],
        ["ReduceLogSum", "", "1+", vl, ne],
        ["ReduceMax", "", "1+", xl, ne],
        ["ReduceMean", "", "1+", gl, ne],
        ["ReduceMin", "", "1+", Tl, ne],
        ["ReduceProd", "", "1+", wl, ne],
        ["ReduceSum", "", "1-12", yl, ne],
        ["ReduceSumSquare", "", "1+", Il, ne],
        ["Relu", "", "6+", su],
        ["Reshape", "", "5+", Sl],
        ["Resize", "", "10", ko, Dl],
        ["Resize", "", "11+", ko, Ll],
 ...
 ${f}`),
  ...
  var df,
    ...
    mf = x(() => {
      ...
      (df =
        /@inline[\s\n\r]+(\w+)[\s\n\r]+([0-9a-zA-Z_]+)\s*\(([^)]*)\)\s*{(([^}]|[\n\r])*)}/gm),
        (Uh = "(\\w+)?\\s+([_0-9a-zA-Z]+)\\s+=\\s+__FUNC__\\((.*)\\)\\s*;");
    });
  function Re(i, e) {
    let o = [],
      t = [],
      r = e != null && Array.isArray(e) && e.length === 0,
      n = e == null || r ? null : zh(e, i).sort(),
      s = 0;
  ...
  var Qr,
    ...
    `)),
      ...
      `)),
            (t = "sampleTexture");
          let r = D(this.context.glContext.version);
          return (
            (o[t] = new O(`
        ...
        getPackedSamplerAtOutputCoords(o, t, r, n) {
          ...
          f === 0
            ...
            : c < 2 && d.length >= 1
            ? (g = "coords = 0;")
            : (g = d.map((wt) => `coords.${T[wt + y]} = 0;`).join(`
`));
          let _ = "";
          c < 2 && f > 0
            ? (_ = "coords")
            : (_ = s.map((wt, mt) => `coords.${T[mt + y]}`).join(", "));
    ...
    `;
          return new O(Ht, ["coordinates.getOutputCoords"]);
        }
        getUnpackedSamplerAtOutputCoords(o, t, r, n) {
          let s = [r.width, r.height],
            ...
            c = r.unpackedShape,
            d = Rr(n);
          if (u === l && de.arraysEqual(a, s)) {
            let L = `
          float ${o}() {
            return sampleTexture(${n}, TexCoords);
          }
        `;
            return new O(L, ["coordinates.sampleTexture"]);
          }
          let m = ht(l),
            y = dt.getBroadcastDims(f, c),
            g = l - u,
            T,
            _ = Gt();
          u === 0
            ...
            : l < 2 && y.length >= 1
            ? (T = "coords = 0;")
            : (T = y.map((L) => `coords.${_[L + g]} = 0;`).join(`
`));
          let w = "";
          l < 2 && u > 0
            ? (w = "coords")
            : (w = t.unpackedShape
                .map((L, B) => `coords.${_[B + g]}`)
                .join(", "));
          let v = `
        float ${o}() {
          ${m} coords = getOutputCoords();
      ...
      `;
          return new O(v, ["coordinates.getOutputCoords"]);
        }
        ...
        getPackedSampler1D(o, t, r) {
          let n = [r.width, r.height],
            s = [n[1], n[0]],
            a = D(this.context.glContext.version),
            l = `vec4 ${o}(int index) {
      vec2 uv = packedUVfrom1D(
      ${s[0]}, ${s[1]}, index);
      return ${a.texture2D}(${t}, uv);
    }`;
          return new O(l, ["coordinates.packedUVfrom1D"]);
        }
        getPackedSampler2D(o, t, r) {
          let n = r.unpackedShape,
            ...
            u = s[0],
            l = s[1];
          if (s != null && de.arraysEqual(n, s)) {
            let y = `vec4 ${o}(int row, int col) {
      ...
      return ${a.texture2D}(${t}, uv);
        ...
        getPackedSampler3D(o, t, r) {
          let n = r.unpackedShape,
            s = [r.width, r.height],
            a = [s[0], s[1]],
            u = D(this.context.glContext.version);
          if (n[0] === 1) {
            let g = n.slice(1),
              T = [1, 2],
              _ = ke(n, g),
            ...
            v.unpackedShape = _;
            let L = this.getPackedSamplerFromInput(o, t, v),
              Q = `${L.routineBody}
      vec4 ${o}(int b, int row, int col) {
        return ${o}(${Be(w, T)});
      } `;
            return new O(Q, L.dependencies);
          }
          let l = a[0],
            f = a[1],
            c = Math.ceil(n[2] / 2),
            d = c * Math.ceil(n[1] / 2),
            y = `vec4 ${o}(int b, int row, int col) {
      vec2 uv = packedUVfrom3D(
        ${f}, ${l}, ${d}, ${c}, b, row, col);
      return ${u.texture2D}(${t}, uv);}`;
          return new O(y, ["coordinates.packedUVfrom3D"]);
        }
        getPackedSamplerND(o, t, r) {
          let n = r.unpackedShape,
            ...
            c = l[0],
            d = Math.ceil(n[s - 1] / 2),
            m = d * Math.ceil(n[s - 2] / 2),
            y = "int b, int row, int col",
            g = `b * ${m} + (row / 2) * ${d} + (col / 2)`;
          for (let w = 2; w < s - 1; w++)
            (y = `int b${w}, ` + y),
              (m *= n[s - w - 1]),
      ...
      return ${u.texture2D}(${t}, uv);
        ...
        `;
            return new O(u, ["coordinates.sampleTexture"]);
          }
          let a = `
        float ${o}() {
      ...
      `;
        ...
        `;
            return new O(g, ["coordinates.sampleTexture"]);
          }
          let { newShape: a, keptDims: u } = Re(n),
            l = a;
          if (l.length < n.length) {
            let m = ke(n, l),
              y = JSON.parse(JSON.stringify(r));
            y.unpackedShape = m;
            let g = ["col", "row"],
              T = `
        ...
        `;
            return new O(T, ["coordinates.sampleTexture"]);
          }
          let f = s[1],
            c = s[0];
          if (c === 1) {
      ...
      `;
        ...
        getUnpackedSampler3D(o, t, r) {
          ...
          if (f.length < n.length) {
            ...
            T.unpackedShape = y;
            let _ = this.getUnpackedSamplerFromInput(o, t, T),
              w = l.reverse(),
              v = `
          ${_.routineBody}
      ...
      `;
        ...
        getUnpackedSampler5D(o, t, r) {
          let n = r.unpackedShape,
            ...
            u = n[2] * a,
            l = n[1] * u,
            { newShape: f, keptDims: c } = Re(n);
          if (f.length < n.length) {
            let g = ke(n, f),
              T = ["row", "col", "depth", "depth2", "depth3"],
              _ = JSON.parse(JSON.stringify(r));
            _.unpackedShape = g;
            let w = `
      ...
      `;
        ...
        getUnpackedSampler6D(o, t, r) {
          let n = r.unpackedShape,
            ...
            l = n[2] * u,
            f = n[1] * l,
            { newShape: c, keptDims: d } = Re(n);
          if (c.length < n.length) {
            let T = ke(n, c),
              _ = ["row", "col", "depth", "depth2", "depth3", "depth4"],
              w = JSON.parse(JSON.stringify(r));
            w.unpackedShape = T;
            let v = `
    ...
    `;
          return { toVec: new O(u, ["coordinates.coordsToOffset"]) };
        }
        valueFrom() {
          let o = {};
          return (
        ...
        getValueFromSingle(o, t, r, n, s) {
          let a = `_${o}`;
          s && (a = a + "_T");
          let u = D(this.context.glContext.version);
          return `
        float ${a}(int m[${t}]) {
  ...
  var tn,
    gf = x(() => {
      ...
      tn = class i extends At {
        ...
        encodeFloat32() {
          return {
            encode: new O(`highp vec4 encode(highp float f) {
        ...
        decodeFloat32() {
          return {
            decode: new O(`highp float decode(highp vec4 rgba) {
        return rgba.r;
      }
        `),
          };
  ...
  var en,
    xf = x(() => {
      ...
      en = class extends At {
        ...
        setFragColor() {
          let e = D(this.context.glContext.version);
          return {
            setFragColor: new O(
              `
          ...
          return (
            this.context.programInfo.inputNames.forEach((t, r) => {
              ...
              if (n.length <= e) {
                ...
                for (let c = 0; c < s; ++c)
                  l += `
          realIndices[${c}] = int( mod(float(bcastedIndices[${a + c}]), ${
                    n[c]
                  }.0) );
          `;
                let f = `
        ...
        indicesToOffset() {
          ...
          return (
            this.context.programInfo.inputNames.forEach((o, t) => {
              ...
              (e[a] = new O(i.indexToOffsetSingle(a, s, n))),
                (a = `indicesToOffset_${o}_T`),
                (e[a] = new O(
                  i.indexToOffsetSingle(a, s, n.slice().reverse())
                ));
            }),
            e
          );
        ...
        offsetToIndices() {
          ...
          return (
            this.context.programInfo.inputNames.forEach((o, t) => {
              ...
              (e[a] = new O(i.offsetToIndicesSingle(a, s, n))),
    ...
    If = x(() => {
      ...
      on = class {
        constructor(e, o, t, r) {
          ...
          (this.context = new Ur(e, o, t, r)),
            Object.keys(Ro).forEach((s) => {
              let a = new Ro[s](this.context);
              this.libs[s] = a;
            });
          ...
          for (let s in this.libs) {
            ...
            for (let l in u) {
              let f = s + "." + l,
                c;
              n[f]
                ? ((c = n[f]), (c.routineBody = u[l].routineBody))
                : ((c = new rr(f, u[l].routineBody)), (n[f] = c));
              let d = u[l].dependencies;
              if (d)
                for (let m = 0; m < d.length; ++m)
                  if (n[d[m]]) c.addDependency(n[d[m]]);
                  else {
                    let y = new rr(d[m]);
                    (n[d[m]] = y), c.addDependency(y);
                  }
            }
          }
        }
      ...
      ${rs(
        ...
        this.context.outputTextureLayout.shape.length
            ...
            (o = hf(o)),
            `${es(this.context.glContext.version)}
      ...
      an = class {
          ...
          this.profiler.event(
            ...
            () => {
              ...
              try {
                ...
                throw (
                  (z.error("ProgramManager", e.programInfo.shaderSource), s)
                );
              }
        ...
        build(e, o, t) {
          return this.profiler.event("backend", "ProgramManager.build", () => {
            let r = new on(this.glContext, e, o, t),
              n = r.preprocess(),
              s = this.compile(n);
            return {
              programInfo: e,
        ...
        compile(e) {
          if (!this.vertexShader) {
            ...
            let r = ts(this.glContext.version);
    ...
    Sf = x(() => {
      ...
      sn = class {
        ...
        createTextureFromLayout(e, o, t, r) {
          ...
          let c = this.glContext.allocateTexture(
            a,
            u,
            s,
            this.toTextureData(e, t)
          ...
          return (
            this.config.reuseTextures &&
              (f.push(c), this.textureLookup.set(c, l)),
            c
          );
        }
        readTexture(e, o, t) {
      ...
      un = class {
        constructor(e, o) {
          ...
          (this.layoutStrategy = new Yr(e.glContext.maxTextureSize)),
            (this.programManager = new an(
              this.context.profiler,
              e.glContext,
              this.layoutStrategy
            )),
            (this.textureManager = new sn(
              e.glContext,
              this.layoutStrategy,
              this.context.profiler,
        ...
        setTextureData(e, o, t = !1) {
          z.verbose("WebGLSessionHandler", "Storing Texture data in cache"),
            t
    ...
    Af = x(() => {
      ...
      ir = class {
        ...
        readTexture(e, o, t, r, n, s) {
          let a = this.gl;
          s || (s = 1),
            this.frameBufferBound || this.attachFramebuffer(e, o, t);
        ...
        getActiveTexture() {
          let e = this.gl;
          return `TEXTURE${
            e.getParameter(this.gl.ACTIVE_TEXTURE) - e.TEXTURE0
          }`;
        }
        getTextureBinding() {
        ...
        createProgram(e, o) {
          let t = this.gl,
            r = t.createProgram();
          return (
            t.attachShader(r, e), t.attachShader(r, o), t.linkProgram(r), r
          );
        }
        compileShader(e, o) {
          let t = this.gl,
...
${e}`);
        ...
        getEncoder(e, o, t = 0) {
          if (this.version === 2) return new Gr(this.gl, o);
          switch (e) {
            case "float":
        ...
        async waitForQueryAndGetTime(e) {
          return (
            await uo(() => this.isTimerResultAvailable(e)),
          ...
          return (
            ...
            r === null
              ...
              : (o = () => {
                  ...
                  return (
                    n === t.ALREADY_SIGNALED || n === t.CONDITION_SATISFIED
                  );
                }),
        ...
        pollItems() {
          let e = qh(this.itemsToPoll.map((o) => o.isDoneFn));
          for (let o = 0; o <= e; ++o) {
  ...
  function Go(i) {
    let e;
    if (
      ((!i || i === "webgl2") && "webgl2" in Ge
        ? (e = Ge.webgl2)
        : (!i || i === "webgl") && "webgl" in Ge && (e = Ge.webgl),
      !e)
    )
      try {
        let t = Xh();
  ...
  function Pf(i, e) {
    ...
    if (
      (!e || e === "webgl") &&
      ((t = i.getContext("webgl", r) || i.getContext("experimental-webgl", r)),
      t)
    )
      try {
        return new ir(t, 1);
  ...
  var ln,
    Df = x(() => {
      ...
      ln = class {
        get contextId() {
          return $.webgl.contextId;
        }
        set contextId(e) {
          $.webgl.contextId = e;
        }
        get matmulMaxBatchSize() {
          return $.webgl.matmulMaxBatchSize;
        }
        set matmulMaxBatchSize(e) {
          $.webgl.matmulMaxBatchSize = e;
        }
        get textureCacheMode() {
          return $.webgl.textureCacheMode;
        }
        set textureCacheMode(e) {
          $.webgl.textureCacheMode = e;
        }
        get pack() {
          return $.webgl.pack;
        }
        ...
        initialize() {
          try {
            return (
              (this.glContext = Go(this.contextId)),
              ...
              z.setWithEnv($),
              $.webgl.context ||
                Object.defineProperty($.webgl, "context", {
  ...
  async function Mo(i) {
    ...
    } else return Mo(["webgl"]);
    throw new Error("no available backend to use");
  }
  async function Jh(i) {
    let e = Kh;
    if (typeof e[i] < "u" && Zh(e[i])) {
      let o = e[i],
        t = o.initialize();
        ...
        (fn = class {
          ...
          initialize(e) {
            this.profiler.event("session", "ExecutionPlan.initialize", () => {
              ...
              (this._ops = e.map((t, r) => new Vo(t, o[r]))),
                this.reset(),
                (this._starter = []),
            ...
            return this.profiler.event(
              ...
              async () => {
                ...
                for (; u < n.length; ) {
                  let f = n[u++],
                    c = this._ops[f],
                    d = c.node.inputs.map((T) => this._values[T]);
                  if (d.indexOf(void 0) !== -1)
                    throw new Error(`unresolved input detected: op: ${c.node}`);
                  let m = d;
                  z.verbose(
                    "ExecPlan",
                    `Running op:${c.node.name} (${m
                      .map(
                        (T, _) =>
                          `'${c.node.inputs[_]}': ${T.type}[${T.dims.join(
                            ","
                          )}]`
                      )
                      .join(", ")})`
                  );
                  let y = await this.profiler.event(
                    "node",
                    c.node.name,
                    async () => c.op.impl(t, m, c.op.context)
                  );
                  if (y.length !== c.node.outputs.length)
                    throw new Error(
                      "the size of output does not match model definition."
                    );
                  y.forEach((T, _) => {
                    let w = c.node.outputs[_];
                    if (this._values[w])
                      throw new Error(
                        `output [${w}] already has value: op:${c.node.name}`
                      );
                    this._values[w] = T;
                  });
                  let g = new Set();
                ...
                for (let f = 0; f < this.graph.getOutputIndices().length; f++) {
                  let c = this.graph.getOutputIndices()[f],
                    d = this._values[c];
                  if (d === void 0)
                    throw new Error(
                      `required output [${c}] does not have value`
                    );
                  c === 0 ? await d.getData() : d.data, l.push(d);
                }
                return (
                  z.verbose("ExecPlan", "disposing of inferenceHandler"),
                  t.dispose(),
                  l
                );
              }
  ...
  var C,
    ...
    Bf = x(() => {
      ...
      ye();
      U();
      (Dt = P.experimental.fbs),
        (ar = class i {
          constructor(e) {
            if (((this._attributes = new Map()), e != null)) {
              for (let o of e)
                o instanceof C.onnx.AttributeProto
                  ? this._attributes.set(o.name, [i.getValue(o), i.getType(o)])
                  : o instanceof Dt.Attribute &&
                    this._attributes.set(o.name(), [
                      i.getValue(o),
                      i.getType(o),
                    ]);
          ...
          static getType(e) {
            let o = e instanceof C.onnx.AttributeProto ? e.type : e.type();
            switch (o) {
              case C.onnx.AttributeProto.AttributeType.FLOAT:
                return "float";
              case C.onnx.AttributeProto.AttributeType.INT:
                return "int";
              case C.onnx.AttributeProto.AttributeType.STRING:
                return "string";
              case C.onnx.AttributeProto.AttributeType.TENSOR:
                return "tensor";
              case C.onnx.AttributeProto.AttributeType.FLOATS:
                return "floats";
              case C.onnx.AttributeProto.AttributeType.INTS:
                return "ints";
              case C.onnx.AttributeProto.AttributeType.STRINGS:
                return "strings";
              case C.onnx.AttributeProto.AttributeType.TENSORS:
                return "tensors";
              default:
                throw new Error(
                  `attribute type is not supported yet: ${C.onnx.AttributeProto.AttributeType[o]}`
                );
            }
          }
          static getValue(e) {
            let o = e instanceof C.onnx.AttributeProto ? e.type : e.type();
            if (
              o === C.onnx.AttributeProto.AttributeType.GRAPH ||
              o === C.onnx.AttributeProto.AttributeType.GRAPHS
            )
              throw new Error("graph attribute is not supported yet");
            let t = this.getValueNoCheck(e);
            if (o === C.onnx.AttributeProto.AttributeType.INT && xt.isLong(t))
              return xt.longToNumber(t);
            if (o === C.onnx.AttributeProto.AttributeType.INTS) {
              let r = t,
                n = new Array(r.length);
              for (let s = 0; s < r.length; s++) {
                let a = r[s];
                n[s] = xt.longToNumber(a);
              }
              return n;
            }
            if (o === C.onnx.AttributeProto.AttributeType.TENSOR)
              return e instanceof C.onnx.AttributeProto
                ? rt.fromProto(t)
                : rt.fromOrtTensor(t);
            if (o === C.onnx.AttributeProto.AttributeType.TENSORS) {
              if (e instanceof C.onnx.AttributeProto)
                return t.map((n) => rt.fromProto(n));
              if (e instanceof Dt.Attribute)
                return t.map((n) => rt.fromOrtTensor(n));
            }
            return o === C.onnx.AttributeProto.AttributeType.STRING &&
              e instanceof C.onnx.AttributeProto
              ? Ye(t)
              : o === C.onnx.AttributeProto.AttributeType.STRINGS &&
                e instanceof C.onnx.AttributeProto
              ? t.map(Ye)
              : t;
          }
          ...
          static getValueNoCheckFromOnnxFormat(e) {
            switch (e.type) {
              ...
              case C.onnx.AttributeProto.AttributeType.TENSOR:
                return e.t;
              case C.onnx.AttributeProto.AttributeType.GRAPH:
                return e.g;
              case C.onnx.AttributeProto.AttributeType.FLOATS:
                return e.floats;
              case C.onnx.AttributeProto.AttributeType.INTS:
              ...
              case C.onnx.AttributeProto.AttributeType.TENSORS:
                return e.tensors;
              case C.onnx.AttributeProto.AttributeType.GRAPHS:
                return e.graphs;
              default:
                throw new Error(
                  `unsupported attribute type: ${
                    C.onnx.AttributeProto.AttributeType[e.type]
                  }`
                );
            }
          }
          static getValueNoCheckFromOrtFormat(e) {
            switch (e.type()) {
              ...
              case Dt.AttributeType.STRINGS: {
                let o = [];
                for (let t = 0; t < e.stringsLength(); t++)
                  o.push(e.strings(t));
                return o;
              }
              case Dt.AttributeType.TENSORS: {
                let o = [];
                for (let t = 0; t < e.tensorsLength(); t++)
                  o.push(e.tensors(t));
                return o;
              }
              default:
                throw new Error(
                  `unsupported attribute type: ${Dt.AttributeType[e.type()]}`
                );
            }
          }
        });
  ...
  var zo,
    ...
    Ff = x(() => {
      ...
      ye();
      U();
      (cn = P.experimental.fbs),
        (Wo = { from: (i, e) => new Uo(i, e) }),
        (Wt = class {
          constructor(e) {
            (this._from = void 0),
              (this._to = []),
              (this.tensor = void 0),
              (this.type = void 0),
              e && (this.type = ut.tensorValueTypeFromProto(e.type.tensorType));
          }
          get from() {
            return this._from;
          }
        ...
        (pn = class {
          constructor(e, o) {
            e instanceof zo.onnx.NodeProto
              ? ((this.name = e.name),
                (this.opType = e.opType),
                (this.attributes = new ar(e.attribute)))
              : e instanceof cn.Node &&
                ((this.name = o ?? e.name()),
                (this.opType = e.opType()),
                (this.attributes = new ar(
                  ut.tensorAttributesFromORTFormat(e)
                ))),
              (this.inputs = []),
              (this.outputs = []),
              (this.executeNode = !0);
        ...
        (Uo = class {
          ...
          buildGraph(e) {
            if (e instanceof zo.onnx.GraphProto)
              this.buildGraphFromOnnxFormat(e);
            else if (e instanceof cn.Graph) this.buildGraphFromOrtFormat(e);
          ...
          buildGraphFromOnnxFormat(e) {
            ...
            for (let n of e.input) {
              ...
              let s = this._allData.push(new Wt(n)) - 1;
            ...
            for (let n of e.initializer) {
              ...
              if (s === void 0) {
                let a = new Wt();
                (a.type = {
                  shape: { dims: ut.tensorDimsFromProto(n.dims) },
                  tensorType: ut.tensorDataTypeFromProto(n.dataType),
                }),
                  (s = this._allData.push(a) - 1),
                  o.set(n.name, s);
              }
              (this._allData[s]._from = -1),
                (this._allData[s].tensor = rt.fromProto(n));
            }
            ...
            for (let n of e.node) {
              ...
              let s = this._nodes.push(new pn(n)) - 1;
              t.set(n.name, s);
            }
            for (let n = 0; n < this._nodes.length; n++) {
              ...
              for (let u of a.output) {
                ...
                if (
                  (typeof l > "u" &&
                    ((l = this._allData.push(new Wt()) - 1), o.set(u, l)),
                  s.outputs.push(l),
                ...
                if (((this._allData[l]._from = n), a.opType === "Constant")) {
                  ...
                  s.outputs.pop(),
                    ...
                    (this._allData[l].tensor = rt.fromProto(a.attribute[0].t));
                }
              }
            }
            for (let n = 0; n < this._nodes.length; n++) {
          ...
          buildGraphFromOrtFormat(e) {
              ...
              for (let a = 0; a < e.nodeArgsLength(); a++)
                if (e.nodeArgs(a)?.name() === s) {
                  ...
                  if (
                    ...
                    cn.TypeInfoValue.tensor_type
                  )
                    throw new Error("Unexpected value type for the nodeArg.");
                  let f = e
                      .nodeArgs(a)
                      .type()
                      .value(new cn.TensorTypeAndShape()),
                    c = ut.tensorDataTypeFromProto(f.elemType()),
                    d = f.shape(),
                    m = [];
                  for (let g = 0; g < d.dimLength(); g++)
                    m.push(xt.longToNumber(d.dim(g).value().dimValue()));
                  u.type = { shape: { dims: m }, tensorType: c };
                  let y = this._allData.push(u) - 1;
                  o.set(s, y), r.push(s);
                }
            }
            for (let n = 0; n < e.initializersLength(); n++) {
              ...
              if (a === void 0) {
                let u = new Wt(),
                  l = ut.tensorDimsFromORTFormat(s),
                  f = ut.tensorDataTypeFromProto(s.dataType());
                (u.type = { shape: { dims: l }, tensorType: f }),
                  (a = this._allData.push(u) - 1),
                  o.set(s.name(), a);
              }
              (this._allData[a]._from = -1),
                (this._allData[a].tensor = rt.fromOrtTensor(s));
            }
            for (let n = 0; n < this._allData.length; n++)
              this._allData[n].tensor ||
                (this._allInputIndices.push(n), this._allInputNames.push(r[n]));
            for (let n = 0; n < e.outputsLength(); n++) {
              ...
              let a = this._allData.push(new Wt()) - 1;
              o.set(s, a),
            ...
            for (let n = 0; n < e.nodesLength(); n++) {
              ...
              let u = this._nodes.push(new pn(s, a)) - 1;
              t.set(a, u);
            }
            for (let n = 0; n < this._nodes.length; n++) {
              let s = this._nodes[n],
              ...
              for (let u = 0; u < a?.outputsLength(); u++) {
                ...
                if (
                  (typeof f > "u" &&
                    ((f = this._allData.push(new Wt()) - 1), o.set(l, f)),
                  s.outputs.push(f),
                ...
                if (((this._allData[f]._from = n), a.opType() === "Constant")) {
                  ...
                  s.outputs.pop(),
                    ...
                    (this._allData[f].tensor = rt.fromOrtTensor(
                      a.attributes(0).t()
                    ));
                }
              }
          ...
          deleteNode(e) {
            ...
            if (
              (s !== -1 && (this._allOutputIndices[s] = t), n && n.length > 0)
            )
              for (let a of n) {
...
as ORT format: ${n}`);
          ...
          loadFromOnnxFormat(e, o) {
            let t = Nf.onnx.ModelProto.decode(e);
            if (xt.longToNumber(t.irVersion) < 3)
              throw new Error("only support ONNX model with IR_VERSION>=3");
            (this._opsets = t.opsetImport.map((n) => ({
              domain: n.domain,
              version: xt.longToNumber(n.version),
            }))),
              (this._graph = Wo.from(t.graph, o));
          }
          loadFromOrtFormat(e, o) {
            let t = new b.ByteBuffer(e),
              r = Yh.InferenceSession.getRootAsInferenceSession(t).model();
            if (xt.longToNumber(r.irVersion()) < 3)
              throw new Error("only support ONNX model with IR_VERSION>=3");
            this._opsets = [];
            for (let s = 0; s < r.opsetImportLength(); s++) {
              ...
              this._opsets.push({
                domain: a?.domain(),
                version: xt.longToNumber(a.version()),
              });
            }
            this._graph = Wo.from(r.graph(), o);
          }
          get graph() {
            return this._graph;
          }
      ...
      hn = class {
        constructor(e = {}) {
          (this._initialized = !1),
            ...
            (this.profiler = Dr.create(e.profiler)),
            (this.context = {
        ...
        async loadModel(e, o, t) {
          await this.profiler.event(
            ...
            "Session.loadModel",
            async () => {
              let r = await Mo(this.backendHint);
              if (
        ...
        async run(e, o, t) {
          ...
          for (let a in e)
            if (Object.hasOwnProperty.call(e, a)) {
              let u = e[a];
              r.set(a, new rt(u.dims, u.type, void 0, void 0, u.data));
            }
          let n = await this.session.run(r),
            s = {};
          return (
            n.forEach((a, u) => {
              s[u] = new et(a.type, a.data, a.dims);
            }),
            s
          );
        }
  ...
  var Uf,
    ...
    Hf = x(() => {
      ...
      ve();
      sr();
      (Uf = "ort-wasm-proxy-worker"), (zf = globalThis.self?.name === Uf);
      zf &&
        (self.onmessage = (i) => {
          ...
          try {
            switch (e) {
              ...
              case "run": {
                ...
                vn(t, r, n, s, new Array(s.length).fill(null), a).then(
                  (u) => {
                    u.some((l) => l[3] !== "cpu")
                      ? postMessage({
                          type: e,
                      ...
                      : postMessage({ type: e, out: u }, _n([...n, ...u]));
                  },
                  (u) => {
      ...
      tm = zf
        ? null
        : (i) => new Worker(i ?? Lt, { type: "classic", name: Uf });
    });
  var Lt,
    em,
    jf,
    ...
    sr = x(() => {
      ...
      (Lt = !1
        ...
        ? self.location?.href
        : void 0),
        (em = !1 || typeof location > "u" ? void 0 : location.origin),
        (jf = (i, e) => {
          try {
            let o = e ?? Lt;
            return (o ? new URL(i, o) : new URL(i)).origin === em;
          } catch {
            return !1;
          }
        }),
        (rm = (i, e) => {
          let o = e ?? Lt;
          try {
            return (o ? new URL(i, o) : new URL(i)).href;
          } catch {
            return;
          }
        }),
        ...
        (om = async (i) => (await import(/*webpackIgnore:true*/ i)).default),
        (qf = (Hf(), gr(Wf)).default),
        (Kf = async () => {
          if (!Lt)
            throw new Error(
          ...
          if (jf(Lt)) return [void 0, qf()];
          let i = await Xf(Lt);
          return [i, qf(i)];
        }),
        (Jf = async (i, e, o) => {
          {
            let t = "ort-wasm-simd-threaded.mjs",
              r = i ?? rm(t, e),
              n = !!1 && o && r && !jf(r, e),
              s = n ? await Xf(r) : r ?? nm(t, e);
            return [n ? s : void 0, await om(s)];
          }
        });
    });
  var jo,
      ...
      Yf = (i) => {
        ...
        try {
          ...
          return (
            ...
            o === 0 && Y("Can't create run options."),
            i?.extra !== void 0 &&
              lr(i.extra, "", new WeakSet(), (s, a) => {
                let u = ot(s, t),
                  l = ot(a, t);
                e._OrtAddRunConfigEntry(o, u, l) !== 0 &&
                  Y(`Can't set a run config entry: ${s} - ${a}.`);
              }),
            [o, t]
          );
        } catch (n) {
      ...
      (sm = (i) => {
        ...
        (fm = (i, e, o) => {
          for (let t of e) {
            ...
            switch (r) {
              case "webnn":
                if (((r = "WEBNN"), typeof t != "string")) {
                  let a = t?.deviceType;
                  if (a) {
                    let u = ot("deviceType", o),
                      l = ot(a, o);
                    nt()._OrtAddSessionConfigEntry(i, u, l) !== 0 &&
                      Y(
              ...
              case "webgpu":
                if (((r = "JS"), typeof t != "string")) {
                  ...
                  if (s?.preferredLayout) {
                    ...
                    let a = ot("preferredLayout", o),
                      u = ot(s.preferredLayout, o);
                    nt()._OrtAddSessionConfigEntry(i, a, u) !== 0 &&
                      Y(
            ...
            let n = ot(r, o);
            nt()._OrtAppendExecutionProvider(i, n) !== 0 &&
              Y(`Can't append execution provider: ${r}.`);
          }
        }),
        (tc = (i) => {
          let e = nt(),
          ...
          lm(r);
          try {
            let n = sm(r.graphOptimizationLevel ?? "all"),
              s = um(r.executionMode ?? "sequential"),
              a = typeof r.logId == "string" ? ot(r.logId, t) : 0,
            ...
            if (
              ...
              o === 0 && Y("Can't create session options."),
              r.executionProviders && fm(o, r.executionProviders, t),
              ...
              let c = ot("enableGraphCapture", t),
                d = ot(r.enableGraphCapture.toString(), t);
              e._OrtAddSessionConfigEntry(o, c, d) !== 0 &&
                Y(
                  `Can't set a session config entry: 'enableGraphCapture' - ${r.enableGraphCapture}.`
                );
            }
            if (r.freeDimensionOverrides)
              for (let [c, d] of Object.entries(r.freeDimensionOverrides)) {
                if (typeof c != "string")
                  throw new Error(
                    `free dimension override name must be a string: ${c}`
                  );
                ...
                let m = ot(c, t);
                e._OrtAddFreeDimensionOverride(o, m, d) !== 0 &&
                  Y(`Can't set a free dimension override: ${c} - ${d}.`);
              }
            return (
              r.extra !== void 0 &&
                lr(r.extra, "", new WeakSet(), (c, d) => {
                  let m = ot(c, t),
                    y = ot(d, t);
                  e._OrtAddSessionConfigEntry(o, m, y) !== 0 &&
                    Y(`Can't set a session config entry: ${c} - ${d}.`);
                }),
              [o, t]
            );
          } catch (n) {
    ...
    Jo = x(() => {
      ...
      pr = async (i) => {
        if (typeof i == "string")
          if (!1)
            try {
              let { readFile: e } = Bn("node:fs/promises");
              return new Uint8Array(await e(i));
            } catch (e) {
              if (e.code === "ERR_FS_FILE_TOO_LARGE") {
                let { createReadStream: o } = Bn("node:fs"),
                  t = o(i),
                  r = [];
            ...
            let e = await fetch(i);
            if (!e.ok)
              throw new Error(`failed to load external data file: ${i}`);
  ...
  var cm,
    ...
    qo = x(() => {
      ...
      Jo();
      (cm = (i, e) => {
        nt()._OrtInit(i, e) !== 0 && Y("Can't initialize onnxruntime.");
      }),
        (gn = async (i) => {
          cm(i.wasm.numThreads, oc(i.logLevel));
        }),
        (xn = async (i, e) => {}),
        (Me = new Map()),
        (pm = (i) => {
        ...
        (Tn = async (i, e) => {
          ...
          let n = 0,
            ...
            f = [];
          try {
            if ((([s, u] = tc(e)), e?.externalData && r.mountExternalData)) {
              let w = [];
              for (let v of e.externalData) {
                let L = typeof v == "string" ? v : v.path;
                w.push(
                  pr(typeof v == "string" ? v : v.data).then((B) => {
                    r.mountExternalData(L, B);
                  })
                );
              }
              await Promise.all(w);
            }
            for (let w of e?.executionProviders ?? [])
              if ((typeof w == "string" ? w : w.name) === "webnn") {
                ...
                if (typeof w != "string") {
                  let L = w,
                    ...
                    pt = L?.deviceType,
                    Ht = L?.numThreads,
                    wt = L?.powerPreference;
                  B
                    ? (r.currentContext = B)
                    : Q
                    ? (r.currentContext = await navigator.ml.createContext(Q))
            ...
            let [c, d] = pm(n),
              ...
              T = [];
            for (let w = 0; w < c; w++) {
              let v = r._OrtGetInputName(n, w);
              v === 0 && Y("Can't get an input name."),
                l.push(v),
                y.push(r.UTF8ToString(v));
            }
            for (let w = 0; w < d; w++) {
              let v = r._OrtGetOutputName(n, w);
              v === 0 && Y("Can't get an output name."), f.push(v);
              let L = r.UTF8ToString(v);
              g.push(L);
            }
            let _ = null;
            return Me.set(n, [n, l, f, _, m, !1]), [n, y, g];
          } catch (c) {
            throw (
        ...
        (ac = (i, e, o, t, r, n = !1) => {
          ...
          if (l === "gpu-buffer") {
            ...
            let y = i[2];
            if (Array.isArray(y)) {
              (c = 4 * y.length), (f = s._malloc(c)), o.push(f);
              let g = f / 4;
              for (let T = 0; T < y.length; T++) {
                if (typeof y[T] != "string")
                  throw new TypeError(
                    `tensor data at index ${T} is not a string`
                  );
                s.HEAPU32[g++] = ot(y[T], o);
              }
            } else
              (c = y.byteLength),
                (f = s._malloc(c)),
                o.push(f),
                s.HEAPU8.set(new Uint8Array(y.buffer, y.byteOffset, c), f);
          }
          let d = s.stackSave(),
            m = s.stackAlloc(4 * u.length);
          try {
            let y = m / 4;
            u.forEach((T) => (s.HEAP32[y++] = T));
            let g = s._OrtCreateTensor(fr(a), f, c, m, u.length, ic(l));
            g === 0 &&
              Y(
        ...
        (vn = async (i, e, o, t, r, n) => {
          ...
          let u = a[0],
            ...
            wt = s.stackAlloc(g * 4);
          try {
            s.jsepOnRunStart?.(u), ([T, _] = Yf(n));
            for (let W = 0; W < y; W++) ac(o[W], w, L, i, e[W], d);
            for (let W = 0; W < g; W++) ac(r[W], v, L, i, y + t[W], d);
            let mt = Q / 4,
              k = pt / 4,
              xc = Ht / 4,
              Tc = wt / 4;
            for (let W = 0; W < y; W++)
              (s.HEAPU32[mt++] = w[W]), (s.HEAPU32[k++] = l[e[W]]);
            for (let W = 0; W < g; W++)
              (s.HEAPU32[xc++] = v[W]), (s.HEAPU32[Tc++] = f[t[W]]);
            let ti;
            (ti = await s._OrtRun(u, pt, Q, y, wt, g, Ht, T)),
              ti !== 0 && Y("failed to call OrtRun().");
            let Se = [];
            for (let W = 0; W < g; W++) {
              let Oe = s.HEAPU32[Ht / 4 + W];
              if (Oe === v[W]) {
                Se.push(r[W]);
                continue;
              }
              let ei = s.stackSave(),
                ...
                vt = 0;
              try {
                s._OrtGetTensorData(Oe, oe, oe + 4, oe + 8, oe + 12) !== 0 &&
                  Y(`Can't access output tensor data on index ${W}.`);
                let hr = oe / 4,
                  mr = s.HEAPU32[hr++];
                vt = s.HEAPU32[hr++];
                let ri = s.HEAPU32[hr++],
                  wc = s.HEAPU32[hr++],
                  ie = [];
                for (let ft = 0; ft < wc; ft++) ie.push(s.HEAPU32[ri / 4 + ft]);
                s._OrtFree(ri);
                let ae = ie.reduce((ft, bt) => ft * bt, 1);
                lt = rc(mr);
                let br = c?.outputPreferredLocations[t[W]];
                if (lt === "string") {
                  if (br === "gpu-buffer" || br === "ml-tensor")
                    throw new Error("String tensor is not supported on GPU.");
                  let ft = [],
                    bt = vt / 4;
                  for (let Kt = 0; Kt < ae; Kt++) {
                    let ni = s.HEAPU32[bt++],
                      vc = Kt === ae - 1 ? void 0 : s.HEAPU32[bt] - ni;
                    ft.push(s.UTF8ToString(ni, vc));
                  }
                  Se.push([lt, ie, ft, "cpu"]);
                } else if (br === "gpu-buffer" && ae > 0) {
                  let ft = s.jsepGetBuffer;
                  if (!ft)
                    throw new Error(
                  ...
                  let bt = ft(vt),
                    Kt = cr(mr, ae);
                  if (Kt === void 0 || !An(lt))
                    throw new Error(`Unsupported data type: ${lt}`);
                  (ze = !0),
                    Se.push([
                      lt,
                      ie,
                      {
                        gpuBuffer: bt,
                        download: s.jsepCreateDownloader(bt, Kt, lt),
                        dispose: () => {
                          s._OrtReleaseTensor(Oe);
                        },
                      },
                      "gpu-buffer",
                    ]);
                } else if (br === "ml-tensor" && ae > 0) {
                  let ft = s.jsepEnsureTensor;
                  if (!ft)
                    throw new Error(
                      'preferredLocation "ml-tensor" is not supported without using WebNN.'
                    );
                  if (cr(mr, ae) === void 0 || !Pn(lt))
                    throw new Error(`Unsupported data type: ${lt}`);
                  let Kt = await ft(vt, mr, ie, !1);
                  (ze = !0),
                    Se.push([
                      lt,
                      ie,
                      {
                        mlTensor: Kt,
                        download: s.jsepCreateMLTensorDownloader(vt, lt),
                        dispose: () => {
                          s.jsepReleaseTensorId(vt), s._OrtReleaseTensor(Oe);
                        },
                      },
                      "ml-tensor",
                    ]);
                  ...
                  let ft = nc(lt),
                    bt = new ft(ae);
                  new Uint8Array(bt.buffer, bt.byteOffset, bt.byteLength).set(
                    s.HEAPU8.subarray(vt, vt + bt.byteLength)
                  ),
                    Se.push([lt, ie, bt, "cpu"]);
                }
              } finally {
                s.stackRestore(ei),
                  lt === "string" && vt && s._free(vt),
                  ze || s._OrtReleaseTensor(Oe);
              }
            }
            return (
              c &&
                !d &&
                (s._OrtClearBoundOutputs(c.handle),
                Me.set(i, [u, l, f, c, d, !1])),
              Se
            );
          } finally {
            s.stackRestore(B),
              w.forEach((mt) => s._OrtReleaseTensor(mt)),
              v.forEach((mt) => s._OrtReleaseTensor(mt)),
              L.forEach((mt) => s._free(mt)),
              T !== 0 && s._OrtReleaseRunOptions(T),
              _.forEach((mt) => s._free(mt));
          }
        }),
        (In = (i) => {
          let e = nt(),
          ...
          r === 0 && Y("Can't get an profile file name."), e._OrtFree(r);
        }),
        (_n = (i) => {
          let e = [];
          for (let o of i) {
  ...
  var _e,
    ...
    Qo = x(() => {
      ...
      ve();
      sr();
      (_e = () => !!$.wasm.proxy && typeof document < "u"),
        (dr = !1),
        (Dn = !1),
        (Ln = !1),
        (Yo = new Map()),
        (Ve = (i, e) => {
          let o = Yo.get(i);
          o ? o.push(e) : Yo.set(i, [e]);
        }),
        (Ue = () => {
          if (dr || !Dn || Ln || !$t) throw new Error("worker not ready");
        }),
        (hm = (i) => {
          switch (i.data.type) {
            case "init-wasm":
              (dr = !1),
                i.data.err
                  ? ((Ln = !0), Zo[1](i.data.err))
                  : ((Dn = !0), Zo[0]()),
                En && (URL.revokeObjectURL(En), (En = void 0));
              break;
            case "init-ep":
            case "copy-from":
            case "create":
                  ...
                  Kf().then(([o, t]) => {
                    try {
                      ($t = t),
                        ...
                        ($t.onmessage = hm),
                        (Zo = [i, e]);
                      let r = { type: "init-wasm", in: $ };
                      $t.postMessage(r), (En = o);
                    } catch (r) {
                      e(r);
                    }
                  }, e);
        ...
        (uc = async (i) => {
          if (_e())
            return (
              ...
              new Promise((e, o) => {
                Ve("init-ep", [e, o]);
                let t = { type: "init-ep", in: { epName: i, env: $ } };
                $t.postMessage(t);
              })
            );
          await xn($, i);
            ...
            return (
              ...
              new Promise((o, t) => {
                ...
                let r = { type: "create", in: { model: i, options: { ...e } } },
                  n = [];
                i instanceof Uint8Array && n.push(i.buffer),
                  $t.postMessage(r, n);
              })
            );
          } else return Tn(i, e);
          ...
          if (_e()) {
            ...
            return (
              ...
              new Promise((s, a) => {
                ...
                $t.postMessage(l, _n(u));
              })
            );
          } else return vn(i, e, o, t, r, n);
        }),
        (dc = async (i) => {
          if (_e())
            return (
        ...
        ($n = class {
          ...
          async loadModel(e, o) {
            ...
            typeof e == "string"
              ...
              : (t = e),
              ([this.sessionId, this.inputNames, this.outputNames] = await fc(
                t,
                o
              )),
              Zt();
          ...
          async run(e, o, t) {
            ...
            Object.entries(e).forEach((d) => {
              ...
              if (g === -1) throw new Error(`invalid input '${m}'`);
              r.push(y), n.push(g);
            });
            let s = [],
              a = [];
            Object.entries(o).forEach((d) => {
              ...
              if (g === -1) throw new Error(`invalid output '${m}'`);
              s.push(y), a.push(g);
            });
            let u = r.map((d, m) =>
                hc(d, () => `input "${this.inputNames[n[m]]}"`)
              ),
              l = s.map((d, m) =>
                d ? hc(d, () => `output "${this.outputNames[a[m]]}"`) : null
              ),
              f = await pc(this.sessionId, n, u, a, l, t),
              c = {};
            for (let d = 0; d < f.length; d++)
              c[this.outputNames[a[d]]] = s[d] ?? mm(f[d]);
            return Zt(), c;
          }
          startProfiling() {}
          endProfiling() {
  ...
  var yc = {};
  We(yc, {
    OnnxruntimeWebAssemblyBackend: () => kn,
    initializeFlags: () => bc,
    wasmBackend: () => bm,
  });
  var bc,
    ...
    gc = x(() => {
      ...
      (bc = () => {
        if (
          ((typeof $.wasm.initTimeout != "number" || $.wasm.initTimeout < 0) &&
            ($.wasm.initTimeout = 0),
          $.wasm.simd === !1 &&
            console.warn(
              'Deprecated property "env.wasm.simd" is set to false. non-SIMD build is no longer provided, and this setting will be ignored.'
            ),
          typeof $.wasm.proxy != "boolean" && ($.wasm.proxy = !1),
          typeof $.wasm.trace != "boolean" && ($.wasm.trace = !1),
          typeof $.wasm.numThreads != "number" ||
            !Number.isInteger($.wasm.numThreads) ||
            $.wasm.numThreads <= 0)
        )
          if (typeof self < "u" && !self.crossOriginIsolated)
            ...
            let i =
              typeof navigator > "u"
                ? Bn("node:os").cpus().length
                : navigator.hardwareConcurrency;
            $.wasm.numThreads = Math.min(4, Math.ceil((i || 1) / 2));
          }
        $.wasm.wasmPaths === void 0 &&
          Lt &&
          Lt.indexOf("blob:") !== 0 &&
          ($.wasm.wasmPaths = Lt.substring(0, Lt.lastIndexOf("/") + 1));
      }),
        (kn = class {
          async init(e) {
            bc(), await sc(), await uc(e);
          }
          async createInferenceSessionHandler(e, o) {
            let t = new $n();
  ...
  var ym = Gn;
  {
    let i = (Vf(), gr(Mf)).onnxjsBackend;
    ue("webgl", i, -10);
  }
  {
    let i = (gc(), gr(yc)).wasmBackend;
    ue("cpu", i, 10), ue("wasm", i, 10);
  }
  Object.defineProperty($.versions, "web", { value: Ni, enumerable: !0 });
  return gr(gm);
})();
